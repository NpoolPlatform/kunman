...
func (rq *ReviewQuery) IDs(ctx context.Context) (ids []uint32, err error) {
...
func (rq *ReviewQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(review.Table, review.Columns, sqlgraph.NewFieldSpec(review.FieldID, field.TypeUint32))
	_spec.From = rq.sql
