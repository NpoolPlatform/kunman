...
type AddonFunc func(context.Context, *generated.AddonMutation) (generated.Value, error)

// Mutate calls f(ctx, m).
func (f AddonFunc) Mutate(ctx context.Context, m generated.Mutation) (generated.Value, error) {
	if mv, ok := m.(*generated.AddonMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *generated.AddonMutation", m)
}

// The ExchangeFunc type is an adapter to allow the use of ordinary
// function as Exchange mutator.
type ExchangeFunc func(context.Context, *generated.ExchangeMutation) (generated.Value, error)

// Mutate calls f(ctx, m).
func (f ExchangeFunc) Mutate(ctx context.Context, m generated.Mutation) (generated.Value, error) {
	if mv, ok := m.(*generated.ExchangeMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *generated.ExchangeMutation", m)
}
...
type UserCreditRecordFunc func(context.Context, *generated.UserCreditRecordMutation) (generated.Value, error)

// Mutate calls f(ctx, m).
func (f UserCreditRecordFunc) Mutate(ctx context.Context, m generated.Mutation) (generated.Value, error) {
	if mv, ok := m.(*generated.UserCreditRecordMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *generated.UserCreditRecordMutation", m)
}

// The UserSubscriptionFunc type is an adapter to allow the use of ordinary
// function as UserSubscription mutator.
type UserSubscriptionFunc func(context.Context, *generated.UserSubscriptionMutation) (generated.Value, error)

// Mutate calls f(ctx, m).
func (f UserSubscriptionFunc) Mutate(ctx context.Context, m generated.Mutation) (generated.Value, error) {
	if mv, ok := m.(*generated.UserSubscriptionMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *generated.UserSubscriptionMutation", m)
}

// The UserSubscriptionChangeFunc type is an adapter to allow the use of ordinary
// function as UserSubscriptionChange mutator.
type UserSubscriptionChangeFunc func(context.Context, *generated.UserSubscriptionChangeMutation) (generated.Value, error)

// Mutate calls f(ctx, m).
func (f UserSubscriptionChangeFunc) Mutate(ctx context.Context, m generated.Mutation) (generated.Value, error) {
	if mv, ok := m.(*generated.UserSubscriptionChangeMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *generated.UserSubscriptionChangeMutation", m)
}
