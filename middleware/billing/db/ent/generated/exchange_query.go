...
func (eq *ExchangeQuery) IDs(ctx context.Context) (ids []uint32, err error) {
...
func (eq *ExchangeQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(exchange.Table, exchange.Columns, sqlgraph.NewFieldSpec(exchange.FieldID, field.TypeUint32))
	_spec.From = eq.sql
