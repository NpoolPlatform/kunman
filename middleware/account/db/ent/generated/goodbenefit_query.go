...
func (gbq *GoodBenefitQuery) Order(o ...goodbenefit.OrderOption) *GoodBenefitQuery {
...
func (gbq *GoodBenefitQuery) All(ctx context.Context) ([]*GoodBenefit, error) {
	...
	qr := querierAll[[]*GoodBenefit, *GoodBenefitQuery]()
	return withInterceptors[[]*GoodBenefit](ctx, gbq, qr, gbq.inters)
}
...
func (gbq *GoodBenefitQuery) IDs(ctx context.Context) (ids []uint32, err error) {
...
func (gbq *GoodBenefitQuery) Count(ctx context.Context) (int, error) {
	...
	return withInterceptors[int](ctx, gbq, querierCount[*GoodBenefitQuery](), gbq.inters)
}
...
func (gbq *GoodBenefitQuery) Clone() *GoodBenefitQuery {
	...
	return &GoodBenefitQuery{
		config:     gbq.config,
		ctx:        gbq.ctx.Clone(),
		order:      append([]goodbenefit.OrderOption{}, gbq.order...),
...
func (gbq *GoodBenefitQuery) GroupBy(field string, fields ...string) *GoodBenefitGroupBy {
	...
	grbuild := &GoodBenefitGroupBy{build: gbq}
...
func (gbq *GoodBenefitQuery) Select(fields ...string) *GoodBenefitSelect {
	...
	sbuild := &GoodBenefitSelect{GoodBenefitQuery: gbq}
	sbuild.label = goodbenefit.Label
	sbuild.flds, sbuild.scan = &gbq.ctx.Fields, sbuild.Scan
	return sbuild
}

// Aggregate returns a GoodBenefitSelect configured with the given aggregations.
func (gbq *GoodBenefitQuery) Aggregate(fns ...AggregateFunc) *GoodBenefitSelect {
...
func (gbq *GoodBenefitQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(goodbenefit.Table, goodbenefit.Columns, sqlgraph.NewFieldSpec(goodbenefit.FieldID, field.TypeUint32))
	_spec.From = gbq.sql
...
func (gbgb *GoodBenefitGroupBy) Scan(ctx context.Context, v any) error {
	ctx = setContextOp(ctx, gbgb.build.ctx, ent.OpQueryGroupBy)
	if err := gbgb.build.prepareQuery(ctx); err != nil {
		return err
	}
	return scanWithInterceptors[*GoodBenefitQuery, *GoodBenefitGroupBy](ctx, gbgb.build, gbgb, gbgb.build.inters, v)
}

func (gbgb *GoodBenefitGroupBy) sqlScan(ctx context.Context, root *GoodBenefitQuery, v any) error {
...
func (gbs *GoodBenefitSelect) Aggregate(fns ...AggregateFunc) *GoodBenefitSelect {
	gbs.fns = append(gbs.fns, fns...)
	return gbs
}

// Scan applies the selector query and scans the result into the given value.
func (gbs *GoodBenefitSelect) Scan(ctx context.Context, v any) error {
	ctx = setContextOp(ctx, gbs.ctx, ent.OpQuerySelect)
	if err := gbs.prepareQuery(ctx); err != nil {
		return err
	}
	return scanWithInterceptors[*GoodBenefitQuery, *GoodBenefitSelect](ctx, gbs.GoodBenefitQuery, gbs, gbs.inters, v)
}

func (gbs *GoodBenefitSelect) sqlScan(ctx context.Context, root *GoodBenefitQuery, v any) error {
