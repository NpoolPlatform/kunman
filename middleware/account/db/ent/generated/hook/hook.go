...
type ContractFunc func(context.Context, *generated.ContractMutation) (generated.Value, error)

// Mutate calls f(ctx, m).
func (f ContractFunc) Mutate(ctx context.Context, m generated.Mutation) (generated.Value, error) {
	if mv, ok := m.(*generated.ContractMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *generated.ContractMutation", m)
}

// The DepositFunc type is an adapter to allow the use of ordinary
// function as Deposit mutator.
type DepositFunc func(context.Context, *generated.DepositMutation) (generated.Value, error)

// Mutate calls f(ctx, m).
func (f DepositFunc) Mutate(ctx context.Context, m generated.Mutation) (generated.Value, error) {
	if mv, ok := m.(*generated.DepositMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *generated.DepositMutation", m)
}
...
type OrderBenefitFunc func(context.Context, *generated.OrderBenefitMutation) (generated.Value, error)

// Mutate calls f(ctx, m).
func (f OrderBenefitFunc) Mutate(ctx context.Context, m generated.Mutation) (generated.Value, error) {
	if mv, ok := m.(*generated.OrderBenefitMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *generated.OrderBenefitMutation", m)
}
...
type TransferFunc func(context.Context, *generated.TransferMutation) (generated.Value, error)

// Mutate calls f(ctx, m).
func (f TransferFunc) Mutate(ctx context.Context, m generated.Mutation) (generated.Value, error) {
	if mv, ok := m.(*generated.TransferMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *generated.TransferMutation", m)
}
