...
func (cq *ContractQuery) IDs(ctx context.Context) (ids []uint32, err error) {
...
func (cq *ContractQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(contract.Table, contract.Columns, sqlgraph.NewFieldSpec(contract.FieldID, field.TypeUint32))
	_spec.From = cq.sql
