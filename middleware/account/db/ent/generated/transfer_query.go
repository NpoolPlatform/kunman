...
func (tq *TransferQuery) IDs(ctx context.Context) (ids []uint32, err error) {
...
func (tq *TransferQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(transfer.Table, transfer.Columns, sqlgraph.NewFieldSpec(transfer.FieldID, field.TypeUint32))
	_spec.From = tq.sql
