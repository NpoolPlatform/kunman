...
func (fu *FiatUpdate) sqlSave(ctx context.Context) (n int, err error) {
	_spec := sqlgraph.NewUpdateSpec(fiat.Table, fiat.Columns, sqlgraph.NewFieldSpec(fiat.FieldID, field.TypeUint32))
	...
	if value, ok := fu.mutation.AddedCreatedAt(); ok {
		_spec.AddField(fiat.FieldCreatedAt, field.TypeUint32, value)
	}
	if value, ok := fu.mutation.UpdatedAt(); ok {
		_spec.SetField(fiat.FieldUpdatedAt, field.TypeUint32, value)
	}
	if value, ok := fu.mutation.AddedUpdatedAt(); ok {
		_spec.AddField(fiat.FieldUpdatedAt, field.TypeUint32, value)
	}
	...
	if value, ok := fu.mutation.AddedDeletedAt(); ok {
		_spec.AddField(fiat.FieldDeletedAt, field.TypeUint32, value)
	}
...
// Where appends a list predicates to the FiatUpdate builder.
func (fuo *FiatUpdateOne) Where(ps ...predicate.Fiat) *FiatUpdateOne {
...
// defaults sets the default values of the builder before save.
func (fuo *FiatUpdateOne) defaults() {
...
func (fuo *FiatUpdateOne) sqlSave(ctx context.Context) (_node *Fiat, err error) {
	...
	if !ok {
		return nil, &ValidationError{Name: "id", err: errors.New(`generated: missing "Fiat.id" for update`)}
	}
