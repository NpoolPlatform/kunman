...
func (*CoinFiatCurrency) scanValues(columns []string) ([]any, error) {
...
func (cfc *CoinFiatCurrency) assignValues(columns []string, values []any) error {
...
// Value returns the ent.Value that was dynamically selected and assigned to the CoinFiatCurrency.
// This includes values selected through modifiers, order, etc.
func (cfc *CoinFiatCurrency) Value(name string) (ent.Value, error) {
...
func (cfc *CoinFiatCurrency) Update() *CoinFiatCurrencyUpdateOne {
	return NewCoinFiatCurrencyClient(cfc.config).UpdateOne(cfc)
}
...
func (cfc *CoinFiatCurrency) Unwrap() *CoinFiatCurrency {
	...
	if !ok {
		panic("generated: CoinFiatCurrency is not a transactional entity")
	}
