...
func (cbc *ChainBaseCreate) defaults() {
...
func (cbc *ChainBaseCreate) check() error {
	if _, ok := cbc.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`generated: missing required field "ChainBase.created_at"`)}
	}
	if _, ok := cbc.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`generated: missing required field "ChainBase.updated_at"`)}
	}
	if _, ok := cbc.mutation.DeletedAt(); !ok {
		return &ValidationError{Name: "deleted_at", err: errors.New(`generated: missing required field "ChainBase.deleted_at"`)}
	}
	if _, ok := cbc.mutation.EntID(); !ok {
		return &ValidationError{Name: "ent_id", err: errors.New(`generated: missing required field "ChainBase.ent_id"`)}
	}
	return nil
}
...
func (cbc *ChainBaseCreate) createSpec() (*ChainBase, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(chainbase.Table, sqlgraph.NewFieldSpec(chainbase.FieldID, field.TypeUint32))
	)
...
func (u *ChainBaseUpsertOne) Exec(ctx context.Context) error {
	if len(u.create.conflict) == 0 {
		return errors.New("generated: missing options for ChainBaseCreate.OnConflict")
	}
...
func (u *ChainBaseUpsertBulk) Exec(ctx context.Context) error {
	...
	for i, b := range u.create.builders {
		if len(b.conflict) != 0 {
			return fmt.Errorf("generated: OnConflict was set for builder %d. Set it on the ChainBaseCreateBulk instead", i)
		}
	}
	if len(u.create.conflict) == 0 {
		return errors.New("generated: missing options for ChainBaseCreateBulk.OnConflict")
	}
	return u.create.Exec(ctx)
}
