...
func (tu *TranUpdate) sqlSave(ctx context.Context) (n int, err error) {
	_spec := sqlgraph.NewUpdateSpec(tran.Table, tran.Columns, sqlgraph.NewFieldSpec(tran.FieldID, field.TypeUint32))
	...
	if value, ok := tu.mutation.CreatedAt(); ok {
		_spec.SetField(tran.FieldCreatedAt, field.TypeUint32, value)
	}
	if value, ok := tu.mutation.AddedCreatedAt(); ok {
		_spec.AddField(tran.FieldCreatedAt, field.TypeUint32, value)
	}
	if value, ok := tu.mutation.UpdatedAt(); ok {
		_spec.SetField(tran.FieldUpdatedAt, field.TypeUint32, value)
	}
	if value, ok := tu.mutation.AddedUpdatedAt(); ok {
		_spec.AddField(tran.FieldUpdatedAt, field.TypeUint32, value)
	}
	if value, ok := tu.mutation.DeletedAt(); ok {
		_spec.SetField(tran.FieldDeletedAt, field.TypeUint32, value)
	}
	if value, ok := tu.mutation.AddedDeletedAt(); ok {
		_spec.AddField(tran.FieldDeletedAt, field.TypeUint32, value)
	}
	if value, ok := tu.mutation.EntID(); ok {
		_spec.SetField(tran.FieldEntID, field.TypeUUID, value)
	}
	if value, ok := tu.mutation.CoinTypeID(); ok {
		_spec.SetField(tran.FieldCoinTypeID, field.TypeUUID, value)
	}
	if tu.mutation.CoinTypeIDCleared() {
		_spec.ClearField(tran.FieldCoinTypeID, field.TypeUUID)
	}
	if value, ok := tu.mutation.FromAccountID(); ok {
		_spec.SetField(tran.FieldFromAccountID, field.TypeUUID, value)
	}
	if tu.mutation.FromAccountIDCleared() {
		_spec.ClearField(tran.FieldFromAccountID, field.TypeUUID)
	}
	if value, ok := tu.mutation.ToAccountID(); ok {
		_spec.SetField(tran.FieldToAccountID, field.TypeUUID, value)
	}
	if tu.mutation.ToAccountIDCleared() {
		_spec.ClearField(tran.FieldToAccountID, field.TypeUUID)
	}
	if value, ok := tu.mutation.Amount(); ok {
		_spec.SetField(tran.FieldAmount, field.TypeOther, value)
	}
	if tu.mutation.AmountCleared() {
		_spec.ClearField(tran.FieldAmount, field.TypeOther)
	}
	if value, ok := tu.mutation.FeeAmount(); ok {
		_spec.SetField(tran.FieldFeeAmount, field.TypeOther, value)
	}
	if tu.mutation.FeeAmountCleared() {
		_spec.ClearField(tran.FieldFeeAmount, field.TypeOther)
	}
	if value, ok := tu.mutation.ChainTxID(); ok {
		_spec.SetField(tran.FieldChainTxID, field.TypeString, value)
	}
	if tu.mutation.ChainTxIDCleared() {
		_spec.ClearField(tran.FieldChainTxID, field.TypeString)
	}
	if value, ok := tu.mutation.State(); ok {
		_spec.SetField(tran.FieldState, field.TypeString, value)
	}
	if tu.mutation.StateCleared() {
		_spec.ClearField(tran.FieldState, field.TypeString)
	}
	if value, ok := tu.mutation.Extra(); ok {
		_spec.SetField(tran.FieldExtra, field.TypeString, value)
	}
	if tu.mutation.ExtraCleared() {
		_spec.ClearField(tran.FieldExtra, field.TypeString)
	}
	if value, ok := tu.mutation.GetType(); ok {
		_spec.SetField(tran.FieldType, field.TypeString, value)
	}
	if tu.mutation.TypeCleared() {
		_spec.ClearField(tran.FieldType, field.TypeString)
	}
...
// Where appends a list predicates to the TranUpdate builder.
func (tuo *TranUpdateOne) Where(ps ...predicate.Tran) *TranUpdateOne {
...
// defaults sets the default values of the builder before save.
func (tuo *TranUpdateOne) defaults() {
...
func (tuo *TranUpdateOne) sqlSave(ctx context.Context) (_node *Tran, err error) {
	...
	if !ok {
		return nil, &ValidationError{Name: "id", err: errors.New(`generated: missing "Tran.id" for update`)}
	}
