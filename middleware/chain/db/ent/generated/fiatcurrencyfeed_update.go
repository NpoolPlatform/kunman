...
func (fcfu *FiatCurrencyFeedUpdate) defaults() {
...
func (fcfu *FiatCurrencyFeedUpdate) sqlSave(ctx context.Context) (n int, err error) {
	_spec := sqlgraph.NewUpdateSpec(fiatcurrencyfeed.Table, fiatcurrencyfeed.Columns, sqlgraph.NewFieldSpec(fiatcurrencyfeed.FieldID, field.TypeUint32))
	...
	if value, ok := fcfu.mutation.AddedCreatedAt(); ok {
		_spec.AddField(fiatcurrencyfeed.FieldCreatedAt, field.TypeUint32, value)
	}
	...
	if value, ok := fcfu.mutation.AddedUpdatedAt(); ok {
		_spec.AddField(fiatcurrencyfeed.FieldUpdatedAt, field.TypeUint32, value)
	}
	...
	if value, ok := fcfu.mutation.AddedDeletedAt(); ok {
		_spec.AddField(fiatcurrencyfeed.FieldDeletedAt, field.TypeUint32, value)
	}
	...
	if fcfu.mutation.FiatIDCleared() {
		_spec.ClearField(fiatcurrencyfeed.FieldFiatID, field.TypeUUID)
	}
	...
	if fcfu.mutation.FeedTypeCleared() {
		_spec.ClearField(fiatcurrencyfeed.FieldFeedType, field.TypeString)
	}
	...
	if fcfu.mutation.FeedFiatNameCleared() {
		_spec.ClearField(fiatcurrencyfeed.FieldFeedFiatName, field.TypeString)
	}
	...
	if fcfu.mutation.DisabledCleared() {
		_spec.ClearField(fiatcurrencyfeed.FieldDisabled, field.TypeBool)
	}
...
// Where appends a list predicates to the FiatCurrencyFeedUpdate builder.
func (fcfuo *FiatCurrencyFeedUpdateOne) Where(ps ...predicate.FiatCurrencyFeed) *FiatCurrencyFeedUpdateOne {
...
// defaults sets the default values of the builder before save.
func (fcfuo *FiatCurrencyFeedUpdateOne) defaults() {
...
func (fcfuo *FiatCurrencyFeedUpdateOne) sqlSave(ctx context.Context) (_node *FiatCurrencyFeed, err error) {
	...
	if !ok {
		return nil, &ValidationError{Name: "id", err: errors.New(`generated: missing "FiatCurrencyFeed.id" for update`)}
	}
