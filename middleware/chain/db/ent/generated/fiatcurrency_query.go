...
func (fcq *FiatCurrencyQuery) IDs(ctx context.Context) (ids []uint32, err error) {
...
func (fcq *FiatCurrencyQuery) Clone() *FiatCurrencyQuery {
	...
	return &FiatCurrencyQuery{
		...
		sql:       fcq.sql.Clone(),
		path:      fcq.path,
		modifiers: append([]func(*sql.Selector){}, fcq.modifiers...),
	}
}
...
func (fcq *FiatCurrencyQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(fiatcurrency.Table, fiatcurrency.Columns, sqlgraph.NewFieldSpec(fiatcurrency.FieldID, field.TypeUint32))
	_spec.From = fcq.sql
