...
func (cufc *CoinUsedForCreate) Save(ctx context.Context) (*CoinUsedFor, error) {
	cufc.defaults()
	return withHooks(ctx, cufc.sqlSave, cufc.mutation, cufc.hooks)
}
...
func (cufc *CoinUsedForCreate) defaults() {
...
func (cufc *CoinUsedForCreate) check() error {
	if _, ok := cufc.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`generated: missing required field "CoinUsedFor.created_at"`)}
	}
	if _, ok := cufc.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`generated: missing required field "CoinUsedFor.updated_at"`)}
	}
	if _, ok := cufc.mutation.DeletedAt(); !ok {
		return &ValidationError{Name: "deleted_at", err: errors.New(`generated: missing required field "CoinUsedFor.deleted_at"`)}
	}
	if _, ok := cufc.mutation.EntID(); !ok {
		return &ValidationError{Name: "ent_id", err: errors.New(`generated: missing required field "CoinUsedFor.ent_id"`)}
	}
	return nil
}
...
func (cufc *CoinUsedForCreate) sqlSave(ctx context.Context) (*CoinUsedFor, error) {
	...
	cufc.mutation.id = &_node.ID
	cufc.mutation.done = true
	return _node, nil
}
...
func (cufc *CoinUsedForCreate) createSpec() (*CoinUsedFor, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(coinusedfor.Table, sqlgraph.NewFieldSpec(coinusedfor.FieldID, field.TypeUint32))
	)
...
func (u *CoinUsedForUpsertOne) Exec(ctx context.Context) error {
	if len(u.create.conflict) == 0 {
		return errors.New("generated: missing options for CoinUsedForCreate.OnConflict")
	}
...
func (u *CoinUsedForUpsertBulk) Exec(ctx context.Context) error {
	...
	for i, b := range u.create.builders {
		if len(b.conflict) != 0 {
			return fmt.Errorf("generated: OnConflict was set for builder %d. Set it on the CoinUsedForCreateBulk instead", i)
		}
	}
	if len(u.create.conflict) == 0 {
		return errors.New("generated: missing options for CoinUsedForCreateBulk.OnConflict")
	}
	return u.create.Exec(ctx)
}
