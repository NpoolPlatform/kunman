...
func (ceu *CoinExtraUpdate) defaults() {
...
func (ceu *CoinExtraUpdate) sqlSave(ctx context.Context) (n int, err error) {
	_spec := sqlgraph.NewUpdateSpec(coinextra.Table, coinextra.Columns, sqlgraph.NewFieldSpec(coinextra.FieldID, field.TypeUint32))
	...
	if value, ok := ceu.mutation.AddedCreatedAt(); ok {
		_spec.AddField(coinextra.FieldCreatedAt, field.TypeUint32, value)
	}
	...
	if value, ok := ceu.mutation.AddedUpdatedAt(); ok {
		_spec.AddField(coinextra.FieldUpdatedAt, field.TypeUint32, value)
	}
	...
	if value, ok := ceu.mutation.AddedDeletedAt(); ok {
		_spec.AddField(coinextra.FieldDeletedAt, field.TypeUint32, value)
	}
	...
	if ceu.mutation.CoinTypeIDCleared() {
		_spec.ClearField(coinextra.FieldCoinTypeID, field.TypeUUID)
	}
	...
	if ceu.mutation.StableUsdCleared() {
		_spec.ClearField(coinextra.FieldStableUsd, field.TypeBool)
	}
...
// Where appends a list predicates to the CoinExtraUpdate builder.
func (ceuo *CoinExtraUpdateOne) Where(ps ...predicate.CoinExtra) *CoinExtraUpdateOne {
...
// defaults sets the default values of the builder before save.
func (ceuo *CoinExtraUpdateOne) defaults() {
...
func (ceuo *CoinExtraUpdateOne) sqlSave(ctx context.Context) (_node *CoinExtra, err error) {
	...
	if !ok {
		return nil, &ValidationError{Name: "id", err: errors.New(`generated: missing "CoinExtra.id" for update`)}
	}
