...
func (*Currency) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case currency.FieldID, currency.FieldCreatedAt, currency.FieldUpdatedAt, currency.FieldDeletedAt:
			values[i] = new(sql.NullInt64)
		case currency.FieldFeedType:
			values[i] = new(sql.NullString)
		case currency.FieldEntID, currency.FieldCoinTypeID:
...
func (c *Currency) Unwrap() *Currency {
	...
	if !ok {
		panic("generated: Currency is not a transactional entity")
	}
