...
func (*Tran) scanValues(columns []string) ([]any, error) {
...
// to the Tran fields.
func (t *Tran) assignValues(columns []string, values []any) error {
...
// Value returns the ent.Value that was dynamically selected and assigned to the Tran.
// This includes values selected through modifiers, order, etc.
func (t *Tran) Value(name string) (ent.Value, error) {
...
func (t *Tran) Update() *TranUpdateOne {
	return NewTranClient(t.config).UpdateOne(t)
}
...
func (t *Tran) Unwrap() *Tran {
	...
	if !ok {
		panic("generated: Tran is not a transactional entity")
	}
