...
func (fcc *FiatCurrencyCreate) SetEntID(u uuid.UUID) *FiatCurrencyCreate {
	fcc.mutation.SetEntID(u)
	return fcc
}

// SetNillableEntID sets the "ent_id" field if the given value is not nil.
func (fcc *FiatCurrencyCreate) SetNillableEntID(u *uuid.UUID) *FiatCurrencyCreate {
	if u != nil {
		fcc.SetEntID(*u)
	}
	return fcc
...
func (fcc *FiatCurrencyCreate) SetID(u uint32) *FiatCurrencyCreate {
...
func (fcc *FiatCurrencyCreate) defaults() {
	...
	if _, ok := fcc.mutation.EntID(); !ok {
		v := fiatcurrency.DefaultEntID()
		fcc.mutation.SetEntID(v)
	}
...
func (fcc *FiatCurrencyCreate) check() error {
	if _, ok := fcc.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`generated: missing required field "FiatCurrency.created_at"`)}
	}
	if _, ok := fcc.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`generated: missing required field "FiatCurrency.updated_at"`)}
	}
	if _, ok := fcc.mutation.DeletedAt(); !ok {
		return &ValidationError{Name: "deleted_at", err: errors.New(`generated: missing required field "FiatCurrency.deleted_at"`)}
	}
	if _, ok := fcc.mutation.EntID(); !ok {
		return &ValidationError{Name: "ent_id", err: errors.New(`generated: missing required field "FiatCurrency.ent_id"`)}
	}
	return nil
}
...
func (fcc *FiatCurrencyCreate) createSpec() (*FiatCurrency, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(fiatcurrency.Table, sqlgraph.NewFieldSpec(fiatcurrency.FieldID, field.TypeUint32))
	)
	...
	if value, ok := fcc.mutation.EntID(); ok {
...
// SetEntID sets the "ent_id" field.
func (u *FiatCurrencyUpsert) SetEntID(v uuid.UUID) *FiatCurrencyUpsert {
	u.Set(fiatcurrency.FieldEntID, v)
	return u
}

// UpdateEntID sets the "ent_id" field to the value that was provided on create.
func (u *FiatCurrencyUpsert) UpdateEntID() *FiatCurrencyUpsert {
	u.SetExcluded(fiatcurrency.FieldEntID)
	return u
}
...
// SetEntID sets the "ent_id" field.
func (u *FiatCurrencyUpsertOne) SetEntID(v uuid.UUID) *FiatCurrencyUpsertOne {
	return u.Update(func(s *FiatCurrencyUpsert) {
		s.SetEntID(v)
	})
}
...
// UpdateEntID sets the "ent_id" field to the value that was provided on create.
func (u *FiatCurrencyUpsertOne) UpdateEntID() *FiatCurrencyUpsertOne {
	return u.Update(func(s *FiatCurrencyUpsert) {
		s.UpdateEntID()
	})
}
...
func (u *FiatCurrencyUpsertOne) Exec(ctx context.Context) error {
	if len(u.create.conflict) == 0 {
		return errors.New("generated: missing options for FiatCurrencyCreate.OnConflict")
	}
...
func (u *FiatCurrencyUpsertOne) ID(ctx context.Context) (id uint32, err error) {
...
func (u *FiatCurrencyUpsertOne) IDX(ctx context.Context) uint32 {
	id, err := u.ID(ctx)
	if err != nil {
		panic(err)
	}
...
// SetEntID sets the "ent_id" field.
func (u *FiatCurrencyUpsertBulk) SetEntID(v uuid.UUID) *FiatCurrencyUpsertBulk {
	return u.Update(func(s *FiatCurrencyUpsert) {
		s.SetEntID(v)
	})
}
...
// UpdateEntID sets the "ent_id" field to the value that was provided on create.
func (u *FiatCurrencyUpsertBulk) UpdateEntID() *FiatCurrencyUpsertBulk {
	return u.Update(func(s *FiatCurrencyUpsert) {
		s.UpdateEntID()
	})
}
...
func (u *FiatCurrencyUpsertBulk) Exec(ctx context.Context) error {
	...
	for i, b := range u.create.builders {
		if len(b.conflict) != 0 {
			return fmt.Errorf("generated: OnConflict was set for builder %d. Set it on the FiatCurrencyCreateBulk instead", i)
		}
	}
	if len(u.create.conflict) == 0 {
		return errors.New("generated: missing options for FiatCurrencyCreateBulk.OnConflict")
	}
	return u.create.Exec(ctx)
}
