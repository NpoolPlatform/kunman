...
func (cfu *CoinFiatUpdate) defaults() {
...
func (cfu *CoinFiatUpdate) sqlSave(ctx context.Context) (n int, err error) {
	_spec := sqlgraph.NewUpdateSpec(coinfiat.Table, coinfiat.Columns, sqlgraph.NewFieldSpec(coinfiat.FieldID, field.TypeUint32))
	...
	if value, ok := cfu.mutation.AddedCreatedAt(); ok {
		_spec.AddField(coinfiat.FieldCreatedAt, field.TypeUint32, value)
	}
	...
	if value, ok := cfu.mutation.AddedUpdatedAt(); ok {
		_spec.AddField(coinfiat.FieldUpdatedAt, field.TypeUint32, value)
	}
	...
	if value, ok := cfu.mutation.AddedDeletedAt(); ok {
		_spec.AddField(coinfiat.FieldDeletedAt, field.TypeUint32, value)
	}
	...
	if cfu.mutation.FeedTypeCleared() {
		_spec.ClearField(coinfiat.FieldFeedType, field.TypeString)
	}
...
// Where appends a list predicates to the CoinFiatUpdate builder.
func (cfuo *CoinFiatUpdateOne) Where(ps ...predicate.CoinFiat) *CoinFiatUpdateOne {
...
// defaults sets the default values of the builder before save.
func (cfuo *CoinFiatUpdateOne) defaults() {
...
func (cfuo *CoinFiatUpdateOne) sqlSave(ctx context.Context) (_node *CoinFiat, err error) {
	...
	if !ok {
		return nil, &ValidationError{Name: "id", err: errors.New(`generated: missing "CoinFiat.id" for update`)}
	}
