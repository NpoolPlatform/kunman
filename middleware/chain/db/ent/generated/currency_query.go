...
func (cq *CurrencyQuery) FirstID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
...
func (cq *CurrencyQuery) FirstIDX(ctx context.Context) uint32 {
...
func (cq *CurrencyQuery) OnlyID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
...
func (cq *CurrencyQuery) OnlyIDX(ctx context.Context) uint32 {
...
func (cq *CurrencyQuery) IDs(ctx context.Context) (ids []uint32, err error) {
...
func (cq *CurrencyQuery) IDsX(ctx context.Context) []uint32 {
	ids, err := cq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (cq *CurrencyQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(currency.Table, currency.Columns, sqlgraph.NewFieldSpec(currency.FieldID, field.TypeUint32))
	_spec.From = cq.sql
