...
func (cdc *CoinDescriptionCreate) defaults() {
...
func (cdc *CoinDescriptionCreate) check() error {
	if _, ok := cdc.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`generated: missing required field "CoinDescription.created_at"`)}
	}
	if _, ok := cdc.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`generated: missing required field "CoinDescription.updated_at"`)}
	}
	if _, ok := cdc.mutation.DeletedAt(); !ok {
		return &ValidationError{Name: "deleted_at", err: errors.New(`generated: missing required field "CoinDescription.deleted_at"`)}
	}
	if _, ok := cdc.mutation.EntID(); !ok {
		return &ValidationError{Name: "ent_id", err: errors.New(`generated: missing required field "CoinDescription.ent_id"`)}
	}
	return nil
}
...
func (cdc *CoinDescriptionCreate) createSpec() (*CoinDescription, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(coindescription.Table, sqlgraph.NewFieldSpec(coindescription.FieldID, field.TypeUint32))
	)
...
func (u *CoinDescriptionUpsertOne) Exec(ctx context.Context) error {
	if len(u.create.conflict) == 0 {
		return errors.New("generated: missing options for CoinDescriptionCreate.OnConflict")
	}
...
func (u *CoinDescriptionUpsertBulk) Exec(ctx context.Context) error {
	...
	for i, b := range u.create.builders {
		if len(b.conflict) != 0 {
			return fmt.Errorf("generated: OnConflict was set for builder %d. Set it on the CoinDescriptionCreateBulk instead", i)
		}
	}
	if len(u.create.conflict) == 0 {
		return errors.New("generated: missing options for CoinDescriptionCreateBulk.OnConflict")
	}
	return u.create.Exec(ctx)
}
