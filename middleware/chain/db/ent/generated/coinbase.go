...
func (*CoinBase) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case coinbase.FieldID, coinbase.FieldCreatedAt, coinbase.FieldUpdatedAt, coinbase.FieldDeletedAt:
...
func (cb *CoinBase) assignValues(columns []string, values []any) error {
...
// Value returns the ent.Value that was dynamically selected and assigned to the CoinBase.
// This includes values selected through modifiers, order, etc.
func (cb *CoinBase) Value(name string) (ent.Value, error) {
...
func (cb *CoinBase) Update() *CoinBaseUpdateOne {
	return NewCoinBaseClient(cb.config).UpdateOne(cb)
}
...
func (cb *CoinBase) Unwrap() *CoinBase {
	...
	if !ok {
		panic("generated: CoinBase is not a transactional entity")
	}
