...
func (cfchc *CoinFiatCurrencyHistoryCreate) Save(ctx context.Context) (*CoinFiatCurrencyHistory, error) {
	cfchc.defaults()
	return withHooks(ctx, cfchc.sqlSave, cfchc.mutation, cfchc.hooks)
}
...
func (cfchc *CoinFiatCurrencyHistoryCreate) defaults() {
...
func (cfchc *CoinFiatCurrencyHistoryCreate) check() error {
	if _, ok := cfchc.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`generated: missing required field "CoinFiatCurrencyHistory.created_at"`)}
	}
	if _, ok := cfchc.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`generated: missing required field "CoinFiatCurrencyHistory.updated_at"`)}
	}
	if _, ok := cfchc.mutation.DeletedAt(); !ok {
		return &ValidationError{Name: "deleted_at", err: errors.New(`generated: missing required field "CoinFiatCurrencyHistory.deleted_at"`)}
	}
	if _, ok := cfchc.mutation.EntID(); !ok {
		return &ValidationError{Name: "ent_id", err: errors.New(`generated: missing required field "CoinFiatCurrencyHistory.ent_id"`)}
	}
	return nil
}
...
func (cfchc *CoinFiatCurrencyHistoryCreate) sqlSave(ctx context.Context) (*CoinFiatCurrencyHistory, error) {
	...
	cfchc.mutation.id = &_node.ID
	cfchc.mutation.done = true
	return _node, nil
}
...
func (cfchc *CoinFiatCurrencyHistoryCreate) createSpec() (*CoinFiatCurrencyHistory, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(coinfiatcurrencyhistory.Table, sqlgraph.NewFieldSpec(coinfiatcurrencyhistory.FieldID, field.TypeUint32))
	)
...
func (u *CoinFiatCurrencyHistoryUpsertOne) Exec(ctx context.Context) error {
	if len(u.create.conflict) == 0 {
		return errors.New("generated: missing options for CoinFiatCurrencyHistoryCreate.OnConflict")
	}
...
func (u *CoinFiatCurrencyHistoryUpsertBulk) Exec(ctx context.Context) error {
	...
	for i, b := range u.create.builders {
		if len(b.conflict) != 0 {
			return fmt.Errorf("generated: OnConflict was set for builder %d. Set it on the CoinFiatCurrencyHistoryCreateBulk instead", i)
		}
	}
	if len(u.create.conflict) == 0 {
		return errors.New("generated: missing options for CoinFiatCurrencyHistoryCreateBulk.OnConflict")
	}
	return u.create.Exec(ctx)
}
