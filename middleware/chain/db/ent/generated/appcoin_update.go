...
func (acu *AppCoinUpdate) AppendDisplayNames(s []string) *AppCoinUpdate {
	acu.mutation.AppendDisplayNames(s)
	return acu
}
...
func (acu *AppCoinUpdate) defaults() {
...
func (acu *AppCoinUpdate) sqlSave(ctx context.Context) (n int, err error) {
	_spec := sqlgraph.NewUpdateSpec(appcoin.Table, appcoin.Columns, sqlgraph.NewFieldSpec(appcoin.FieldID, field.TypeUint32))
	...
	if value, ok := acu.mutation.CreatedAt(); ok {
		_spec.SetField(appcoin.FieldCreatedAt, field.TypeUint32, value)
	}
	if value, ok := acu.mutation.AddedCreatedAt(); ok {
		_spec.AddField(appcoin.FieldCreatedAt, field.TypeUint32, value)
	}
	if value, ok := acu.mutation.UpdatedAt(); ok {
		_spec.SetField(appcoin.FieldUpdatedAt, field.TypeUint32, value)
	}
	if value, ok := acu.mutation.AddedUpdatedAt(); ok {
		_spec.AddField(appcoin.FieldUpdatedAt, field.TypeUint32, value)
	}
	if value, ok := acu.mutation.DeletedAt(); ok {
		_spec.SetField(appcoin.FieldDeletedAt, field.TypeUint32, value)
	}
	if value, ok := acu.mutation.AddedDeletedAt(); ok {
		_spec.AddField(appcoin.FieldDeletedAt, field.TypeUint32, value)
	}
	if value, ok := acu.mutation.EntID(); ok {
		_spec.SetField(appcoin.FieldEntID, field.TypeUUID, value)
	}
	if value, ok := acu.mutation.AppID(); ok {
		_spec.SetField(appcoin.FieldAppID, field.TypeUUID, value)
	}
	if acu.mutation.AppIDCleared() {
		_spec.ClearField(appcoin.FieldAppID, field.TypeUUID)
	}
	if value, ok := acu.mutation.CoinTypeID(); ok {
		_spec.SetField(appcoin.FieldCoinTypeID, field.TypeUUID, value)
	}
	if acu.mutation.CoinTypeIDCleared() {
		_spec.ClearField(appcoin.FieldCoinTypeID, field.TypeUUID)
	}
	if value, ok := acu.mutation.Name(); ok {
		_spec.SetField(appcoin.FieldName, field.TypeString, value)
	}
	if acu.mutation.NameCleared() {
		_spec.ClearField(appcoin.FieldName, field.TypeString)
	}
	if value, ok := acu.mutation.DisplayNames(); ok {
		_spec.SetField(appcoin.FieldDisplayNames, field.TypeJSON, value)
	}
	if value, ok := acu.mutation.AppendedDisplayNames(); ok {
		_spec.AddModifier(func(u *sql.UpdateBuilder) {
			sqljson.Append(u, appcoin.FieldDisplayNames, value)
		})
	}
	if acu.mutation.DisplayNamesCleared() {
		_spec.ClearField(appcoin.FieldDisplayNames, field.TypeJSON)
	}
	if value, ok := acu.mutation.Logo(); ok {
		_spec.SetField(appcoin.FieldLogo, field.TypeString, value)
	}
	if acu.mutation.LogoCleared() {
		_spec.ClearField(appcoin.FieldLogo, field.TypeString)
	}
	if value, ok := acu.mutation.ForPay(); ok {
		_spec.SetField(appcoin.FieldForPay, field.TypeBool, value)
	}
	if acu.mutation.ForPayCleared() {
		_spec.ClearField(appcoin.FieldForPay, field.TypeBool)
	}
	if value, ok := acu.mutation.WithdrawAutoReviewAmount(); ok {
		_spec.SetField(appcoin.FieldWithdrawAutoReviewAmount, field.TypeOther, value)
	}
	if acu.mutation.WithdrawAutoReviewAmountCleared() {
		_spec.ClearField(appcoin.FieldWithdrawAutoReviewAmount, field.TypeOther)
	}
	if value, ok := acu.mutation.ProductPage(); ok {
		_spec.SetField(appcoin.FieldProductPage, field.TypeString, value)
	}
	if acu.mutation.ProductPageCleared() {
		_spec.ClearField(appcoin.FieldProductPage, field.TypeString)
	}
	if value, ok := acu.mutation.Disabled(); ok {
		_spec.SetField(appcoin.FieldDisabled, field.TypeBool, value)
	}
	if acu.mutation.DisabledCleared() {
		_spec.ClearField(appcoin.FieldDisabled, field.TypeBool)
	}
	if value, ok := acu.mutation.DailyRewardAmount(); ok {
		_spec.SetField(appcoin.FieldDailyRewardAmount, field.TypeOther, value)
	}
	if acu.mutation.DailyRewardAmountCleared() {
		_spec.ClearField(appcoin.FieldDailyRewardAmount, field.TypeOther)
	}
	if value, ok := acu.mutation.Display(); ok {
		_spec.SetField(appcoin.FieldDisplay, field.TypeBool, value)
	}
	if acu.mutation.DisplayCleared() {
		_spec.ClearField(appcoin.FieldDisplay, field.TypeBool)
	}
	if value, ok := acu.mutation.DisplayIndex(); ok {
		_spec.SetField(appcoin.FieldDisplayIndex, field.TypeUint32, value)
	}
	if value, ok := acu.mutation.AddedDisplayIndex(); ok {
		_spec.AddField(appcoin.FieldDisplayIndex, field.TypeUint32, value)
	}
	if acu.mutation.DisplayIndexCleared() {
		_spec.ClearField(appcoin.FieldDisplayIndex, field.TypeUint32)
	}
	if value, ok := acu.mutation.MaxAmountPerWithdraw(); ok {
		_spec.SetField(appcoin.FieldMaxAmountPerWithdraw, field.TypeOther, value)
	}
	if acu.mutation.MaxAmountPerWithdrawCleared() {
		_spec.ClearField(appcoin.FieldMaxAmountPerWithdraw, field.TypeOther)
	}
...
// AppendDisplayNames appends s to the "display_names" field.
func (acuo *AppCoinUpdateOne) AppendDisplayNames(s []string) *AppCoinUpdateOne {
	acuo.mutation.AppendDisplayNames(s)
	return acuo
}
...
// Where appends a list predicates to the AppCoinUpdate builder.
func (acuo *AppCoinUpdateOne) Where(ps ...predicate.AppCoin) *AppCoinUpdateOne {
...
// defaults sets the default values of the builder before save.
func (acuo *AppCoinUpdateOne) defaults() {
...
func (acuo *AppCoinUpdateOne) sqlSave(ctx context.Context) (_node *AppCoin, err error) {
	...
	if !ok {
		return nil, &ValidationError{Name: "id", err: errors.New(`generated: missing "AppCoin.id" for update`)}
	}
	...
	if value, ok := acuo.mutation.AppendedDisplayNames(); ok {
		_spec.AddModifier(func(u *sql.UpdateBuilder) {
			sqljson.Append(u, appcoin.FieldDisplayNames, value)
		})
	}
