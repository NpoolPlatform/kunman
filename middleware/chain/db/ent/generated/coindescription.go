...
func (*CoinDescription) scanValues(columns []string) ([]any, error) {
...
func (cd *CoinDescription) assignValues(columns []string, values []any) error {
...
// Value returns the ent.Value that was dynamically selected and assigned to the CoinDescription.
// This includes values selected through modifiers, order, etc.
func (cd *CoinDescription) Value(name string) (ent.Value, error) {
...
func (cd *CoinDescription) Update() *CoinDescriptionUpdateOne {
	return NewCoinDescriptionClient(cd.config).UpdateOne(cd)
}
...
func (cd *CoinDescription) Unwrap() *CoinDescription {
	...
	if !ok {
		panic("generated: CoinDescription is not a transactional entity")
	}
