...
func (*FiatCurrencyHistory) scanValues(columns []string) ([]any, error) {
...
func (fch *FiatCurrencyHistory) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		default:
			fch.selectValues.Set(columns[i], values[i])
		}
	}
	return nil
}

// Value returns the ent.Value that was dynamically selected and assigned to the FiatCurrencyHistory.
// This includes values selected through modifiers, order, etc.
func (fch *FiatCurrencyHistory) Value(name string) (ent.Value, error) {
	return fch.selectValues.Get(name)
}
...
func (fch *FiatCurrencyHistory) Update() *FiatCurrencyHistoryUpdateOne {
	return NewFiatCurrencyHistoryClient(fch.config).UpdateOne(fch)
}
...
func (fch *FiatCurrencyHistory) Unwrap() *FiatCurrencyHistory {
	...
	if !ok {
		panic("generated: FiatCurrencyHistory is not a transactional entity")
	}
