...
type FiatCurrencyHistoryQuery struct {
	config
	ctx        *QueryContext
	order      []fiatcurrencyhistory.OrderOption
	inters     []Interceptor
...
func (fchq *FiatCurrencyHistoryQuery) Unique(unique bool) *FiatCurrencyHistoryQuery {
	fchq.ctx.Unique = &unique
	return fchq
}

// Order specifies how the records should be ordered.
func (fchq *FiatCurrencyHistoryQuery) Order(o ...fiatcurrencyhistory.OrderOption) *FiatCurrencyHistoryQuery {
...
func (fchq *FiatCurrencyHistoryQuery) First(ctx context.Context) (*FiatCurrencyHistory, error) {
	nodes, err := fchq.Limit(1).All(setContextOp(ctx, fchq.ctx, ent.OpQueryFirst))
	if err != nil {
		return nil, err
	}
	if len(nodes) == 0 {
...
func (fchq *FiatCurrencyHistoryQuery) FirstID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
	if ids, err = fchq.Limit(1).IDs(setContextOp(ctx, fchq.ctx, ent.OpQueryFirstID)); err != nil {
		return
	}
	if len(ids) == 0 {
...
func (fchq *FiatCurrencyHistoryQuery) Only(ctx context.Context) (*FiatCurrencyHistory, error) {
	nodes, err := fchq.Limit(2).All(setContextOp(ctx, fchq.ctx, ent.OpQueryOnly))
	if err != nil {
		return nil, err
	}
	switch len(nodes) {
...
func (fchq *FiatCurrencyHistoryQuery) OnlyID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
	if ids, err = fchq.Limit(2).IDs(setContextOp(ctx, fchq.ctx, ent.OpQueryOnlyID)); err != nil {
		return
	}
	switch len(ids) {
	case 1:
...
func (fchq *FiatCurrencyHistoryQuery) All(ctx context.Context) ([]*FiatCurrencyHistory, error) {
	ctx = setContextOp(ctx, fchq.ctx, ent.OpQueryAll)
	if err := fchq.prepareQuery(ctx); err != nil {
		return nil, err
	}
	qr := querierAll[[]*FiatCurrencyHistory, *FiatCurrencyHistoryQuery]()
	return withInterceptors[[]*FiatCurrencyHistory](ctx, fchq, qr, fchq.inters)
}
...
func (fchq *FiatCurrencyHistoryQuery) IDs(ctx context.Context) (ids []uint32, err error) {
	if fchq.ctx.Unique == nil && fchq.path != nil {
		fchq.Unique(true)
	}
...
func (fchq *FiatCurrencyHistoryQuery) Count(ctx context.Context) (int, error) {
	ctx = setContextOp(ctx, fchq.ctx, ent.OpQueryCount)
	if err := fchq.prepareQuery(ctx); err != nil {
		return 0, err
	}
	return withInterceptors[int](ctx, fchq, querierCount[*FiatCurrencyHistoryQuery](), fchq.inters)
}
...
func (fchq *FiatCurrencyHistoryQuery) Exist(ctx context.Context) (bool, error) {
	ctx = setContextOp(ctx, fchq.ctx, ent.OpQueryExist)
	switch _, err := fchq.FirstID(ctx); {
	case IsNotFound(err):
		return false, nil
	case err != nil:
...
func (fchq *FiatCurrencyHistoryQuery) Clone() *FiatCurrencyHistoryQuery {
	...
	return &FiatCurrencyHistoryQuery{
		config:     fchq.config,
		ctx:        fchq.ctx.Clone(),
		order:      append([]fiatcurrencyhistory.OrderOption{}, fchq.order...),
		inters:     append([]Interceptor{}, fchq.inters...),
		predicates: append([]predicate.FiatCurrencyHistory{}, fchq.predicates...),
		// clone intermediate query.
		sql:       fchq.sql.Clone(),
		path:      fchq.path,
		modifiers: append([]func(*sql.Selector){}, fchq.modifiers...),
	}
}
...
func (fchq *FiatCurrencyHistoryQuery) GroupBy(field string, fields ...string) *FiatCurrencyHistoryGroupBy {
	fchq.ctx.Fields = append([]string{field}, fields...)
	grbuild := &FiatCurrencyHistoryGroupBy{build: fchq}
	grbuild.flds = &fchq.ctx.Fields
...
func (fchq *FiatCurrencyHistoryQuery) Select(fields ...string) *FiatCurrencyHistorySelect {
	fchq.ctx.Fields = append(fchq.ctx.Fields, fields...)
	sbuild := &FiatCurrencyHistorySelect{FiatCurrencyHistoryQuery: fchq}
	sbuild.label = fiatcurrencyhistory.Label
	sbuild.flds, sbuild.scan = &fchq.ctx.Fields, sbuild.Scan
	return sbuild
}

// Aggregate returns a FiatCurrencyHistorySelect configured with the given aggregations.
func (fchq *FiatCurrencyHistoryQuery) Aggregate(fns ...AggregateFunc) *FiatCurrencyHistorySelect {
	return fchq.Select().Aggregate(fns...)
}

func (fchq *FiatCurrencyHistoryQuery) prepareQuery(ctx context.Context) error {
	for _, inter := range fchq.inters {
		if inter == nil {
			return fmt.Errorf("generated: uninitialized interceptor (forgotten import generated/runtime?)")
		}
		if trv, ok := inter.(Traverser); ok {
			if err := trv.Traverse(ctx, fchq); err != nil {
				return err
			}
		}
	}
	for _, f := range fchq.ctx.Fields {
...
func (fchq *FiatCurrencyHistoryQuery) sqlCount(ctx context.Context) (int, error) {
	...
	_spec.Node.Columns = fchq.ctx.Fields
	if len(fchq.ctx.Fields) > 0 {
		_spec.Unique = fchq.ctx.Unique != nil && *fchq.ctx.Unique
	}
	return sqlgraph.CountNodes(ctx, fchq.driver, _spec)
}

func (fchq *FiatCurrencyHistoryQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(fiatcurrencyhistory.Table, fiatcurrencyhistory.Columns, sqlgraph.NewFieldSpec(fiatcurrencyhistory.FieldID, field.TypeUint32))
	_spec.From = fchq.sql
	if unique := fchq.ctx.Unique; unique != nil {
		_spec.Unique = *unique
	} else if fchq.path != nil {
		_spec.Unique = true
	}
	if fields := fchq.ctx.Fields; len(fields) > 0 {
	...
	if limit := fchq.ctx.Limit; limit != nil {
		_spec.Limit = *limit
	}
	if offset := fchq.ctx.Offset; offset != nil {
		_spec.Offset = *offset
	}
...
func (fchq *FiatCurrencyHistoryQuery) sqlQuery(ctx context.Context) *sql.Selector {
	...
	if fchq.ctx.Unique != nil && *fchq.ctx.Unique {
		selector.Distinct()
	}
...
type FiatCurrencyHistoryGroupBy struct {
	selector
	build *FiatCurrencyHistoryQuery
}
...
func (fchgb *FiatCurrencyHistoryGroupBy) Scan(ctx context.Context, v any) error {
	ctx = setContextOp(ctx, fchgb.build.ctx, ent.OpQueryGroupBy)
	if err := fchgb.build.prepareQuery(ctx); err != nil {
		return err
	}
	return scanWithInterceptors[*FiatCurrencyHistoryQuery, *FiatCurrencyHistoryGroupBy](ctx, fchgb.build, fchgb, fchgb.build.inters, v)
}

func (fchgb *FiatCurrencyHistoryGroupBy) sqlScan(ctx context.Context, root *FiatCurrencyHistoryQuery, v any) error {
	...
	if len(selector.SelectedColumns()) == 0 {
		columns := make([]string, 0, len(*fchgb.flds)+len(fchgb.fns))
		for _, f := range *fchgb.flds {
			columns = append(columns, selector.C(f))
		}
		columns = append(columns, aggregation...)
		selector.Select(columns...)
	}
	selector.GroupBy(selector.Columns(*fchgb.flds...)...)
	if err := selector.Err(); err != nil {
		return err
	}
	rows := &sql.Rows{}
	query, args := selector.Query()
	if err := fchgb.build.driver.Query(ctx, query, args, rows); err != nil {
		return err
	}
	defer rows.Close()
...
func (fchs *FiatCurrencyHistorySelect) Aggregate(fns ...AggregateFunc) *FiatCurrencyHistorySelect {
	fchs.fns = append(fchs.fns, fns...)
	return fchs
}

// Scan applies the selector query and scans the result into the given value.
func (fchs *FiatCurrencyHistorySelect) Scan(ctx context.Context, v any) error {
	ctx = setContextOp(ctx, fchs.ctx, ent.OpQuerySelect)
	if err := fchs.prepareQuery(ctx); err != nil {
		return err
	}
	return scanWithInterceptors[*FiatCurrencyHistoryQuery, *FiatCurrencyHistorySelect](ctx, fchs.FiatCurrencyHistoryQuery, fchs, fchs.inters, v)
}

func (fchs *FiatCurrencyHistorySelect) sqlScan(ctx context.Context, root *FiatCurrencyHistoryQuery, v any) error {
	selector := root.sqlQuery(ctx)
	aggregation := make([]string, 0, len(fchs.fns))
	for _, fn := range fchs.fns {
		aggregation = append(aggregation, fn(selector))
	}
	switch n := len(*fchs.selector.flds); {
