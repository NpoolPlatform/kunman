...
func (*CoinFiat) scanValues(columns []string) ([]any, error) {
...
func (cf *CoinFiat) assignValues(columns []string, values []any) error {
...
// Value returns the ent.Value that was dynamically selected and assigned to the CoinFiat.
// This includes values selected through modifiers, order, etc.
func (cf *CoinFiat) Value(name string) (ent.Value, error) {
...
func (cf *CoinFiat) Update() *CoinFiatUpdateOne {
	return NewCoinFiatClient(cf.config).UpdateOne(cf)
}
...
func (cf *CoinFiat) Unwrap() *CoinFiat {
	...
	if !ok {
		panic("generated: CoinFiat is not a transactional entity")
	}
