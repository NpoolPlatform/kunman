...
const (
	// Label holds the string label denoting the coinfiatcurrency type in the database.
	Label = "coin_fiat_currency"
	...
	// Table holds the table name of the coinfiatcurrency in the database.
	Table = "coin_fiat_currencies"
)

// Columns holds all SQL columns for coinfiatcurrency fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
// OrderOption defines the ordering options for the CoinFiatCurrency queries.
