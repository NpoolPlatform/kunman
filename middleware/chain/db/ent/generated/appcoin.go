...
func (*AppCoin) scanValues(columns []string) ([]any, error) {
...
func (ac *AppCoin) assignValues(columns []string, values []any) error {
...
// Value returns the ent.Value that was dynamically selected and assigned to the AppCoin.
// This includes values selected through modifiers, order, etc.
func (ac *AppCoin) Value(name string) (ent.Value, error) {
...
func (ac *AppCoin) Update() *AppCoinUpdateOne {
	return NewAppCoinClient(ac.config).UpdateOne(ac)
}
...
func (ac *AppCoin) Unwrap() *AppCoin {
	...
	if !ok {
		panic("generated: AppCoin is not a transactional entity")
	}
