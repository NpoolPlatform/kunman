...
// OrderOption defines the ordering options for the AppCoin queries.
...
// ByWithdrawAutoReviewAmount orders the results by the withdraw_auto_review_amount field.
func ByWithdrawAutoReviewAmount(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldWithdrawAutoReviewAmount, opts...).ToFunc()
}
...
// ByDailyRewardAmount orders the results by the daily_reward_amount field.
func ByDailyRewardAmount(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldDailyRewardAmount, opts...).ToFunc()
}
...
// ByMaxAmountPerWithdraw orders the results by the max_amount_per_withdraw field.
func ByMaxAmountPerWithdraw(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldMaxAmountPerWithdraw, opts...).ToFunc()
}
