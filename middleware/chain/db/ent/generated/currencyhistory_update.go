...
func (chu *CurrencyHistoryUpdate) defaults() {
...
func (chu *CurrencyHistoryUpdate) sqlSave(ctx context.Context) (n int, err error) {
	_spec := sqlgraph.NewUpdateSpec(currencyhistory.Table, currencyhistory.Columns, sqlgraph.NewFieldSpec(currencyhistory.FieldID, field.TypeUint32))
	...
	if value, ok := chu.mutation.CreatedAt(); ok {
		_spec.SetField(currencyhistory.FieldCreatedAt, field.TypeUint32, value)
	}
	if value, ok := chu.mutation.AddedCreatedAt(); ok {
		_spec.AddField(currencyhistory.FieldCreatedAt, field.TypeUint32, value)
	}
	if value, ok := chu.mutation.UpdatedAt(); ok {
		_spec.SetField(currencyhistory.FieldUpdatedAt, field.TypeUint32, value)
	}
	if value, ok := chu.mutation.AddedUpdatedAt(); ok {
		_spec.AddField(currencyhistory.FieldUpdatedAt, field.TypeUint32, value)
	}
	if value, ok := chu.mutation.DeletedAt(); ok {
		_spec.SetField(currencyhistory.FieldDeletedAt, field.TypeUint32, value)
	}
	if value, ok := chu.mutation.AddedDeletedAt(); ok {
		_spec.AddField(currencyhistory.FieldDeletedAt, field.TypeUint32, value)
	}
	if value, ok := chu.mutation.EntID(); ok {
		_spec.SetField(currencyhistory.FieldEntID, field.TypeUUID, value)
	}
	if value, ok := chu.mutation.CoinTypeID(); ok {
		_spec.SetField(currencyhistory.FieldCoinTypeID, field.TypeUUID, value)
	}
	if chu.mutation.CoinTypeIDCleared() {
		_spec.ClearField(currencyhistory.FieldCoinTypeID, field.TypeUUID)
	}
	if value, ok := chu.mutation.FeedType(); ok {
		_spec.SetField(currencyhistory.FieldFeedType, field.TypeString, value)
	}
	if chu.mutation.FeedTypeCleared() {
		_spec.ClearField(currencyhistory.FieldFeedType, field.TypeString)
	}
	if value, ok := chu.mutation.MarketValueHigh(); ok {
		_spec.SetField(currencyhistory.FieldMarketValueHigh, field.TypeOther, value)
	}
	if chu.mutation.MarketValueHighCleared() {
		_spec.ClearField(currencyhistory.FieldMarketValueHigh, field.TypeOther)
	}
	if value, ok := chu.mutation.MarketValueLow(); ok {
		_spec.SetField(currencyhistory.FieldMarketValueLow, field.TypeOther, value)
	}
	if chu.mutation.MarketValueLowCleared() {
		_spec.ClearField(currencyhistory.FieldMarketValueLow, field.TypeOther)
	}
...
// Where appends a list predicates to the CurrencyHistoryUpdate builder.
func (chuo *CurrencyHistoryUpdateOne) Where(ps ...predicate.CurrencyHistory) *CurrencyHistoryUpdateOne {
...
// defaults sets the default values of the builder before save.
func (chuo *CurrencyHistoryUpdateOne) defaults() {
...
func (chuo *CurrencyHistoryUpdateOne) sqlSave(ctx context.Context) (_node *CurrencyHistory, err error) {
	...
	if !ok {
		return nil, &ValidationError{Name: "id", err: errors.New(`generated: missing "CurrencyHistory.id" for update`)}
	}
