...
func (*Fiat) scanValues(columns []string) ([]any, error) {
...
// to the Fiat fields.
func (f *Fiat) assignValues(columns []string, values []any) error {
...
// Value returns the ent.Value that was dynamically selected and assigned to the Fiat.
// This includes values selected through modifiers, order, etc.
func (f *Fiat) Value(name string) (ent.Value, error) {
...
func (f *Fiat) Update() *FiatUpdateOne {
	return NewFiatClient(f.config).UpdateOne(f)
}
...
func (f *Fiat) Unwrap() *Fiat {
	...
	if !ok {
		panic("generated: Fiat is not a transactional entity")
	}
