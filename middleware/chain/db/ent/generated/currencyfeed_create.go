...
func (cfc *CurrencyFeedCreate) SetID(u uint32) *CurrencyFeedCreate {
...
func (cfc *CurrencyFeedCreate) defaults() {
...
func (cfc *CurrencyFeedCreate) check() error {
	if _, ok := cfc.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`generated: missing required field "CurrencyFeed.created_at"`)}
	}
	if _, ok := cfc.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`generated: missing required field "CurrencyFeed.updated_at"`)}
	}
	if _, ok := cfc.mutation.DeletedAt(); !ok {
		return &ValidationError{Name: "deleted_at", err: errors.New(`generated: missing required field "CurrencyFeed.deleted_at"`)}
	}
	if _, ok := cfc.mutation.EntID(); !ok {
		return &ValidationError{Name: "ent_id", err: errors.New(`generated: missing required field "CurrencyFeed.ent_id"`)}
	}
	return nil
}
...
func (cfc *CurrencyFeedCreate) createSpec() (*CurrencyFeed, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(currencyfeed.Table, sqlgraph.NewFieldSpec(currencyfeed.FieldID, field.TypeUint32))
	)
...
func (u *CurrencyFeedUpsertOne) Exec(ctx context.Context) error {
	if len(u.create.conflict) == 0 {
		return errors.New("generated: missing options for CurrencyFeedCreate.OnConflict")
	}
...
func (u *CurrencyFeedUpsertOne) ID(ctx context.Context) (id uint32, err error) {
...
func (u *CurrencyFeedUpsertOne) IDX(ctx context.Context) uint32 {
	id, err := u.ID(ctx)
	if err != nil {
		panic(err)
	}
...
func (u *CurrencyFeedUpsertBulk) Exec(ctx context.Context) error {
	...
	for i, b := range u.create.builders {
		if len(b.conflict) != 0 {
			return fmt.Errorf("generated: OnConflict was set for builder %d. Set it on the CurrencyFeedCreateBulk instead", i)
		}
	}
	if len(u.create.conflict) == 0 {
		return errors.New("generated: missing options for CurrencyFeedCreateBulk.OnConflict")
	}
	return u.create.Exec(ctx)
}
