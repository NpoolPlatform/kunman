...
const (
	// Label holds the string label denoting the fiatcurrencyhistory type in the database.
	Label = "fiat_currency_history"
	...
	// Table holds the table name of the fiatcurrencyhistory in the database.
	Table = "fiat_currency_histories"
)

// Columns holds all SQL columns for fiatcurrencyhistory fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
// OrderOption defines the ordering options for the FiatCurrencyHistory queries.
