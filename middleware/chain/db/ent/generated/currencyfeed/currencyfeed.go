...
// OrderOption defines the ordering options for the CurrencyFeed queries.
...
// ByFeedCoinName orders the results by the feed_coin_name field.
func ByFeedCoinName(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldFeedCoinName, opts...).ToFunc()
}
