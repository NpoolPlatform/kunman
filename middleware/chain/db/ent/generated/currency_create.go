...
func (cc *CurrencyCreate) SetEntID(u uuid.UUID) *CurrencyCreate {
	cc.mutation.SetEntID(u)
	return cc
}

// SetNillableEntID sets the "ent_id" field if the given value is not nil.
func (cc *CurrencyCreate) SetNillableEntID(u *uuid.UUID) *CurrencyCreate {
	if u != nil {
		cc.SetEntID(*u)
	}
	return cc
...
func (cc *CurrencyCreate) check() error {
	if _, ok := cc.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`generated: missing required field "Currency.created_at"`)}
	}
	if _, ok := cc.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`generated: missing required field "Currency.updated_at"`)}
	}
	if _, ok := cc.mutation.DeletedAt(); !ok {
		return &ValidationError{Name: "deleted_at", err: errors.New(`generated: missing required field "Currency.deleted_at"`)}
	}
	if _, ok := cc.mutation.EntID(); !ok {
		return &ValidationError{Name: "ent_id", err: errors.New(`generated: missing required field "Currency.ent_id"`)}
	}
	return nil
}
...
func (cc *CurrencyCreate) createSpec() (*Currency, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(currency.Table, sqlgraph.NewFieldSpec(currency.FieldID, field.TypeUint32))
	)
...
// SetEntID sets the "ent_id" field.
func (u *CurrencyUpsert) SetEntID(v uuid.UUID) *CurrencyUpsert {
	u.Set(currency.FieldEntID, v)
	return u
}

// UpdateEntID sets the "ent_id" field to the value that was provided on create.
func (u *CurrencyUpsert) UpdateEntID() *CurrencyUpsert {
	u.SetExcluded(currency.FieldEntID)
	return u
}
...
// SetEntID sets the "ent_id" field.
func (u *CurrencyUpsertOne) SetEntID(v uuid.UUID) *CurrencyUpsertOne {
	return u.Update(func(s *CurrencyUpsert) {
		s.SetEntID(v)
	})
}
...
// UpdateEntID sets the "ent_id" field to the value that was provided on create.
func (u *CurrencyUpsertOne) UpdateEntID() *CurrencyUpsertOne {
	return u.Update(func(s *CurrencyUpsert) {
		s.UpdateEntID()
	})
}
...
func (u *CurrencyUpsertOne) Exec(ctx context.Context) error {
	if len(u.create.conflict) == 0 {
		return errors.New("generated: missing options for CurrencyCreate.OnConflict")
	}
...
// SetEntID sets the "ent_id" field.
func (u *CurrencyUpsertBulk) SetEntID(v uuid.UUID) *CurrencyUpsertBulk {
	return u.Update(func(s *CurrencyUpsert) {
		s.SetEntID(v)
	})
}
...
// UpdateEntID sets the "ent_id" field to the value that was provided on create.
func (u *CurrencyUpsertBulk) UpdateEntID() *CurrencyUpsertBulk {
	return u.Update(func(s *CurrencyUpsert) {
		s.UpdateEntID()
	})
}
...
func (u *CurrencyUpsertBulk) Exec(ctx context.Context) error {
	...
	for i, b := range u.create.builders {
		if len(b.conflict) != 0 {
			return fmt.Errorf("generated: OnConflict was set for builder %d. Set it on the CurrencyCreateBulk instead", i)
		}
	}
	if len(u.create.conflict) == 0 {
		return errors.New("generated: missing options for CurrencyCreateBulk.OnConflict")
	}
	return u.create.Exec(ctx)
}
