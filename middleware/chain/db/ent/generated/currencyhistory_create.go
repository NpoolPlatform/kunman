...
func (chc *CurrencyHistoryCreate) defaults() {
...
func (chc *CurrencyHistoryCreate) check() error {
	if _, ok := chc.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`generated: missing required field "CurrencyHistory.created_at"`)}
	}
	if _, ok := chc.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`generated: missing required field "CurrencyHistory.updated_at"`)}
	}
	if _, ok := chc.mutation.DeletedAt(); !ok {
		return &ValidationError{Name: "deleted_at", err: errors.New(`generated: missing required field "CurrencyHistory.deleted_at"`)}
	}
	if _, ok := chc.mutation.EntID(); !ok {
		return &ValidationError{Name: "ent_id", err: errors.New(`generated: missing required field "CurrencyHistory.ent_id"`)}
	}
	return nil
}
...
func (chc *CurrencyHistoryCreate) createSpec() (*CurrencyHistory, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(currencyhistory.Table, sqlgraph.NewFieldSpec(currencyhistory.FieldID, field.TypeUint32))
	)
...
func (u *CurrencyHistoryUpsertOne) Exec(ctx context.Context) error {
	if len(u.create.conflict) == 0 {
		return errors.New("generated: missing options for CurrencyHistoryCreate.OnConflict")
	}
...
func (u *CurrencyHistoryUpsertBulk) Exec(ctx context.Context) error {
	...
	for i, b := range u.create.builders {
		if len(b.conflict) != 0 {
			return fmt.Errorf("generated: OnConflict was set for builder %d. Set it on the CurrencyHistoryCreateBulk instead", i)
		}
	}
	if len(u.create.conflict) == 0 {
		return errors.New("generated: missing options for CurrencyHistoryCreateBulk.OnConflict")
	}
	return u.create.Exec(ctx)
}
