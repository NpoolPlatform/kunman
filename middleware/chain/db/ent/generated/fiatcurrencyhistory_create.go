...
func (fchc *FiatCurrencyHistoryCreate) SetEntID(u uuid.UUID) *FiatCurrencyHistoryCreate {
	fchc.mutation.SetEntID(u)
	return fchc
}

// SetNillableEntID sets the "ent_id" field if the given value is not nil.
func (fchc *FiatCurrencyHistoryCreate) SetNillableEntID(u *uuid.UUID) *FiatCurrencyHistoryCreate {
	if u != nil {
		fchc.SetEntID(*u)
	}
	return fchc
...
func (fchc *FiatCurrencyHistoryCreate) SetID(u uint32) *FiatCurrencyHistoryCreate {
...
func (fchc *FiatCurrencyHistoryCreate) Save(ctx context.Context) (*FiatCurrencyHistory, error) {
	fchc.defaults()
	return withHooks(ctx, fchc.sqlSave, fchc.mutation, fchc.hooks)
}
...
func (fchc *FiatCurrencyHistoryCreate) defaults() {
	...
	if _, ok := fchc.mutation.EntID(); !ok {
		v := fiatcurrencyhistory.DefaultEntID()
		fchc.mutation.SetEntID(v)
	}
...
func (fchc *FiatCurrencyHistoryCreate) check() error {
	if _, ok := fchc.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`generated: missing required field "FiatCurrencyHistory.created_at"`)}
	}
	if _, ok := fchc.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`generated: missing required field "FiatCurrencyHistory.updated_at"`)}
	}
	if _, ok := fchc.mutation.DeletedAt(); !ok {
		return &ValidationError{Name: "deleted_at", err: errors.New(`generated: missing required field "FiatCurrencyHistory.deleted_at"`)}
	}
	if _, ok := fchc.mutation.EntID(); !ok {
		return &ValidationError{Name: "ent_id", err: errors.New(`generated: missing required field "FiatCurrencyHistory.ent_id"`)}
	}
	return nil
}
...
func (fchc *FiatCurrencyHistoryCreate) sqlSave(ctx context.Context) (*FiatCurrencyHistory, error) {
	...
	fchc.mutation.id = &_node.ID
	fchc.mutation.done = true
	return _node, nil
}
...
func (fchc *FiatCurrencyHistoryCreate) createSpec() (*FiatCurrencyHistory, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(fiatcurrencyhistory.Table, sqlgraph.NewFieldSpec(fiatcurrencyhistory.FieldID, field.TypeUint32))
	)
	...
	if value, ok := fchc.mutation.EntID(); ok {
...
// SetEntID sets the "ent_id" field.
func (u *FiatCurrencyHistoryUpsert) SetEntID(v uuid.UUID) *FiatCurrencyHistoryUpsert {
	u.Set(fiatcurrencyhistory.FieldEntID, v)
	return u
}

// UpdateEntID sets the "ent_id" field to the value that was provided on create.
func (u *FiatCurrencyHistoryUpsert) UpdateEntID() *FiatCurrencyHistoryUpsert {
	u.SetExcluded(fiatcurrencyhistory.FieldEntID)
	return u
}
...
// SetEntID sets the "ent_id" field.
func (u *FiatCurrencyHistoryUpsertOne) SetEntID(v uuid.UUID) *FiatCurrencyHistoryUpsertOne {
	return u.Update(func(s *FiatCurrencyHistoryUpsert) {
		s.SetEntID(v)
	})
}
...
// UpdateEntID sets the "ent_id" field to the value that was provided on create.
func (u *FiatCurrencyHistoryUpsertOne) UpdateEntID() *FiatCurrencyHistoryUpsertOne {
	return u.Update(func(s *FiatCurrencyHistoryUpsert) {
		s.UpdateEntID()
	})
}
...
func (u *FiatCurrencyHistoryUpsertOne) Exec(ctx context.Context) error {
	if len(u.create.conflict) == 0 {
		return errors.New("generated: missing options for FiatCurrencyHistoryCreate.OnConflict")
	}
...
func (u *FiatCurrencyHistoryUpsertOne) ID(ctx context.Context) (id uint32, err error) {
...
func (u *FiatCurrencyHistoryUpsertOne) IDX(ctx context.Context) uint32 {
	id, err := u.ID(ctx)
	if err != nil {
		panic(err)
	}
...
// SetEntID sets the "ent_id" field.
func (u *FiatCurrencyHistoryUpsertBulk) SetEntID(v uuid.UUID) *FiatCurrencyHistoryUpsertBulk {
	return u.Update(func(s *FiatCurrencyHistoryUpsert) {
		s.SetEntID(v)
	})
}
...
// UpdateEntID sets the "ent_id" field to the value that was provided on create.
func (u *FiatCurrencyHistoryUpsertBulk) UpdateEntID() *FiatCurrencyHistoryUpsertBulk {
	return u.Update(func(s *FiatCurrencyHistoryUpsert) {
		s.UpdateEntID()
	})
}
...
func (u *FiatCurrencyHistoryUpsertBulk) Exec(ctx context.Context) error {
	...
	for i, b := range u.create.builders {
		if len(b.conflict) != 0 {
			return fmt.Errorf("generated: OnConflict was set for builder %d. Set it on the FiatCurrencyHistoryCreateBulk instead", i)
		}
	}
	if len(u.create.conflict) == 0 {
		return errors.New("generated: missing options for FiatCurrencyHistoryCreateBulk.OnConflict")
	}
	return u.create.Exec(ctx)
}
