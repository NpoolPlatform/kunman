...
func (fc *FiatCreate) SetID(u uint32) *FiatCreate {
	fc.mutation.SetID(u)
	return fc
}
...
func (fc *FiatCreate) check() error {
	if _, ok := fc.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`generated: missing required field "Fiat.created_at"`)}
	}
	if _, ok := fc.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`generated: missing required field "Fiat.updated_at"`)}
	}
	if _, ok := fc.mutation.DeletedAt(); !ok {
		return &ValidationError{Name: "deleted_at", err: errors.New(`generated: missing required field "Fiat.deleted_at"`)}
	}
	if _, ok := fc.mutation.EntID(); !ok {
		return &ValidationError{Name: "ent_id", err: errors.New(`generated: missing required field "Fiat.ent_id"`)}
	}
	return nil
}
...
func (fc *FiatCreate) createSpec() (*Fiat, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(fiat.Table, sqlgraph.NewFieldSpec(fiat.FieldID, field.TypeUint32))
	)
	...
	if value, ok := fc.mutation.CreatedAt(); ok {
		_spec.SetField(fiat.FieldCreatedAt, field.TypeUint32, value)
		_node.CreatedAt = value
	}
	if value, ok := fc.mutation.UpdatedAt(); ok {
		_spec.SetField(fiat.FieldUpdatedAt, field.TypeUint32, value)
		_node.UpdatedAt = value
	}
	if value, ok := fc.mutation.DeletedAt(); ok {
		_spec.SetField(fiat.FieldDeletedAt, field.TypeUint32, value)
		_node.DeletedAt = value
	}
	if value, ok := fc.mutation.EntID(); ok {
		_spec.SetField(fiat.FieldEntID, field.TypeUUID, value)
		_node.EntID = value
	}
	if value, ok := fc.mutation.Name(); ok {
		_spec.SetField(fiat.FieldName, field.TypeString, value)
		_node.Name = value
	}
	if value, ok := fc.mutation.Logo(); ok {
		_spec.SetField(fiat.FieldLogo, field.TypeString, value)
		_node.Logo = value
	}
	if value, ok := fc.mutation.Unit(); ok {
		_spec.SetField(fiat.FieldUnit, field.TypeString, value)
		_node.Unit = value
	}
	return _node, _spec
}
...
func (u *FiatUpsertOne) Exec(ctx context.Context) error {
	if len(u.create.conflict) == 0 {
		return errors.New("generated: missing options for FiatCreate.OnConflict")
	}
...
func (u *FiatUpsertOne) ID(ctx context.Context) (id uint32, err error) {
...
func (u *FiatUpsertOne) IDX(ctx context.Context) uint32 {
	id, err := u.ID(ctx)
	if err != nil {
		panic(err)
	}
...
func (u *FiatUpsertBulk) Exec(ctx context.Context) error {
	...
	for i, b := range u.create.builders {
		if len(b.conflict) != 0 {
			return fmt.Errorf("generated: OnConflict was set for builder %d. Set it on the FiatCreateBulk instead", i)
		}
	}
	if len(u.create.conflict) == 0 {
		return errors.New("generated: missing options for FiatCreateBulk.OnConflict")
	}
	return u.create.Exec(ctx)
}
