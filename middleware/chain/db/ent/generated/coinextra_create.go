...
func (cec *CoinExtraCreate) SetID(u uint32) *CoinExtraCreate {
...
func (cec *CoinExtraCreate) defaults() {
...
func (cec *CoinExtraCreate) check() error {
	if _, ok := cec.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`generated: missing required field "CoinExtra.created_at"`)}
	}
	if _, ok := cec.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`generated: missing required field "CoinExtra.updated_at"`)}
	}
	if _, ok := cec.mutation.DeletedAt(); !ok {
		return &ValidationError{Name: "deleted_at", err: errors.New(`generated: missing required field "CoinExtra.deleted_at"`)}
	}
	if _, ok := cec.mutation.EntID(); !ok {
		return &ValidationError{Name: "ent_id", err: errors.New(`generated: missing required field "CoinExtra.ent_id"`)}
	}
	return nil
}
...
func (cec *CoinExtraCreate) createSpec() (*CoinExtra, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(coinextra.Table, sqlgraph.NewFieldSpec(coinextra.FieldID, field.TypeUint32))
	)
	...
	if value, ok := cec.mutation.CreatedAt(); ok {
		_spec.SetField(coinextra.FieldCreatedAt, field.TypeUint32, value)
		_node.CreatedAt = value
	}
	if value, ok := cec.mutation.UpdatedAt(); ok {
		_spec.SetField(coinextra.FieldUpdatedAt, field.TypeUint32, value)
		_node.UpdatedAt = value
	}
	if value, ok := cec.mutation.DeletedAt(); ok {
		_spec.SetField(coinextra.FieldDeletedAt, field.TypeUint32, value)
		_node.DeletedAt = value
	}
	if value, ok := cec.mutation.EntID(); ok {
		_spec.SetField(coinextra.FieldEntID, field.TypeUUID, value)
		_node.EntID = value
	}
	if value, ok := cec.mutation.CoinTypeID(); ok {
		_spec.SetField(coinextra.FieldCoinTypeID, field.TypeUUID, value)
		_node.CoinTypeID = value
	}
	if value, ok := cec.mutation.HomePage(); ok {
		_spec.SetField(coinextra.FieldHomePage, field.TypeString, value)
		_node.HomePage = value
	}
	if value, ok := cec.mutation.Specs(); ok {
		_spec.SetField(coinextra.FieldSpecs, field.TypeString, value)
		_node.Specs = value
	}
	if value, ok := cec.mutation.StableUsd(); ok {
		_spec.SetField(coinextra.FieldStableUsd, field.TypeBool, value)
...
func (u *CoinExtraUpsertOne) Exec(ctx context.Context) error {
	if len(u.create.conflict) == 0 {
		return errors.New("generated: missing options for CoinExtraCreate.OnConflict")
	}
...
func (u *CoinExtraUpsertOne) ID(ctx context.Context) (id uint32, err error) {
...
func (u *CoinExtraUpsertOne) IDX(ctx context.Context) uint32 {
	id, err := u.ID(ctx)
	if err != nil {
		panic(err)
	}
...
func (u *CoinExtraUpsertBulk) Exec(ctx context.Context) error {
	...
	for i, b := range u.create.builders {
		if len(b.conflict) != 0 {
			return fmt.Errorf("generated: OnConflict was set for builder %d. Set it on the CoinExtraCreateBulk instead", i)
		}
	}
	if len(u.create.conflict) == 0 {
		return errors.New("generated: missing options for CoinExtraCreateBulk.OnConflict")
	}
	return u.create.Exec(ctx)
}
