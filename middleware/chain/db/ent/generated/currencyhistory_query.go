...
type CurrencyHistoryQuery struct {
	config
	ctx        *QueryContext
	order      []currencyhistory.OrderOption
	inters     []Interceptor
...
func (chq *CurrencyHistoryQuery) Order(o ...currencyhistory.OrderOption) *CurrencyHistoryQuery {
...
func (chq *CurrencyHistoryQuery) All(ctx context.Context) ([]*CurrencyHistory, error) {
	...
	qr := querierAll[[]*CurrencyHistory, *CurrencyHistoryQuery]()
	return withInterceptors[[]*CurrencyHistory](ctx, chq, qr, chq.inters)
}
...
func (chq *CurrencyHistoryQuery) IDs(ctx context.Context) (ids []uint32, err error) {
...
func (chq *CurrencyHistoryQuery) Count(ctx context.Context) (int, error) {
	...
	return withInterceptors[int](ctx, chq, querierCount[*CurrencyHistoryQuery](), chq.inters)
}
...
func (chq *CurrencyHistoryQuery) Clone() *CurrencyHistoryQuery {
	...
	return &CurrencyHistoryQuery{
		config:     chq.config,
		ctx:        chq.ctx.Clone(),
		order:      append([]currencyhistory.OrderOption{}, chq.order...),
...
func (chq *CurrencyHistoryQuery) GroupBy(field string, fields ...string) *CurrencyHistoryGroupBy {
	...
	grbuild := &CurrencyHistoryGroupBy{build: chq}
...
func (chq *CurrencyHistoryQuery) Select(fields ...string) *CurrencyHistorySelect {
	...
	sbuild := &CurrencyHistorySelect{CurrencyHistoryQuery: chq}
	sbuild.label = currencyhistory.Label
	sbuild.flds, sbuild.scan = &chq.ctx.Fields, sbuild.Scan
	return sbuild
}

// Aggregate returns a CurrencyHistorySelect configured with the given aggregations.
func (chq *CurrencyHistoryQuery) Aggregate(fns ...AggregateFunc) *CurrencyHistorySelect {
...
func (chq *CurrencyHistoryQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(currencyhistory.Table, currencyhistory.Columns, sqlgraph.NewFieldSpec(currencyhistory.FieldID, field.TypeUint32))
	_spec.From = chq.sql
...
func (chgb *CurrencyHistoryGroupBy) Scan(ctx context.Context, v any) error {
	ctx = setContextOp(ctx, chgb.build.ctx, ent.OpQueryGroupBy)
	if err := chgb.build.prepareQuery(ctx); err != nil {
		return err
	}
	return scanWithInterceptors[*CurrencyHistoryQuery, *CurrencyHistoryGroupBy](ctx, chgb.build, chgb, chgb.build.inters, v)
}

func (chgb *CurrencyHistoryGroupBy) sqlScan(ctx context.Context, root *CurrencyHistoryQuery, v any) error {
...
func (chs *CurrencyHistorySelect) Aggregate(fns ...AggregateFunc) *CurrencyHistorySelect {
	chs.fns = append(chs.fns, fns...)
	return chs
}

// Scan applies the selector query and scans the result into the given value.
func (chs *CurrencyHistorySelect) Scan(ctx context.Context, v any) error {
	ctx = setContextOp(ctx, chs.ctx, ent.OpQuerySelect)
	if err := chs.prepareQuery(ctx); err != nil {
		return err
	}
	return scanWithInterceptors[*CurrencyHistoryQuery, *CurrencyHistorySelect](ctx, chs.CurrencyHistoryQuery, chs, chs.inters, v)
}

func (chs *CurrencyHistorySelect) sqlScan(ctx context.Context, root *CurrencyHistoryQuery, v any) error {
