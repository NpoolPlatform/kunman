...
func (*CoinExtra) scanValues(columns []string) ([]any, error) {
...
func (ce *CoinExtra) assignValues(columns []string, values []any) error {
...
// Value returns the ent.Value that was dynamically selected and assigned to the CoinExtra.
// This includes values selected through modifiers, order, etc.
func (ce *CoinExtra) Value(name string) (ent.Value, error) {
...
func (ce *CoinExtra) Update() *CoinExtraUpdateOne {
	return NewCoinExtraClient(ce.config).UpdateOne(ce)
}
...
func (ce *CoinExtra) Unwrap() *CoinExtra {
	...
	if !ok {
		panic("generated: CoinExtra is not a transactional entity")
	}
