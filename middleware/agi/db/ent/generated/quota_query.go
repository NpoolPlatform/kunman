...
func (qq *QuotaQuery) FirstID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
...
func (qq *QuotaQuery) FirstIDX(ctx context.Context) uint32 {
...
func (qq *QuotaQuery) OnlyID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
...
func (qq *QuotaQuery) OnlyIDX(ctx context.Context) uint32 {
...
func (qq *QuotaQuery) IDs(ctx context.Context) (ids []uint32, err error) {
...
func (qq *QuotaQuery) IDsX(ctx context.Context) []uint32 {
	ids, err := qq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (qq *QuotaQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(quota.Table, quota.Columns, sqlgraph.NewFieldSpec(quota.FieldID, field.TypeUint32))
	_spec.From = qq.sql
...
func (qq *QuotaQuery) ForUpdate(opts ...sql.LockOption) *QuotaQuery {
...
func (qq *QuotaQuery) ForShare(opts ...sql.LockOption) *QuotaQuery {
	if qq.driver.Dialect() == dialect.Postgres {
		qq.Unique(false)
	}
	qq.modifiers = append(qq.modifiers, func(s *sql.Selector) {
...
func (qq *QuotaQuery) Modify(modifiers ...func(s *sql.Selector)) *QuotaSelect {
...
// Modify adds a query modifier for attaching custom logic to queries.
func (qs *QuotaSelect) Modify(modifiers ...func(s *sql.Selector)) *QuotaSelect {
