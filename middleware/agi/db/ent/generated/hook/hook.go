...
// The CapacityFunc type is an adapter to allow the use of ordinary
// function as Capacity mutator.
type CapacityFunc func(context.Context, *generated.CapacityMutation) (generated.Value, error)

// Mutate calls f(ctx, m).
func (f CapacityFunc) Mutate(ctx context.Context, m generated.Mutation) (generated.Value, error) {
	if mv, ok := m.(*generated.CapacityMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *generated.CapacityMutation", m)
}

// The QuotaFunc type is an adapter to allow the use of ordinary
// function as Quota mutator.
type QuotaFunc func(context.Context, *generated.QuotaMutation) (generated.Value, error)

// Mutate calls f(ctx, m).
func (f QuotaFunc) Mutate(ctx context.Context, m generated.Mutation) (generated.Value, error) {
	if mv, ok := m.(*generated.QuotaMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *generated.QuotaMutation", m)
}
