...
func (sq *SubscriptionQuery) IDs(ctx context.Context) (ids []uint32, err error) {
...
func (sq *SubscriptionQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(subscription.Table, subscription.Columns, sqlgraph.NewFieldSpec(subscription.FieldID, field.TypeUint32))
	_spec.From = sq.sql
