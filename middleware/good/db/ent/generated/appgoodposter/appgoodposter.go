...
const (
	// Label holds the string label denoting the appgoodposter type in the database.
	Label = "app_good_poster"
	...
	FieldIndex = "index"
	// Table holds the table name of the appgoodposter in the database.
	Table = "app_good_posters"
)

// Columns holds all SQL columns for appgoodposter fields.
var Columns = []string{
	FieldID,
	FieldEntID,
	FieldAppGoodID,
...
// OrderOption defines the ordering options for the AppGoodPoster queries.
