...
const (
	// Label holds the string label denoting the topmostgoodposter type in the database.
	Label = "top_most_good_poster"
	...
	FieldIndex = "index"
	// Table holds the table name of the topmostgoodposter in the database.
	Table = "top_most_good_posters"
)

// Columns holds all SQL columns for topmostgoodposter fields.
var Columns = []string{
	FieldID,
	FieldEntID,
	FieldCreatedAt,
...
// OrderOption defines the ordering options for the TopMostGoodPoster queries.
