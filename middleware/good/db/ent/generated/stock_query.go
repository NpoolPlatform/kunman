...
func (sq *StockQuery) IDs(ctx context.Context) (ids []uint32, err error) {
...
func (sq *StockQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(stock.Table, stock.Columns, sqlgraph.NewFieldSpec(stock.FieldID, field.TypeUint32))
	_spec.From = sq.sql
