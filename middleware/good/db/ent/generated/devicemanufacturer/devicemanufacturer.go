...
const (
	// Label holds the string label denoting the devicemanufacturer type in the database.
	...
	FieldLogo = "logo"
	// Table holds the table name of the devicemanufacturer in the database.
	Table = "device_manufacturers"
)

// Columns holds all SQL columns for devicemanufacturer fields.
var Columns = []string{
	FieldID,
	FieldEntID,
	FieldName,
...
// OrderOption defines the ordering options for the DeviceManufacturer queries.
