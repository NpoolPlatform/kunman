...
func (sq *ScoreQuery) IDs(ctx context.Context) (ids []uint32, err error) {
...
func (sq *ScoreQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(score.Table, score.Columns, sqlgraph.NewFieldSpec(score.FieldID, field.TypeUint32))
	_spec.From = sq.sql
...
func (sq *ScoreQuery) ForUpdate(opts ...sql.LockOption) *ScoreQuery {
...
func (sq *ScoreQuery) ForShare(opts ...sql.LockOption) *ScoreQuery {
	if sq.driver.Dialect() == dialect.Postgres {
		sq.Unique(false)
	}
	sq.modifiers = append(sq.modifiers, func(s *sql.Selector) {
...
func (sq *ScoreQuery) Modify(modifiers ...func(s *sql.Selector)) *ScoreSelect {
...
// Modify adds a query modifier for attaching custom logic to queries.
func (ss *ScoreSelect) Modify(modifiers ...func(s *sql.Selector)) *ScoreSelect {
