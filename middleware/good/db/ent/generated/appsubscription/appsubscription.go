...
const (
	// Label holds the string label denoting the appsubscription type in the database.
	Label = "app_subscription"
...
// Columns holds all SQL columns for appsubscription fields.
var Columns = []string{
	FieldID,
	FieldEntID,
	FieldCreatedAt,
