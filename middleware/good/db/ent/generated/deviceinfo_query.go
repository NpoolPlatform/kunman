...
func (diq *DeviceInfoQuery) IDs(ctx context.Context) (ids []uint32, err error) {
...
func (diq *DeviceInfoQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(deviceinfo.Table, deviceinfo.Columns, sqlgraph.NewFieldSpec(deviceinfo.FieldID, field.TypeUint32))
	_spec.From = diq.sql
