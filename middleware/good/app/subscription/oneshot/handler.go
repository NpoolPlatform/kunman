...
type Handler struct {
	...
	AppOneShotConds  *apponeshotcrud.Conds
...
func WithGoodID(s *string, must bool) func(context.Context, *Handler) error {
	return func(ctx context.Context, h *Handler) error {
		...
		handler.GoodBaseConds = &goodbasecrud.Conds{
			...
			GoodType: &cruder.Cond{Op: cruder.EQ, Val: types.GoodType_OneShot},
		}
...
func (h *Handler) withAppOneShotConds(conds *npool.Conds) error {
	if conds.ID != nil {
		h.AppOneShotConds.ID = &cruder.Cond{
			Op:  conds.GetID().GetOp(),
			Val: conds.GetID().GetValue(),
		}
	}
	if conds.IDs != nil {
		h.AppOneShotConds.IDs = &cruder.Cond{
	...
	if conds.EntID != nil {
		...
		h.AppOneShotConds.EntID = &cruder.Cond{
	...
	if conds.EntIDs != nil {
		...
		h.AppOneShotConds.EntIDs = &cruder.Cond{
	...
	if conds.AppGoodID != nil {
		...
		h.AppOneShotConds.AppGoodID = &cruder.Cond{
	...
	if conds.AppGoodIDs != nil {
		...
		h.AppOneShotConds.AppGoodIDs = &cruder.Cond{
...
func WithConds(conds *npool.Conds) func(context.Context, *Handler) error {
	return func(ctx context.Context, h *Handler) error {
		...
		if err := h.withAppOneShotConds(conds); err != nil {
			return wlog.WrapError(err)
		}
