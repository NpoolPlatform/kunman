...
type Handler struct {
	...
	AppDelegatedStakingConds *appdelegatedstakingcrud.Conds
...
func (h *Handler) withAppDelegatedStakingConds(conds *npool.Conds) error {
	if conds.ID != nil {
		h.AppDelegatedStakingConds.ID = &cruder.Cond{
	...
	if conds.EntID != nil {
		...
		h.AppDelegatedStakingConds.EntID = &cruder.Cond{
	...
	if conds.AppGoodID != nil {
		...
		h.AppDelegatedStakingConds.AppGoodID = &cruder.Cond{
	...
	if conds.AppGoodIDs != nil {
		...
		h.AppDelegatedStakingConds.AppGoodIDs = &cruder.Cond{
...
func WithConds(conds *npool.Conds) func(context.Context, *Handler) error {
	return func(ctx context.Context, h *Handler) error {
		...
		if err := h.withAppDelegatedStakingConds(conds); err != nil {
			return wlog.WrapError(err)
		}
