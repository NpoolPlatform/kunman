...
func (h *Handler) withAppDisplayNameGoodConds(conds *npool.Conds) error {
	if conds.ID != nil {
		h.DisplayNameConds.ID = &cruder.Cond{
	...
	if conds.EntID != nil {
		...
		h.DisplayNameConds.EntID = &cruder.Cond{
	...
	if conds.AppGoodID != nil {
		...
		h.DisplayNameConds.AppGoodID = &cruder.Cond{
	...
	if conds.AppGoodIDs != nil {
		...
		h.DisplayNameConds.AppGoodIDs = &cruder.Cond{
...
func WithConds(conds *npool.Conds) func(context.Context, *Handler) error {
	return func(ctx context.Context, h *Handler) error {
		...
		if err := h.withAppDisplayNameGoodConds(conds); err != nil {
			return wlog.WrapError(err)
		}
