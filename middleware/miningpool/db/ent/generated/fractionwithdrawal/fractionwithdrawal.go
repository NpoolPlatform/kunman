...
// OrderOption defines the ordering options for the FractionWithdrawal queries.
...
// ByFractionWithdrawState orders the results by the fraction_withdraw_state field.
func ByFractionWithdrawState(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldFractionWithdrawState, opts...).ToFunc()
}

// ByWithdrawAt orders the results by the withdraw_at field.
func ByWithdrawAt(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldWithdrawAt, opts...).ToFunc()
}

// ByPromisePayAt orders the results by the promise_pay_at field.
func ByPromisePayAt(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldPromisePayAt, opts...).ToFunc()
}
