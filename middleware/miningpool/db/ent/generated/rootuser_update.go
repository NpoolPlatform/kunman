...
func (ruu *RootUserUpdate) defaults() {
...
func (ruu *RootUserUpdate) sqlSave(ctx context.Context) (n int, err error) {
	_spec := sqlgraph.NewUpdateSpec(rootuser.Table, rootuser.Columns, sqlgraph.NewFieldSpec(rootuser.FieldID, field.TypeUint32))
	...
	if value, ok := ruu.mutation.CreatedAt(); ok {
		_spec.SetField(rootuser.FieldCreatedAt, field.TypeUint32, value)
	}
	if value, ok := ruu.mutation.AddedCreatedAt(); ok {
		_spec.AddField(rootuser.FieldCreatedAt, field.TypeUint32, value)
	}
	if value, ok := ruu.mutation.UpdatedAt(); ok {
		_spec.SetField(rootuser.FieldUpdatedAt, field.TypeUint32, value)
	}
	if value, ok := ruu.mutation.AddedUpdatedAt(); ok {
		_spec.AddField(rootuser.FieldUpdatedAt, field.TypeUint32, value)
	}
	if value, ok := ruu.mutation.DeletedAt(); ok {
		_spec.SetField(rootuser.FieldDeletedAt, field.TypeUint32, value)
	}
	if value, ok := ruu.mutation.AddedDeletedAt(); ok {
		_spec.AddField(rootuser.FieldDeletedAt, field.TypeUint32, value)
	}
	if value, ok := ruu.mutation.EntID(); ok {
		_spec.SetField(rootuser.FieldEntID, field.TypeUUID, value)
	}
	if value, ok := ruu.mutation.Name(); ok {
		_spec.SetField(rootuser.FieldName, field.TypeString, value)
	}
	if ruu.mutation.NameCleared() {
		_spec.ClearField(rootuser.FieldName, field.TypeString)
	}
	if value, ok := ruu.mutation.PoolID(); ok {
		_spec.SetField(rootuser.FieldPoolID, field.TypeUUID, value)
	}
	if ruu.mutation.PoolIDCleared() {
		_spec.ClearField(rootuser.FieldPoolID, field.TypeUUID)
	}
	if value, ok := ruu.mutation.Email(); ok {
		_spec.SetField(rootuser.FieldEmail, field.TypeString, value)
	}
	if ruu.mutation.EmailCleared() {
		_spec.ClearField(rootuser.FieldEmail, field.TypeString)
	}
	if value, ok := ruu.mutation.AuthToken(); ok {
		_spec.SetField(rootuser.FieldAuthToken, field.TypeString, value)
	}
	if ruu.mutation.AuthTokenCleared() {
		_spec.ClearField(rootuser.FieldAuthToken, field.TypeString)
	}
	if value, ok := ruu.mutation.AuthTokenSalt(); ok {
		_spec.SetField(rootuser.FieldAuthTokenSalt, field.TypeString, value)
	}
	if ruu.mutation.AuthTokenSaltCleared() {
		_spec.ClearField(rootuser.FieldAuthTokenSalt, field.TypeString)
	}
	if value, ok := ruu.mutation.Authed(); ok {
		_spec.SetField(rootuser.FieldAuthed, field.TypeBool, value)
	}
	if ruu.mutation.AuthedCleared() {
		_spec.ClearField(rootuser.FieldAuthed, field.TypeBool)
	}
	if value, ok := ruu.mutation.Remark(); ok {
		_spec.SetField(rootuser.FieldRemark, field.TypeString, value)
	}
	if ruu.mutation.RemarkCleared() {
		_spec.ClearField(rootuser.FieldRemark, field.TypeString)
	}
...
// Where appends a list predicates to the RootUserUpdate builder.
func (ruuo *RootUserUpdateOne) Where(ps ...predicate.RootUser) *RootUserUpdateOne {
...
// defaults sets the default values of the builder before save.
func (ruuo *RootUserUpdateOne) defaults() {
...
func (ruuo *RootUserUpdateOne) sqlSave(ctx context.Context) (_node *RootUser, err error) {
	...
	if !ok {
		return nil, &ValidationError{Name: "id", err: errors.New(`generated: missing "RootUser.id" for update`)}
	}
