...
func (*FractionWithdrawal) scanValues(columns []string) ([]any, error) {
...
func (fw *FractionWithdrawal) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		default:
			fw.selectValues.Set(columns[i], values[i])
		}
	}
	return nil
}

// Value returns the ent.Value that was dynamically selected and assigned to the FractionWithdrawal.
// This includes values selected through modifiers, order, etc.
func (fw *FractionWithdrawal) Value(name string) (ent.Value, error) {
	return fw.selectValues.Get(name)
}
...
func (fw *FractionWithdrawal) Update() *FractionWithdrawalUpdateOne {
	return NewFractionWithdrawalClient(fw.config).UpdateOne(fw)
}
...
func (fw *FractionWithdrawal) Unwrap() *FractionWithdrawal {
	...
	if !ok {
		panic("generated: FractionWithdrawal is not a transactional entity")
	}
