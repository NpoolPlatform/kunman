...
func (cq *CoinQuery) IDs(ctx context.Context) (ids []uint32, err error) {
...
func (cq *CoinQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(coin.Table, coin.Columns, sqlgraph.NewFieldSpec(coin.FieldID, field.TypeUint32))
	_spec.From = cq.sql
