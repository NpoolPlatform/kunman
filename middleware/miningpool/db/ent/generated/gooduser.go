...
func (*GoodUser) scanValues(columns []string) ([]any, error) {
...
func (gu *GoodUser) assignValues(columns []string, values []any) error {
...
// Value returns the ent.Value that was dynamically selected and assigned to the GoodUser.
// This includes values selected through modifiers, order, etc.
func (gu *GoodUser) Value(name string) (ent.Value, error) {
...
func (gu *GoodUser) Update() *GoodUserUpdateOne {
	return NewGoodUserClient(gu.config).UpdateOne(gu)
}
...
func (gu *GoodUser) Unwrap() *GoodUser {
	...
	if !ok {
		panic("generated: GoodUser is not a transactional entity")
	}
