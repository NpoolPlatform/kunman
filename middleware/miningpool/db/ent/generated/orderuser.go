...
func (*OrderUser) scanValues(columns []string) ([]any, error) {
...
func (ou *OrderUser) assignValues(columns []string, values []any) error {
...
// Value returns the ent.Value that was dynamically selected and assigned to the OrderUser.
// This includes values selected through modifiers, order, etc.
func (ou *OrderUser) Value(name string) (ent.Value, error) {
...
func (ou *OrderUser) Update() *OrderUserUpdateOne {
	return NewOrderUserClient(ou.config).UpdateOne(ou)
}
...
func (ou *OrderUser) Unwrap() *OrderUser {
	...
	if !ok {
		panic("generated: OrderUser is not a transactional entity")
	}
