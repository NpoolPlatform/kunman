...
func (*RootUser) scanValues(columns []string) ([]any, error) {
...
func (ru *RootUser) assignValues(columns []string, values []any) error {
...
// Value returns the ent.Value that was dynamically selected and assigned to the RootUser.
// This includes values selected through modifiers, order, etc.
func (ru *RootUser) Value(name string) (ent.Value, error) {
...
func (ru *RootUser) Update() *RootUserUpdateOne {
	return NewRootUserClient(ru.config).UpdateOne(ru)
}
...
func (ru *RootUser) Unwrap() *RootUser {
	...
	if !ok {
		panic("generated: RootUser is not a transactional entity")
	}
