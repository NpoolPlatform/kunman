...
func (ruc *RootUserCreate) defaults() {
...
func (ruc *RootUserCreate) check() error {
	if _, ok := ruc.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`generated: missing required field "RootUser.created_at"`)}
	}
	if _, ok := ruc.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`generated: missing required field "RootUser.updated_at"`)}
	}
	if _, ok := ruc.mutation.DeletedAt(); !ok {
		return &ValidationError{Name: "deleted_at", err: errors.New(`generated: missing required field "RootUser.deleted_at"`)}
	}
	if _, ok := ruc.mutation.EntID(); !ok {
		return &ValidationError{Name: "ent_id", err: errors.New(`generated: missing required field "RootUser.ent_id"`)}
	}
	return nil
}
...
func (ruc *RootUserCreate) createSpec() (*RootUser, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(rootuser.Table, sqlgraph.NewFieldSpec(rootuser.FieldID, field.TypeUint32))
	)
...
func (u *RootUserUpsertOne) Exec(ctx context.Context) error {
	if len(u.create.conflict) == 0 {
		return errors.New("generated: missing options for RootUserCreate.OnConflict")
	}
...
func (u *RootUserUpsertBulk) Exec(ctx context.Context) error {
	...
	for i, b := range u.create.builders {
		if len(b.conflict) != 0 {
			return fmt.Errorf("generated: OnConflict was set for builder %d. Set it on the RootUserCreateBulk instead", i)
		}
	}
	if len(u.create.conflict) == 0 {
		return errors.New("generated: missing options for RootUserCreateBulk.OnConflict")
	}
	return u.create.Exec(ctx)
}
