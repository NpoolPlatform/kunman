...
func (apc *AppPoolCreate) defaults() {
...
func (apc *AppPoolCreate) check() error {
	if _, ok := apc.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`generated: missing required field "AppPool.created_at"`)}
	}
	if _, ok := apc.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`generated: missing required field "AppPool.updated_at"`)}
	}
	if _, ok := apc.mutation.DeletedAt(); !ok {
		return &ValidationError{Name: "deleted_at", err: errors.New(`generated: missing required field "AppPool.deleted_at"`)}
	}
	if _, ok := apc.mutation.EntID(); !ok {
		return &ValidationError{Name: "ent_id", err: errors.New(`generated: missing required field "AppPool.ent_id"`)}
	}
	return nil
}
...
func (apc *AppPoolCreate) createSpec() (*AppPool, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(apppool.Table, sqlgraph.NewFieldSpec(apppool.FieldID, field.TypeUint32))
	)
	...
	if value, ok := apc.mutation.CreatedAt(); ok {
		_spec.SetField(apppool.FieldCreatedAt, field.TypeUint32, value)
		_node.CreatedAt = value
	}
	if value, ok := apc.mutation.UpdatedAt(); ok {
		_spec.SetField(apppool.FieldUpdatedAt, field.TypeUint32, value)
		_node.UpdatedAt = value
	}
	if value, ok := apc.mutation.DeletedAt(); ok {
		_spec.SetField(apppool.FieldDeletedAt, field.TypeUint32, value)
		_node.DeletedAt = value
	}
	if value, ok := apc.mutation.EntID(); ok {
		_spec.SetField(apppool.FieldEntID, field.TypeUUID, value)
		_node.EntID = value
	}
	if value, ok := apc.mutation.AppID(); ok {
		_spec.SetField(apppool.FieldAppID, field.TypeUUID, value)
		_node.AppID = value
	}
	if value, ok := apc.mutation.PoolID(); ok {
		_spec.SetField(apppool.FieldPoolID, field.TypeUUID, value)
		_node.PoolID = value
	}
	return _node, _spec
}
...
func (u *AppPoolUpsertOne) Exec(ctx context.Context) error {
	if len(u.create.conflict) == 0 {
		return errors.New("generated: missing options for AppPoolCreate.OnConflict")
	}
...
func (u *AppPoolUpsertBulk) Exec(ctx context.Context) error {
	...
	for i, b := range u.create.builders {
		if len(b.conflict) != 0 {
			return fmt.Errorf("generated: OnConflict was set for builder %d. Set it on the AppPoolCreateBulk instead", i)
		}
	}
	if len(u.create.conflict) == 0 {
		return errors.New("generated: missing options for AppPoolCreateBulk.OnConflict")
	}
	return u.create.Exec(ctx)
}
