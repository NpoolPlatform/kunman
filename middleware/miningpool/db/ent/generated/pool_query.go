...
func (pq *PoolQuery) IDs(ctx context.Context) (ids []uint32, err error) {
...
func (pq *PoolQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(pool.Table, pool.Columns, sqlgraph.NewFieldSpec(pool.FieldID, field.TypeUint32))
	_spec.From = pq.sql
