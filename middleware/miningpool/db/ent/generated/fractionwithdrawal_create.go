...
func (fwc *FractionWithdrawalCreate) Save(ctx context.Context) (*FractionWithdrawal, error) {
	fwc.defaults()
	return withHooks(ctx, fwc.sqlSave, fwc.mutation, fwc.hooks)
}
...
func (fwc *FractionWithdrawalCreate) defaults() {
...
func (fwc *FractionWithdrawalCreate) check() error {
	if _, ok := fwc.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`generated: missing required field "FractionWithdrawal.created_at"`)}
	}
	if _, ok := fwc.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`generated: missing required field "FractionWithdrawal.updated_at"`)}
	}
	if _, ok := fwc.mutation.DeletedAt(); !ok {
		return &ValidationError{Name: "deleted_at", err: errors.New(`generated: missing required field "FractionWithdrawal.deleted_at"`)}
	}
	if _, ok := fwc.mutation.EntID(); !ok {
		return &ValidationError{Name: "ent_id", err: errors.New(`generated: missing required field "FractionWithdrawal.ent_id"`)}
	}
	return nil
}
...
func (fwc *FractionWithdrawalCreate) sqlSave(ctx context.Context) (*FractionWithdrawal, error) {
	...
	fwc.mutation.id = &_node.ID
	fwc.mutation.done = true
	return _node, nil
}
...
func (fwc *FractionWithdrawalCreate) createSpec() (*FractionWithdrawal, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(fractionwithdrawal.Table, sqlgraph.NewFieldSpec(fractionwithdrawal.FieldID, field.TypeUint32))
	)
...
func (u *FractionWithdrawalUpsertOne) Exec(ctx context.Context) error {
	if len(u.create.conflict) == 0 {
		return errors.New("generated: missing options for FractionWithdrawalCreate.OnConflict")
	}
...
func (u *FractionWithdrawalUpsertBulk) Exec(ctx context.Context) error {
	...
	for i, b := range u.create.builders {
		if len(b.conflict) != 0 {
			return fmt.Errorf("generated: OnConflict was set for builder %d. Set it on the FractionWithdrawalCreateBulk instead", i)
		}
	}
	if len(u.create.conflict) == 0 {
		return errors.New("generated: missing options for FractionWithdrawalCreateBulk.OnConflict")
	}
	return u.create.Exec(ctx)
}
