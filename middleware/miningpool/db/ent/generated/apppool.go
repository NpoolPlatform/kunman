...
func (*AppPool) scanValues(columns []string) ([]any, error) {
...
func (ap *AppPool) assignValues(columns []string, values []any) error {
...
// Value returns the ent.Value that was dynamically selected and assigned to the AppPool.
// This includes values selected through modifiers, order, etc.
func (ap *AppPool) Value(name string) (ent.Value, error) {
...
func (ap *AppPool) Update() *AppPoolUpdateOne {
	return NewAppPoolClient(ap.config).UpdateOne(ap)
}
...
func (ap *AppPool) Unwrap() *AppPool {
	...
	if !ok {
		panic("generated: AppPool is not a transactional entity")
	}
