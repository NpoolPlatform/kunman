...
func (ouc *OrderUserCreate) defaults() {
...
func (ouc *OrderUserCreate) check() error {
	if _, ok := ouc.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`generated: missing required field "OrderUser.created_at"`)}
	}
	if _, ok := ouc.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`generated: missing required field "OrderUser.updated_at"`)}
	}
	if _, ok := ouc.mutation.DeletedAt(); !ok {
		return &ValidationError{Name: "deleted_at", err: errors.New(`generated: missing required field "OrderUser.deleted_at"`)}
	}
	if _, ok := ouc.mutation.EntID(); !ok {
		return &ValidationError{Name: "ent_id", err: errors.New(`generated: missing required field "OrderUser.ent_id"`)}
	}
	return nil
}
...
func (ouc *OrderUserCreate) createSpec() (*OrderUser, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(orderuser.Table, sqlgraph.NewFieldSpec(orderuser.FieldID, field.TypeUint32))
	)
...
func (u *OrderUserUpsertOne) Exec(ctx context.Context) error {
	if len(u.create.conflict) == 0 {
		return errors.New("generated: missing options for OrderUserCreate.OnConflict")
	}
...
func (u *OrderUserUpsertBulk) Exec(ctx context.Context) error {
	...
	for i, b := range u.create.builders {
		if len(b.conflict) != 0 {
			return fmt.Errorf("generated: OnConflict was set for builder %d. Set it on the OrderUserCreateBulk instead", i)
		}
	}
	if len(u.create.conflict) == 0 {
		return errors.New("generated: missing options for OrderUserCreateBulk.OnConflict")
	}
	return u.create.Exec(ctx)
}
