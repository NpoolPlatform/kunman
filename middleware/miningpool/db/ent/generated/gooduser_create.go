...
func (guc *GoodUserCreate) defaults() {
...
func (guc *GoodUserCreate) check() error {
	if _, ok := guc.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`generated: missing required field "GoodUser.created_at"`)}
	}
	if _, ok := guc.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`generated: missing required field "GoodUser.updated_at"`)}
	}
	if _, ok := guc.mutation.DeletedAt(); !ok {
		return &ValidationError{Name: "deleted_at", err: errors.New(`generated: missing required field "GoodUser.deleted_at"`)}
	}
	if _, ok := guc.mutation.EntID(); !ok {
		return &ValidationError{Name: "ent_id", err: errors.New(`generated: missing required field "GoodUser.ent_id"`)}
	}
	return nil
}
...
func (guc *GoodUserCreate) createSpec() (*GoodUser, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(gooduser.Table, sqlgraph.NewFieldSpec(gooduser.FieldID, field.TypeUint32))
	)
...
func (u *GoodUserUpsertOne) Exec(ctx context.Context) error {
	if len(u.create.conflict) == 0 {
		return errors.New("generated: missing options for GoodUserCreate.OnConflict")
	}
...
func (u *GoodUserUpsertBulk) Exec(ctx context.Context) error {
	...
	for i, b := range u.create.builders {
		if len(b.conflict) != 0 {
			return fmt.Errorf("generated: OnConflict was set for builder %d. Set it on the GoodUserCreateBulk instead", i)
		}
	}
	if len(u.create.conflict) == 0 {
		return errors.New("generated: missing options for GoodUserCreateBulk.OnConflict")
	}
	return u.create.Exec(ctx)
}
