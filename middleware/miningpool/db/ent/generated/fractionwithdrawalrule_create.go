...
func (fwrc *FractionWithdrawalRuleCreate) Save(ctx context.Context) (*FractionWithdrawalRule, error) {
	fwrc.defaults()
	return withHooks(ctx, fwrc.sqlSave, fwrc.mutation, fwrc.hooks)
}
...
func (fwrc *FractionWithdrawalRuleCreate) defaults() {
...
func (fwrc *FractionWithdrawalRuleCreate) check() error {
	if _, ok := fwrc.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`generated: missing required field "FractionWithdrawalRule.created_at"`)}
	}
	if _, ok := fwrc.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`generated: missing required field "FractionWithdrawalRule.updated_at"`)}
	}
	if _, ok := fwrc.mutation.DeletedAt(); !ok {
		return &ValidationError{Name: "deleted_at", err: errors.New(`generated: missing required field "FractionWithdrawalRule.deleted_at"`)}
	}
	if _, ok := fwrc.mutation.EntID(); !ok {
		return &ValidationError{Name: "ent_id", err: errors.New(`generated: missing required field "FractionWithdrawalRule.ent_id"`)}
	}
	return nil
}
...
func (fwrc *FractionWithdrawalRuleCreate) sqlSave(ctx context.Context) (*FractionWithdrawalRule, error) {
	...
	fwrc.mutation.id = &_node.ID
	fwrc.mutation.done = true
	return _node, nil
}
...
func (fwrc *FractionWithdrawalRuleCreate) createSpec() (*FractionWithdrawalRule, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(fractionwithdrawalrule.Table, sqlgraph.NewFieldSpec(fractionwithdrawalrule.FieldID, field.TypeUint32))
	)
...
func (u *FractionWithdrawalRuleUpsertOne) Exec(ctx context.Context) error {
	if len(u.create.conflict) == 0 {
		return errors.New("generated: missing options for FractionWithdrawalRuleCreate.OnConflict")
	}
...
func (u *FractionWithdrawalRuleUpsertBulk) Exec(ctx context.Context) error {
	...
	for i, b := range u.create.builders {
		if len(b.conflict) != 0 {
			return fmt.Errorf("generated: OnConflict was set for builder %d. Set it on the FractionWithdrawalRuleCreateBulk instead", i)
		}
	}
	if len(u.create.conflict) == 0 {
		return errors.New("generated: missing options for FractionWithdrawalRuleCreateBulk.OnConflict")
	}
	return u.create.Exec(ctx)
}
