...
// ByFeeRatio orders the results by the fee_ratio field.
func ByFeeRatio(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldFeeRatio, opts...).ToFunc()
}

// ByFixedRevenueAble orders the results by the fixed_revenue_able field.
func ByFixedRevenueAble(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldFixedRevenueAble, opts...).ToFunc()
}
...
// ByBenefitIntervalSeconds orders the results by the benefit_interval_seconds field.
func ByBenefitIntervalSeconds(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldBenefitIntervalSeconds, opts...).ToFunc()
}
