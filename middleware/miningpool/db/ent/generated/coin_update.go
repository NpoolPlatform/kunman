...
func (cu *CoinUpdate) sqlSave(ctx context.Context) (n int, err error) {
	_spec := sqlgraph.NewUpdateSpec(coin.Table, coin.Columns, sqlgraph.NewFieldSpec(coin.FieldID, field.TypeUint32))
	...
	if value, ok := cu.mutation.CreatedAt(); ok {
		_spec.SetField(coin.FieldCreatedAt, field.TypeUint32, value)
	}
	if value, ok := cu.mutation.AddedCreatedAt(); ok {
		_spec.AddField(coin.FieldCreatedAt, field.TypeUint32, value)
	}
	if value, ok := cu.mutation.UpdatedAt(); ok {
		_spec.SetField(coin.FieldUpdatedAt, field.TypeUint32, value)
	}
	if value, ok := cu.mutation.AddedUpdatedAt(); ok {
		_spec.AddField(coin.FieldUpdatedAt, field.TypeUint32, value)
	}
	if value, ok := cu.mutation.DeletedAt(); ok {
		_spec.SetField(coin.FieldDeletedAt, field.TypeUint32, value)
	}
	if value, ok := cu.mutation.AddedDeletedAt(); ok {
		_spec.AddField(coin.FieldDeletedAt, field.TypeUint32, value)
	}
	if value, ok := cu.mutation.EntID(); ok {
		_spec.SetField(coin.FieldEntID, field.TypeUUID, value)
	}
	if value, ok := cu.mutation.PoolID(); ok {
		_spec.SetField(coin.FieldPoolID, field.TypeUUID, value)
	}
	if cu.mutation.PoolIDCleared() {
		_spec.ClearField(coin.FieldPoolID, field.TypeUUID)
	}
	if value, ok := cu.mutation.CoinTypeID(); ok {
		_spec.SetField(coin.FieldCoinTypeID, field.TypeUUID, value)
	}
	if cu.mutation.CoinTypeIDCleared() {
		_spec.ClearField(coin.FieldCoinTypeID, field.TypeUUID)
	}
	if value, ok := cu.mutation.CoinType(); ok {
		_spec.SetField(coin.FieldCoinType, field.TypeString, value)
	}
	if cu.mutation.CoinTypeCleared() {
		_spec.ClearField(coin.FieldCoinType, field.TypeString)
	}
	if value, ok := cu.mutation.FeeRatio(); ok {
		_spec.SetField(coin.FieldFeeRatio, field.TypeOther, value)
	}
	if cu.mutation.FeeRatioCleared() {
		_spec.ClearField(coin.FieldFeeRatio, field.TypeOther)
	}
	if value, ok := cu.mutation.FixedRevenueAble(); ok {
		_spec.SetField(coin.FieldFixedRevenueAble, field.TypeBool, value)
	}
	if cu.mutation.FixedRevenueAbleCleared() {
		_spec.ClearField(coin.FieldFixedRevenueAble, field.TypeBool)
	}
	if value, ok := cu.mutation.LeastTransferAmount(); ok {
		_spec.SetField(coin.FieldLeastTransferAmount, field.TypeOther, value)
	}
	if cu.mutation.LeastTransferAmountCleared() {
		_spec.ClearField(coin.FieldLeastTransferAmount, field.TypeOther)
	}
	if value, ok := cu.mutation.BenefitIntervalSeconds(); ok {
		_spec.SetField(coin.FieldBenefitIntervalSeconds, field.TypeUint32, value)
	}
	if value, ok := cu.mutation.AddedBenefitIntervalSeconds(); ok {
		_spec.AddField(coin.FieldBenefitIntervalSeconds, field.TypeUint32, value)
	}
	if cu.mutation.BenefitIntervalSecondsCleared() {
		_spec.ClearField(coin.FieldBenefitIntervalSeconds, field.TypeUint32)
	}
	if value, ok := cu.mutation.Remark(); ok {
		_spec.SetField(coin.FieldRemark, field.TypeString, value)
	}
	if cu.mutation.RemarkCleared() {
		_spec.ClearField(coin.FieldRemark, field.TypeString)
	}
...
func (cuo *CoinUpdateOne) sqlSave(ctx context.Context) (_node *Coin, err error) {
	...
	if !ok {
		return nil, &ValidationError{Name: "id", err: errors.New(`generated: missing "Coin.id" for update`)}
	}
