...
func (cq *CountryQuery) IDs(ctx context.Context) (ids []uint32, err error) {
...
func (cq *CountryQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(country.Table, country.Columns, sqlgraph.NewFieldSpec(country.FieldID, field.TypeUint32))
	_spec.From = cq.sql
