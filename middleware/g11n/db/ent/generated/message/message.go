...
// ByGetIndex orders the results by the get_index field.
func ByGetIndex(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldGetIndex, opts...).ToFunc()
}
