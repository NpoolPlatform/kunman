...
func (pu *ProfitUpdate) SetEntID(u uuid.UUID) *ProfitUpdate {
	pu.mutation.SetEntID(u)
	return pu
}

// SetNillableEntID sets the "ent_id" field if the given value is not nil.
func (pu *ProfitUpdate) SetNillableEntID(u *uuid.UUID) *ProfitUpdate {
	if u != nil {
		pu.SetEntID(*u)
	}
	return pu
...
func (pu *ProfitUpdate) sqlSave(ctx context.Context) (n int, err error) {
	_spec := sqlgraph.NewUpdateSpec(profit.Table, profit.Columns, sqlgraph.NewFieldSpec(profit.FieldID, field.TypeUint32))
	...
	if value, ok := pu.mutation.CreatedAt(); ok {
		_spec.SetField(profit.FieldCreatedAt, field.TypeUint32, value)
	}
	if value, ok := pu.mutation.AddedCreatedAt(); ok {
		_spec.AddField(profit.FieldCreatedAt, field.TypeUint32, value)
	}
	if value, ok := pu.mutation.UpdatedAt(); ok {
		_spec.SetField(profit.FieldUpdatedAt, field.TypeUint32, value)
	}
	if value, ok := pu.mutation.AddedUpdatedAt(); ok {
		_spec.AddField(profit.FieldUpdatedAt, field.TypeUint32, value)
	}
	if value, ok := pu.mutation.DeletedAt(); ok {
		_spec.SetField(profit.FieldDeletedAt, field.TypeUint32, value)
	}
	if value, ok := pu.mutation.AddedDeletedAt(); ok {
		_spec.AddField(profit.FieldDeletedAt, field.TypeUint32, value)
	}
	if value, ok := pu.mutation.EntID(); ok {
		_spec.SetField(profit.FieldEntID, field.TypeUUID, value)
	}
	if value, ok := pu.mutation.AppID(); ok {
		_spec.SetField(profit.FieldAppID, field.TypeUUID, value)
	}
	if pu.mutation.AppIDCleared() {
		_spec.ClearField(profit.FieldAppID, field.TypeUUID)
	}
	if value, ok := pu.mutation.UserID(); ok {
		_spec.SetField(profit.FieldUserID, field.TypeUUID, value)
	}
	if pu.mutation.UserIDCleared() {
		_spec.ClearField(profit.FieldUserID, field.TypeUUID)
	}
	if value, ok := pu.mutation.CoinTypeID(); ok {
		_spec.SetField(profit.FieldCoinTypeID, field.TypeUUID, value)
	}
	if pu.mutation.CoinTypeIDCleared() {
		_spec.ClearField(profit.FieldCoinTypeID, field.TypeUUID)
	}
	if value, ok := pu.mutation.Incoming(); ok {
		_spec.SetField(profit.FieldIncoming, field.TypeFloat64, value)
	}
	if value, ok := pu.mutation.AddedIncoming(); ok {
		_spec.AddField(profit.FieldIncoming, field.TypeFloat64, value)
	}
	if pu.mutation.IncomingCleared() {
		_spec.ClearField(profit.FieldIncoming, field.TypeFloat64)
	}
...
// SetEntID sets the "ent_id" field.
func (puo *ProfitUpdateOne) SetEntID(u uuid.UUID) *ProfitUpdateOne {
	puo.mutation.SetEntID(u)
	return puo
}

// SetNillableEntID sets the "ent_id" field if the given value is not nil.
func (puo *ProfitUpdateOne) SetNillableEntID(u *uuid.UUID) *ProfitUpdateOne {
	if u != nil {
		puo.SetEntID(*u)
	}
	return puo
...
// Where appends a list predicates to the ProfitUpdate builder.
func (puo *ProfitUpdateOne) Where(ps ...predicate.Profit) *ProfitUpdateOne {
...
// defaults sets the default values of the builder before save.
func (puo *ProfitUpdateOne) defaults() {
...
func (puo *ProfitUpdateOne) sqlSave(ctx context.Context) (_node *Profit, err error) {
	...
	if !ok {
		return nil, &ValidationError{Name: "id", err: errors.New(`generated: missing "Profit.id" for update`)}
	}
