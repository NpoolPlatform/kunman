...
func (*SimulateStatement) scanValues(columns []string) ([]any, error) {
...
func (ss *SimulateStatement) assignValues(columns []string, values []any) error {
...
// Value returns the ent.Value that was dynamically selected and assigned to the SimulateStatement.
// This includes values selected through modifiers, order, etc.
func (ss *SimulateStatement) Value(name string) (ent.Value, error) {
...
func (ss *SimulateStatement) Update() *SimulateStatementUpdateOne {
	return NewSimulateStatementClient(ss.config).UpdateOne(ss)
}
...
func (ss *SimulateStatement) Unwrap() *SimulateStatement {
	...
	if !ok {
		panic("generated: SimulateStatement is not a transactional entity")
	}
