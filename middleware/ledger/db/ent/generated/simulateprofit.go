...
func (*SimulateProfit) scanValues(columns []string) ([]any, error) {
...
func (sp *SimulateProfit) assignValues(columns []string, values []any) error {
...
// Value returns the ent.Value that was dynamically selected and assigned to the SimulateProfit.
// This includes values selected through modifiers, order, etc.
func (sp *SimulateProfit) Value(name string) (ent.Value, error) {
...
func (sp *SimulateProfit) Update() *SimulateProfitUpdateOne {
	return NewSimulateProfitClient(sp.config).UpdateOne(sp)
}
...
func (sp *SimulateProfit) Unwrap() *SimulateProfit {
	...
	if !ok {
		panic("generated: SimulateProfit is not a transactional entity")
	}
