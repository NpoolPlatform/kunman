...
const (
	// Label holds the string label denoting the goodledger type in the database.
	Label = "good_ledger"
	...
	FieldToUser = "to_user"
	// Table holds the table name of the goodledger in the database.
	Table = "mining_generals"
)

// Columns holds all SQL columns for goodledger fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
// OrderOption defines the ordering options for the GoodLedger queries.
