...
func (wq *WithdrawQuery) IDs(ctx context.Context) (ids []uint32, err error) {
...
func (wq *WithdrawQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(withdraw.Table, withdraw.Columns, sqlgraph.NewFieldSpec(withdraw.FieldID, field.TypeUint32))
	_spec.From = wq.sql
