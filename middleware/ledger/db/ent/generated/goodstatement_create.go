...
func (gsc *GoodStatementCreate) SetEntID(u uuid.UUID) *GoodStatementCreate {
	gsc.mutation.SetEntID(u)
	return gsc
}

// SetNillableEntID sets the "ent_id" field if the given value is not nil.
func (gsc *GoodStatementCreate) SetNillableEntID(u *uuid.UUID) *GoodStatementCreate {
	if u != nil {
		gsc.SetEntID(*u)
	}
	return gsc
...
func (gsc *GoodStatementCreate) SetID(u uint32) *GoodStatementCreate {
...
func (gsc *GoodStatementCreate) defaults() {
	...
	if _, ok := gsc.mutation.EntID(); !ok {
		v := goodstatement.DefaultEntID()
		gsc.mutation.SetEntID(v)
	}
...
func (gsc *GoodStatementCreate) check() error {
	if _, ok := gsc.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`generated: missing required field "GoodStatement.created_at"`)}
	}
	if _, ok := gsc.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`generated: missing required field "GoodStatement.updated_at"`)}
	}
	if _, ok := gsc.mutation.DeletedAt(); !ok {
		return &ValidationError{Name: "deleted_at", err: errors.New(`generated: missing required field "GoodStatement.deleted_at"`)}
	}
	if _, ok := gsc.mutation.EntID(); !ok {
		return &ValidationError{Name: "ent_id", err: errors.New(`generated: missing required field "GoodStatement.ent_id"`)}
	}
	return nil
}
...
func (gsc *GoodStatementCreate) createSpec() (*GoodStatement, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(goodstatement.Table, sqlgraph.NewFieldSpec(goodstatement.FieldID, field.TypeUint32))
	)
	...
	if value, ok := gsc.mutation.EntID(); ok {
...
// SetEntID sets the "ent_id" field.
func (u *GoodStatementUpsert) SetEntID(v uuid.UUID) *GoodStatementUpsert {
	u.Set(goodstatement.FieldEntID, v)
	return u
}

// UpdateEntID sets the "ent_id" field to the value that was provided on create.
func (u *GoodStatementUpsert) UpdateEntID() *GoodStatementUpsert {
	u.SetExcluded(goodstatement.FieldEntID)
	return u
}
...
// SetEntID sets the "ent_id" field.
func (u *GoodStatementUpsertOne) SetEntID(v uuid.UUID) *GoodStatementUpsertOne {
	return u.Update(func(s *GoodStatementUpsert) {
		s.SetEntID(v)
	})
}
...
// UpdateEntID sets the "ent_id" field to the value that was provided on create.
func (u *GoodStatementUpsertOne) UpdateEntID() *GoodStatementUpsertOne {
	return u.Update(func(s *GoodStatementUpsert) {
		s.UpdateEntID()
	})
}
...
func (u *GoodStatementUpsertOne) Exec(ctx context.Context) error {
	if len(u.create.conflict) == 0 {
		return errors.New("generated: missing options for GoodStatementCreate.OnConflict")
	}
...
func (u *GoodStatementUpsertOne) ID(ctx context.Context) (id uint32, err error) {
...
func (u *GoodStatementUpsertOne) IDX(ctx context.Context) uint32 {
	id, err := u.ID(ctx)
	if err != nil {
		panic(err)
	}
...
// SetEntID sets the "ent_id" field.
func (u *GoodStatementUpsertBulk) SetEntID(v uuid.UUID) *GoodStatementUpsertBulk {
	return u.Update(func(s *GoodStatementUpsert) {
		s.SetEntID(v)
	})
}
...
// UpdateEntID sets the "ent_id" field to the value that was provided on create.
func (u *GoodStatementUpsertBulk) UpdateEntID() *GoodStatementUpsertBulk {
	return u.Update(func(s *GoodStatementUpsert) {
		s.UpdateEntID()
	})
}
...
func (u *GoodStatementUpsertBulk) Exec(ctx context.Context) error {
	...
	for i, b := range u.create.builders {
		if len(b.conflict) != 0 {
			return fmt.Errorf("generated: OnConflict was set for builder %d. Set it on the GoodStatementCreateBulk instead", i)
		}
	}
	if len(u.create.conflict) == 0 {
		return errors.New("generated: missing options for GoodStatementCreateBulk.OnConflict")
	}
	return u.create.Exec(ctx)
}
