...
func (usu *UnsoldStatementUpdate) defaults() {
...
func (usu *UnsoldStatementUpdate) Modify(modifiers ...func(u *sql.UpdateBuilder)) *UnsoldStatementUpdate {
	usu.modifiers = append(usu.modifiers, modifiers...)
	return usu
}

func (usu *UnsoldStatementUpdate) sqlSave(ctx context.Context) (n int, err error) {
	_spec := sqlgraph.NewUpdateSpec(unsoldstatement.Table, unsoldstatement.Columns, sqlgraph.NewFieldSpec(unsoldstatement.FieldID, field.TypeUint32))
	...
	if value, ok := usu.mutation.CreatedAt(); ok {
		_spec.SetField(unsoldstatement.FieldCreatedAt, field.TypeUint32, value)
	}
	if value, ok := usu.mutation.AddedCreatedAt(); ok {
		_spec.AddField(unsoldstatement.FieldCreatedAt, field.TypeUint32, value)
	}
	if value, ok := usu.mutation.UpdatedAt(); ok {
		_spec.SetField(unsoldstatement.FieldUpdatedAt, field.TypeUint32, value)
	}
	if value, ok := usu.mutation.AddedUpdatedAt(); ok {
		_spec.AddField(unsoldstatement.FieldUpdatedAt, field.TypeUint32, value)
	}
	if value, ok := usu.mutation.DeletedAt(); ok {
		_spec.SetField(unsoldstatement.FieldDeletedAt, field.TypeUint32, value)
	}
	if value, ok := usu.mutation.AddedDeletedAt(); ok {
		_spec.AddField(unsoldstatement.FieldDeletedAt, field.TypeUint32, value)
	}
	if value, ok := usu.mutation.EntID(); ok {
		_spec.SetField(unsoldstatement.FieldEntID, field.TypeUUID, value)
	}
	if value, ok := usu.mutation.GoodID(); ok {
		_spec.SetField(unsoldstatement.FieldGoodID, field.TypeUUID, value)
	}
	if usu.mutation.GoodIDCleared() {
		_spec.ClearField(unsoldstatement.FieldGoodID, field.TypeUUID)
	}
	if value, ok := usu.mutation.CoinTypeID(); ok {
		_spec.SetField(unsoldstatement.FieldCoinTypeID, field.TypeUUID, value)
	}
	if usu.mutation.CoinTypeIDCleared() {
		_spec.ClearField(unsoldstatement.FieldCoinTypeID, field.TypeUUID)
	}
	if value, ok := usu.mutation.Amount(); ok {
		_spec.SetField(unsoldstatement.FieldAmount, field.TypeFloat64, value)
	}
	if value, ok := usu.mutation.AddedAmount(); ok {
		_spec.AddField(unsoldstatement.FieldAmount, field.TypeFloat64, value)
	}
	if usu.mutation.AmountCleared() {
		_spec.ClearField(unsoldstatement.FieldAmount, field.TypeFloat64)
	}
	if value, ok := usu.mutation.BenefitDate(); ok {
		_spec.SetField(unsoldstatement.FieldBenefitDate, field.TypeUint32, value)
	}
	if value, ok := usu.mutation.AddedBenefitDate(); ok {
		_spec.AddField(unsoldstatement.FieldBenefitDate, field.TypeUint32, value)
	}
	if usu.mutation.BenefitDateCleared() {
		_spec.ClearField(unsoldstatement.FieldBenefitDate, field.TypeUint32)
	}
	if value, ok := usu.mutation.StatementID(); ok {
		_spec.SetField(unsoldstatement.FieldStatementID, field.TypeUUID, value)
	}
	if usu.mutation.StatementIDCleared() {
		_spec.ClearField(unsoldstatement.FieldStatementID, field.TypeUUID)
	}
...
// Where appends a list predicates to the UnsoldStatementUpdate builder.
func (usuo *UnsoldStatementUpdateOne) Where(ps ...predicate.UnsoldStatement) *UnsoldStatementUpdateOne {
...
// defaults sets the default values of the builder before save.
func (usuo *UnsoldStatementUpdateOne) defaults() {
...
// Modify adds a statement modifier for attaching custom logic to the UPDATE statement.
func (usuo *UnsoldStatementUpdateOne) Modify(modifiers ...func(u *sql.UpdateBuilder)) *UnsoldStatementUpdateOne {
...
func (usuo *UnsoldStatementUpdateOne) sqlSave(ctx context.Context) (_node *UnsoldStatement, err error) {
	...
	if !ok {
		return nil, &ValidationError{Name: "id", err: errors.New(`generated: missing "UnsoldStatement.id" for update`)}
	}
