...
func (slc *SimulateLedgerCreate) defaults() {
...
func (slc *SimulateLedgerCreate) check() error {
	if _, ok := slc.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`generated: missing required field "SimulateLedger.created_at"`)}
	}
	if _, ok := slc.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`generated: missing required field "SimulateLedger.updated_at"`)}
	}
	if _, ok := slc.mutation.DeletedAt(); !ok {
		return &ValidationError{Name: "deleted_at", err: errors.New(`generated: missing required field "SimulateLedger.deleted_at"`)}
	}
	if _, ok := slc.mutation.EntID(); !ok {
		return &ValidationError{Name: "ent_id", err: errors.New(`generated: missing required field "SimulateLedger.ent_id"`)}
	}
	return nil
}
...
func (slc *SimulateLedgerCreate) createSpec() (*SimulateLedger, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(simulateledger.Table, sqlgraph.NewFieldSpec(simulateledger.FieldID, field.TypeUint32))
	)
...
func (u *SimulateLedgerUpsertOne) Exec(ctx context.Context) error {
	if len(u.create.conflict) == 0 {
		return errors.New("generated: missing options for SimulateLedgerCreate.OnConflict")
	}
...
func (u *SimulateLedgerUpsertBulk) Exec(ctx context.Context) error {
	...
	for i, b := range u.create.builders {
		if len(b.conflict) != 0 {
			return fmt.Errorf("generated: OnConflict was set for builder %d. Set it on the SimulateLedgerCreateBulk instead", i)
		}
	}
	if len(u.create.conflict) == 0 {
		return errors.New("generated: missing options for SimulateLedgerCreateBulk.OnConflict")
	}
	return u.create.Exec(ctx)
}
