...
const (
	// Label holds the string label denoting the simulateledger type in the database.
	Label = "simulate_ledger"
	...
	// Table holds the table name of the simulateledger in the database.
	Table = "simulate_generals"
)

// Columns holds all SQL columns for simulateledger fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
// OrderOption defines the ordering options for the SimulateLedger queries.
