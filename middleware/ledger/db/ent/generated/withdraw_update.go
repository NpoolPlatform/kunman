...
func (wu *WithdrawUpdate) defaults() {
...
func (wu *WithdrawUpdate) sqlSave(ctx context.Context) (n int, err error) {
	_spec := sqlgraph.NewUpdateSpec(withdraw.Table, withdraw.Columns, sqlgraph.NewFieldSpec(withdraw.FieldID, field.TypeUint32))
	...
	if value, ok := wu.mutation.CreatedAt(); ok {
		_spec.SetField(withdraw.FieldCreatedAt, field.TypeUint32, value)
	}
	if value, ok := wu.mutation.AddedCreatedAt(); ok {
		_spec.AddField(withdraw.FieldCreatedAt, field.TypeUint32, value)
	}
	if value, ok := wu.mutation.UpdatedAt(); ok {
		_spec.SetField(withdraw.FieldUpdatedAt, field.TypeUint32, value)
	}
	if value, ok := wu.mutation.AddedUpdatedAt(); ok {
		_spec.AddField(withdraw.FieldUpdatedAt, field.TypeUint32, value)
	}
	if value, ok := wu.mutation.DeletedAt(); ok {
		_spec.SetField(withdraw.FieldDeletedAt, field.TypeUint32, value)
	}
	if value, ok := wu.mutation.AddedDeletedAt(); ok {
		_spec.AddField(withdraw.FieldDeletedAt, field.TypeUint32, value)
	}
	if value, ok := wu.mutation.EntID(); ok {
		_spec.SetField(withdraw.FieldEntID, field.TypeUUID, value)
	}
	if value, ok := wu.mutation.AppID(); ok {
		_spec.SetField(withdraw.FieldAppID, field.TypeUUID, value)
	}
	if wu.mutation.AppIDCleared() {
		_spec.ClearField(withdraw.FieldAppID, field.TypeUUID)
	}
	if value, ok := wu.mutation.UserID(); ok {
		_spec.SetField(withdraw.FieldUserID, field.TypeUUID, value)
	}
	if wu.mutation.UserIDCleared() {
		_spec.ClearField(withdraw.FieldUserID, field.TypeUUID)
	}
	if value, ok := wu.mutation.CoinTypeID(); ok {
		_spec.SetField(withdraw.FieldCoinTypeID, field.TypeUUID, value)
	}
	if wu.mutation.CoinTypeIDCleared() {
		_spec.ClearField(withdraw.FieldCoinTypeID, field.TypeUUID)
	}
	if value, ok := wu.mutation.AccountID(); ok {
		_spec.SetField(withdraw.FieldAccountID, field.TypeUUID, value)
	}
	if wu.mutation.AccountIDCleared() {
		_spec.ClearField(withdraw.FieldAccountID, field.TypeUUID)
	}
	...
	if wu.mutation.AddressCleared() {
		_spec.ClearField(withdraw.FieldAddress, field.TypeString)
	}
	if value, ok := wu.mutation.PlatformTransactionID(); ok {
		_spec.SetField(withdraw.FieldPlatformTransactionID, field.TypeUUID, value)
	}
	if wu.mutation.PlatformTransactionIDCleared() {
		_spec.ClearField(withdraw.FieldPlatformTransactionID, field.TypeUUID)
	}
	if value, ok := wu.mutation.ChainTransactionID(); ok {
		_spec.SetField(withdraw.FieldChainTransactionID, field.TypeString, value)
	}
	if wu.mutation.ChainTransactionIDCleared() {
		_spec.ClearField(withdraw.FieldChainTransactionID, field.TypeString)
	}
	if value, ok := wu.mutation.State(); ok {
		_spec.SetField(withdraw.FieldState, field.TypeString, value)
	}
	if wu.mutation.StateCleared() {
		_spec.ClearField(withdraw.FieldState, field.TypeString)
	}
	...
	if wu.mutation.AmountCleared() {
		_spec.ClearField(withdraw.FieldAmount, field.TypeFloat64)
	}
	if value, ok := wu.mutation.ReviewID(); ok {
		_spec.SetField(withdraw.FieldReviewID, field.TypeUUID, value)
	}
	if wu.mutation.ReviewIDCleared() {
		_spec.ClearField(withdraw.FieldReviewID, field.TypeUUID)
	}
...
// defaults sets the default values of the builder before save.
func (wuo *WithdrawUpdateOne) defaults() {
...
func (wuo *WithdrawUpdateOne) sqlSave(ctx context.Context) (_node *Withdraw, err error) {
	...
	if !ok {
		return nil, &ValidationError{Name: "id", err: errors.New(`generated: missing "Withdraw.id" for update`)}
	}
