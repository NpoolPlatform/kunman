...
func (*CouponWithdraw) scanValues(columns []string) ([]any, error) {
...
func (cw *CouponWithdraw) assignValues(columns []string, values []any) error {
...
// Value returns the ent.Value that was dynamically selected and assigned to the CouponWithdraw.
// This includes values selected through modifiers, order, etc.
func (cw *CouponWithdraw) Value(name string) (ent.Value, error) {
...
func (cw *CouponWithdraw) Update() *CouponWithdrawUpdateOne {
	return NewCouponWithdrawClient(cw.config).UpdateOne(cw)
}
...
func (cw *CouponWithdraw) Unwrap() *CouponWithdraw {
	...
	if !ok {
		panic("generated: CouponWithdraw is not a transactional entity")
	}
