...
func (wc *WithdrawCreate) check() error {
	if _, ok := wc.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`generated: missing required field "Withdraw.created_at"`)}
	}
	if _, ok := wc.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`generated: missing required field "Withdraw.updated_at"`)}
	}
	if _, ok := wc.mutation.DeletedAt(); !ok {
		return &ValidationError{Name: "deleted_at", err: errors.New(`generated: missing required field "Withdraw.deleted_at"`)}
	}
	if _, ok := wc.mutation.EntID(); !ok {
		return &ValidationError{Name: "ent_id", err: errors.New(`generated: missing required field "Withdraw.ent_id"`)}
	}
	return nil
}
...
func (wc *WithdrawCreate) createSpec() (*Withdraw, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(withdraw.Table, sqlgraph.NewFieldSpec(withdraw.FieldID, field.TypeUint32))
	)
...
func (u *WithdrawUpsertOne) Exec(ctx context.Context) error {
	if len(u.create.conflict) == 0 {
		return errors.New("generated: missing options for WithdrawCreate.OnConflict")
	}
...
func (u *WithdrawUpsertBulk) Exec(ctx context.Context) error {
	...
	for i, b := range u.create.builders {
		if len(b.conflict) != 0 {
			return fmt.Errorf("generated: OnConflict was set for builder %d. Set it on the WithdrawCreateBulk instead", i)
		}
	}
	if len(u.create.conflict) == 0 {
		return errors.New("generated: missing options for WithdrawCreateBulk.OnConflict")
	}
	return u.create.Exec(ctx)
}
