...
// OrderOption defines the ordering options for the SimulateStatement queries.
...
// BySendCoupon orders the results by the send_coupon field.
func BySendCoupon(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldSendCoupon, opts...).ToFunc()
}
