...
func (lq *LedgerQuery) IDs(ctx context.Context) (ids []uint32, err error) {
...
func (lq *LedgerQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(ledger.Table, ledger.Columns, sqlgraph.NewFieldSpec(ledger.FieldID, field.TypeUint32))
	_spec.From = lq.sql
...
func (lq *LedgerQuery) Modify(modifiers ...func(s *sql.Selector)) *LedgerSelect {
...
// Modify adds a query modifier for attaching custom logic to queries.
func (ls *LedgerSelect) Modify(modifiers ...func(s *sql.Selector)) *LedgerSelect {
