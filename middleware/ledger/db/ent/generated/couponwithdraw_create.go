...
func (cwc *CouponWithdrawCreate) defaults() {
...
func (cwc *CouponWithdrawCreate) check() error {
	if _, ok := cwc.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`generated: missing required field "CouponWithdraw.created_at"`)}
	}
	if _, ok := cwc.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`generated: missing required field "CouponWithdraw.updated_at"`)}
	}
	if _, ok := cwc.mutation.DeletedAt(); !ok {
		return &ValidationError{Name: "deleted_at", err: errors.New(`generated: missing required field "CouponWithdraw.deleted_at"`)}
	}
	if _, ok := cwc.mutation.EntID(); !ok {
		return &ValidationError{Name: "ent_id", err: errors.New(`generated: missing required field "CouponWithdraw.ent_id"`)}
	}
	return nil
}
...
func (cwc *CouponWithdrawCreate) createSpec() (*CouponWithdraw, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(couponwithdraw.Table, sqlgraph.NewFieldSpec(couponwithdraw.FieldID, field.TypeUint32))
	)
...
func (u *CouponWithdrawUpsertOne) Exec(ctx context.Context) error {
	if len(u.create.conflict) == 0 {
		return errors.New("generated: missing options for CouponWithdrawCreate.OnConflict")
	}
...
func (u *CouponWithdrawUpsertBulk) Exec(ctx context.Context) error {
	...
	for i, b := range u.create.builders {
		if len(b.conflict) != 0 {
			return fmt.Errorf("generated: OnConflict was set for builder %d. Set it on the CouponWithdrawCreateBulk instead", i)
		}
	}
	if len(u.create.conflict) == 0 {
		return errors.New("generated: missing options for CouponWithdrawCreateBulk.OnConflict")
	}
	return u.create.Exec(ctx)
}
