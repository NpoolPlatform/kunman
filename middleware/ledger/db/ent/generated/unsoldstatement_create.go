...
func (usc *UnsoldStatementCreate) defaults() {
...
func (usc *UnsoldStatementCreate) check() error {
	if _, ok := usc.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`generated: missing required field "UnsoldStatement.created_at"`)}
	}
	if _, ok := usc.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`generated: missing required field "UnsoldStatement.updated_at"`)}
	}
	if _, ok := usc.mutation.DeletedAt(); !ok {
		return &ValidationError{Name: "deleted_at", err: errors.New(`generated: missing required field "UnsoldStatement.deleted_at"`)}
	}
	if _, ok := usc.mutation.EntID(); !ok {
		return &ValidationError{Name: "ent_id", err: errors.New(`generated: missing required field "UnsoldStatement.ent_id"`)}
	}
	return nil
}
...
func (usc *UnsoldStatementCreate) createSpec() (*UnsoldStatement, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(unsoldstatement.Table, sqlgraph.NewFieldSpec(unsoldstatement.FieldID, field.TypeUint32))
	)
...
func (u *UnsoldStatementUpsertOne) Exec(ctx context.Context) error {
	if len(u.create.conflict) == 0 {
		return errors.New("generated: missing options for UnsoldStatementCreate.OnConflict")
	}
...
func (u *UnsoldStatementUpsertBulk) Exec(ctx context.Context) error {
	...
	for i, b := range u.create.builders {
		if len(b.conflict) != 0 {
			return fmt.Errorf("generated: OnConflict was set for builder %d. Set it on the UnsoldStatementCreateBulk instead", i)
		}
	}
	if len(u.create.conflict) == 0 {
		return errors.New("generated: missing options for UnsoldStatementCreateBulk.OnConflict")
	}
	return u.create.Exec(ctx)
}
