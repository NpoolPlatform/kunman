...
func (*GoodLedger) scanValues(columns []string) ([]any, error) {
...
func (gl *GoodLedger) assignValues(columns []string, values []any) error {
...
// Value returns the ent.Value that was dynamically selected and assigned to the GoodLedger.
// This includes values selected through modifiers, order, etc.
func (gl *GoodLedger) Value(name string) (ent.Value, error) {
...
func (gl *GoodLedger) Update() *GoodLedgerUpdateOne {
	return NewGoodLedgerClient(gl.config).UpdateOne(gl)
}
...
func (gl *GoodLedger) Unwrap() *GoodLedger {
	...
	if !ok {
		panic("generated: GoodLedger is not a transactional entity")
	}
