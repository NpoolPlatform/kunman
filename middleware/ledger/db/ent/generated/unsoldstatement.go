...
func (*UnsoldStatement) scanValues(columns []string) ([]any, error) {
...
func (us *UnsoldStatement) assignValues(columns []string, values []any) error {
...
// Value returns the ent.Value that was dynamically selected and assigned to the UnsoldStatement.
// This includes values selected through modifiers, order, etc.
func (us *UnsoldStatement) Value(name string) (ent.Value, error) {
...
func (us *UnsoldStatement) Update() *UnsoldStatementUpdateOne {
	return NewUnsoldStatementClient(us.config).UpdateOne(us)
}
...
func (us *UnsoldStatement) Unwrap() *UnsoldStatement {
	...
	if !ok {
		panic("generated: UnsoldStatement is not a transactional entity")
	}
