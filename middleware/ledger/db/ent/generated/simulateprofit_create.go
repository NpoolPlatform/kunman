...
func (spc *SimulateProfitCreate) defaults() {
...
func (spc *SimulateProfitCreate) check() error {
	if _, ok := spc.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`generated: missing required field "SimulateProfit.created_at"`)}
	}
	if _, ok := spc.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`generated: missing required field "SimulateProfit.updated_at"`)}
	}
	if _, ok := spc.mutation.DeletedAt(); !ok {
		return &ValidationError{Name: "deleted_at", err: errors.New(`generated: missing required field "SimulateProfit.deleted_at"`)}
	}
	if _, ok := spc.mutation.EntID(); !ok {
		return &ValidationError{Name: "ent_id", err: errors.New(`generated: missing required field "SimulateProfit.ent_id"`)}
	}
	return nil
}
...
func (spc *SimulateProfitCreate) createSpec() (*SimulateProfit, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(simulateprofit.Table, sqlgraph.NewFieldSpec(simulateprofit.FieldID, field.TypeUint32))
	)
...
func (u *SimulateProfitUpsertOne) Exec(ctx context.Context) error {
	if len(u.create.conflict) == 0 {
		return errors.New("generated: missing options for SimulateProfitCreate.OnConflict")
	}
...
func (u *SimulateProfitUpsertBulk) Exec(ctx context.Context) error {
	...
	for i, b := range u.create.builders {
		if len(b.conflict) != 0 {
			return fmt.Errorf("generated: OnConflict was set for builder %d. Set it on the SimulateProfitCreateBulk instead", i)
		}
	}
	if len(u.create.conflict) == 0 {
		return errors.New("generated: missing options for SimulateProfitCreateBulk.OnConflict")
	}
	return u.create.Exec(ctx)
}
