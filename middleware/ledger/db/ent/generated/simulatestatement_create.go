...
func (ssc *SimulateStatementCreate) defaults() {
...
func (ssc *SimulateStatementCreate) check() error {
	if _, ok := ssc.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`generated: missing required field "SimulateStatement.created_at"`)}
	}
	if _, ok := ssc.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`generated: missing required field "SimulateStatement.updated_at"`)}
	}
	if _, ok := ssc.mutation.DeletedAt(); !ok {
		return &ValidationError{Name: "deleted_at", err: errors.New(`generated: missing required field "SimulateStatement.deleted_at"`)}
	}
	if _, ok := ssc.mutation.EntID(); !ok {
		return &ValidationError{Name: "ent_id", err: errors.New(`generated: missing required field "SimulateStatement.ent_id"`)}
	}
...
func (ssc *SimulateStatementCreate) createSpec() (*SimulateStatement, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(simulatestatement.Table, sqlgraph.NewFieldSpec(simulatestatement.FieldID, field.TypeUint32))
	)
...
func (u *SimulateStatementUpsertOne) Exec(ctx context.Context) error {
	if len(u.create.conflict) == 0 {
		return errors.New("generated: missing options for SimulateStatementCreate.OnConflict")
	}
...
func (u *SimulateStatementUpsertBulk) Exec(ctx context.Context) error {
	...
	for i, b := range u.create.builders {
		if len(b.conflict) != 0 {
			return fmt.Errorf("generated: OnConflict was set for builder %d. Set it on the SimulateStatementCreateBulk instead", i)
		}
	}
	if len(u.create.conflict) == 0 {
		return errors.New("generated: missing options for SimulateStatementCreateBulk.OnConflict")
	}
	return u.create.Exec(ctx)
}
