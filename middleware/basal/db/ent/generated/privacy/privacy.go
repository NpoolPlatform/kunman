...
import (
	...
	"github.com/NpoolPlatform/kunman/middleware/basal/db/ent/generated"
...
type APIQueryRuleFunc func(context.Context, *generated.APIQuery) error

// EvalQuery return f(ctx, q).
func (f APIQueryRuleFunc) EvalQuery(ctx context.Context, q generated.Query) error {
	if q, ok := q.(*generated.APIQuery); ok {
		return f(ctx, q)
	}
	return Denyf("generated/privacy: unexpected query type %T, expect *generated.APIQuery", q)
}

// The APIMutationRuleFunc type is an adapter to allow the use of ordinary
// functions as a mutation rule.
type APIMutationRuleFunc func(context.Context, *generated.APIMutation) error

// EvalMutation calls f(ctx, m).
func (f APIMutationRuleFunc) EvalMutation(ctx context.Context, m generated.Mutation) error {
	if m, ok := m.(*generated.APIMutation); ok {
		return f(ctx, m)
	}
	return Denyf("generated/privacy: unexpected mutation type %T, expect *generated.APIMutation", m)
}
