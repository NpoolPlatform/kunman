...
func (eq *EventQuery) IDs(ctx context.Context) (ids []uint32, err error) {
...
func (eq *EventQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(event.Table, event.Columns, sqlgraph.NewFieldSpec(event.FieldID, field.TypeUint32))
	_spec.From = eq.sql
