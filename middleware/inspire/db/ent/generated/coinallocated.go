...
func (*CoinAllocated) scanValues(columns []string) ([]any, error) {
...
func (ca *CoinAllocated) assignValues(columns []string, values []any) error {
...
// GetValue returns the ent.Value that was dynamically selected and assigned to the CoinAllocated.
// This includes values selected through modifiers, order, etc.
func (ca *CoinAllocated) GetValue(name string) (ent.Value, error) {
...
func (ca *CoinAllocated) Update() *CoinAllocatedUpdateOne {
	return NewCoinAllocatedClient(ca.config).UpdateOne(ca)
}
...
func (ca *CoinAllocated) Unwrap() *CoinAllocated {
	...
	if !ok {
		panic("generated: CoinAllocated is not a transactional entity")
	}
