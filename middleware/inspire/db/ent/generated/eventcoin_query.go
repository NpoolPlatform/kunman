...
func (ecq *EventCoinQuery) Order(o ...eventcoin.OrderOption) *EventCoinQuery {
...
func (ecq *EventCoinQuery) All(ctx context.Context) ([]*EventCoin, error) {
	...
	qr := querierAll[[]*EventCoin, *EventCoinQuery]()
	return withInterceptors[[]*EventCoin](ctx, ecq, qr, ecq.inters)
}
...
func (ecq *EventCoinQuery) IDs(ctx context.Context) (ids []uint32, err error) {
...
func (ecq *EventCoinQuery) Count(ctx context.Context) (int, error) {
	...
	return withInterceptors[int](ctx, ecq, querierCount[*EventCoinQuery](), ecq.inters)
}
...
func (ecq *EventCoinQuery) Clone() *EventCoinQuery {
	...
	return &EventCoinQuery{
		config:     ecq.config,
		ctx:        ecq.ctx.Clone(),
		order:      append([]eventcoin.OrderOption{}, ecq.order...),
...
func (ecq *EventCoinQuery) GroupBy(field string, fields ...string) *EventCoinGroupBy {
	...
	grbuild := &EventCoinGroupBy{build: ecq}
...
func (ecq *EventCoinQuery) Select(fields ...string) *EventCoinSelect {
	...
	sbuild := &EventCoinSelect{EventCoinQuery: ecq}
	sbuild.label = eventcoin.Label
	sbuild.flds, sbuild.scan = &ecq.ctx.Fields, sbuild.Scan
	return sbuild
}

// Aggregate returns a EventCoinSelect configured with the given aggregations.
func (ecq *EventCoinQuery) Aggregate(fns ...AggregateFunc) *EventCoinSelect {
...
func (ecq *EventCoinQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(eventcoin.Table, eventcoin.Columns, sqlgraph.NewFieldSpec(eventcoin.FieldID, field.TypeUint32))
	_spec.From = ecq.sql
...
func (ecgb *EventCoinGroupBy) Scan(ctx context.Context, v any) error {
	ctx = setContextOp(ctx, ecgb.build.ctx, ent.OpQueryGroupBy)
	if err := ecgb.build.prepareQuery(ctx); err != nil {
		return err
	}
	return scanWithInterceptors[*EventCoinQuery, *EventCoinGroupBy](ctx, ecgb.build, ecgb, ecgb.build.inters, v)
}

func (ecgb *EventCoinGroupBy) sqlScan(ctx context.Context, root *EventCoinQuery, v any) error {
...
func (ecs *EventCoinSelect) Aggregate(fns ...AggregateFunc) *EventCoinSelect {
	ecs.fns = append(ecs.fns, fns...)
	return ecs
}

// Scan applies the selector query and scans the result into the given value.
func (ecs *EventCoinSelect) Scan(ctx context.Context, v any) error {
	ctx = setContextOp(ctx, ecs.ctx, ent.OpQuerySelect)
	if err := ecs.prepareQuery(ctx); err != nil {
		return err
	}
	return scanWithInterceptors[*EventCoinQuery, *EventCoinSelect](ctx, ecs.EventCoinQuery, ecs, ecs.inters, v)
}

func (ecs *EventCoinSelect) sqlScan(ctx context.Context, root *EventCoinQuery, v any) error {
