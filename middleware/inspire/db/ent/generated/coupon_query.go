...
func (cq *CouponQuery) IDs(ctx context.Context) (ids []uint32, err error) {
...
func (cq *CouponQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(coupon.Table, coupon.Columns, sqlgraph.NewFieldSpec(coupon.FieldID, field.TypeUint32))
	_spec.From = cq.sql
