...
func (aq *AchievementQuery) IDs(ctx context.Context) (ids []uint32, err error) {
...
func (aq *AchievementQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(achievement.Table, achievement.Columns, sqlgraph.NewFieldSpec(achievement.FieldID, field.TypeUint32))
	_spec.From = aq.sql
