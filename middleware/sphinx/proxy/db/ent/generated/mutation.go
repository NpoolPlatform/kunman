...
type TransactionMutation struct {
	...
	appendutxo          []*sphinxplugin.Unspent
...
// AppendUtxo adds s to the "utxo" field.
func (m *TransactionMutation) AppendUtxo(s []*sphinxplugin.Unspent) {
	m.appendutxo = append(m.appendutxo, s...)
}

// AppendedUtxo returns the list of values that were appended to the "utxo" field in this mutation.
func (m *TransactionMutation) AppendedUtxo() ([]*sphinxplugin.Unspent, bool) {
	if len(m.appendutxo) == 0 {
		return nil, false
	}
	return m.appendutxo, true
}
