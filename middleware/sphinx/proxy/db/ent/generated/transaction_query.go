...
func (tq *TransactionQuery) IDs(ctx context.Context) (ids []uint32, err error) {
...
func (tq *TransactionQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(transaction.Table, transaction.Columns, sqlgraph.NewFieldSpec(transaction.FieldID, field.TypeUint32))
	_spec.From = tq.sql
