...
func (uac *UserAnnouncementCreate) defaults() {
...
func (uac *UserAnnouncementCreate) check() error {
	if _, ok := uac.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`generated: missing required field "UserAnnouncement.created_at"`)}
	}
	if _, ok := uac.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`generated: missing required field "UserAnnouncement.updated_at"`)}
	}
	if _, ok := uac.mutation.DeletedAt(); !ok {
		return &ValidationError{Name: "deleted_at", err: errors.New(`generated: missing required field "UserAnnouncement.deleted_at"`)}
	}
	if _, ok := uac.mutation.EntID(); !ok {
		return &ValidationError{Name: "ent_id", err: errors.New(`generated: missing required field "UserAnnouncement.ent_id"`)}
	}
	return nil
}
...
func (uac *UserAnnouncementCreate) createSpec() (*UserAnnouncement, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(userannouncement.Table, sqlgraph.NewFieldSpec(userannouncement.FieldID, field.TypeUint32))
	)
...
func (u *UserAnnouncementUpsertOne) Exec(ctx context.Context) error {
	if len(u.create.conflict) == 0 {
		return errors.New("generated: missing options for UserAnnouncementCreate.OnConflict")
	}
...
func (u *UserAnnouncementUpsertBulk) Exec(ctx context.Context) error {
	...
	for i, b := range u.create.builders {
		if len(b.conflict) != 0 {
			return fmt.Errorf("generated: OnConflict was set for builder %d. Set it on the UserAnnouncementCreateBulk instead", i)
		}
	}
	if len(u.create.conflict) == 0 {
		return errors.New("generated: missing options for UserAnnouncementCreateBulk.OnConflict")
	}
	return u.create.Exec(ctx)
}
