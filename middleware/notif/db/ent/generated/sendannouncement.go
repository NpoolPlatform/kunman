...
func (*SendAnnouncement) scanValues(columns []string) ([]any, error) {
...
func (sa *SendAnnouncement) assignValues(columns []string, values []any) error {
...
// Value returns the ent.Value that was dynamically selected and assigned to the SendAnnouncement.
// This includes values selected through modifiers, order, etc.
func (sa *SendAnnouncement) Value(name string) (ent.Value, error) {
...
func (sa *SendAnnouncement) Update() *SendAnnouncementUpdateOne {
	return NewSendAnnouncementClient(sa.config).UpdateOne(sa)
}
...
func (sa *SendAnnouncement) Unwrap() *SendAnnouncement {
	...
	if !ok {
		panic("generated: SendAnnouncement is not a transactional entity")
	}
