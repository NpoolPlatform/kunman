...
func (gbc *GoodBenefitCreate) createSpec() (*GoodBenefit, *sqlgraph.CreateSpec) {
	...
	if value, ok := gbc.mutation.GoodType(); ok {
		_spec.SetField(goodbenefit.FieldGoodType, field.TypeString, value)
		_node.GoodType = value
	}
	if value, ok := gbc.mutation.GoodName(); ok {
		_spec.SetField(goodbenefit.FieldGoodName, field.TypeString, value)
		_node.GoodName = value
	}
	if value, ok := gbc.mutation.CoinTypeID(); ok {
		_spec.SetField(goodbenefit.FieldCoinTypeID, field.TypeUUID, value)
		_node.CoinTypeID = value
	}
	if value, ok := gbc.mutation.Amount(); ok {
		_spec.SetField(goodbenefit.FieldAmount, field.TypeString, value)
		_node.Amount = value
	}
	if value, ok := gbc.mutation.State(); ok {
		_spec.SetField(goodbenefit.FieldState, field.TypeString, value)
		_node.State = value
	}
	if value, ok := gbc.mutation.Message(); ok {
		_spec.SetField(goodbenefit.FieldMessage, field.TypeString, value)
		_node.Message = value
	}
	if value, ok := gbc.mutation.BenefitDate(); ok {
		_spec.SetField(goodbenefit.FieldBenefitDate, field.TypeUint32, value)
		_node.BenefitDate = value
	}
	if value, ok := gbc.mutation.TxID(); ok {
		_spec.SetField(goodbenefit.FieldTxID, field.TypeUUID, value)
		_node.TxID = value
	}
	if value, ok := gbc.mutation.Generated(); ok {
		_spec.SetField(goodbenefit.FieldGenerated, field.TypeBool, value)
