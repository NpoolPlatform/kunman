...
func (rau *ReadAnnouncementUpdate) defaults() {
...
func (rau *ReadAnnouncementUpdate) sqlSave(ctx context.Context) (n int, err error) {
	_spec := sqlgraph.NewUpdateSpec(readannouncement.Table, readannouncement.Columns, sqlgraph.NewFieldSpec(readannouncement.FieldID, field.TypeUint32))
	...
	if value, ok := rau.mutation.AddedCreatedAt(); ok {
		_spec.AddField(readannouncement.FieldCreatedAt, field.TypeUint32, value)
	}
	...
	if value, ok := rau.mutation.AddedUpdatedAt(); ok {
		_spec.AddField(readannouncement.FieldUpdatedAt, field.TypeUint32, value)
	}
	...
	if value, ok := rau.mutation.AddedDeletedAt(); ok {
		_spec.AddField(readannouncement.FieldDeletedAt, field.TypeUint32, value)
	}
	...
	if rau.mutation.AppIDCleared() {
		_spec.ClearField(readannouncement.FieldAppID, field.TypeUUID)
	}
	...
	if rau.mutation.UserIDCleared() {
		_spec.ClearField(readannouncement.FieldUserID, field.TypeUUID)
	}
	...
	if rau.mutation.AnnouncementIDCleared() {
		_spec.ClearField(readannouncement.FieldAnnouncementID, field.TypeUUID)
	}
...
// Where appends a list predicates to the ReadAnnouncementUpdate builder.
func (rauo *ReadAnnouncementUpdateOne) Where(ps ...predicate.ReadAnnouncement) *ReadAnnouncementUpdateOne {
...
// defaults sets the default values of the builder before save.
func (rauo *ReadAnnouncementUpdateOne) defaults() {
...
func (rauo *ReadAnnouncementUpdateOne) sqlSave(ctx context.Context) (_node *ReadAnnouncement, err error) {
	...
	if !ok {
		return nil, &ValidationError{Name: "id", err: errors.New(`generated: missing "ReadAnnouncement.id" for update`)}
	}
