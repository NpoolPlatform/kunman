...
func (ftc *FrontendTemplateCreate) defaults() {
...
func (ftc *FrontendTemplateCreate) check() error {
	if _, ok := ftc.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`generated: missing required field "FrontendTemplate.created_at"`)}
	}
	if _, ok := ftc.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`generated: missing required field "FrontendTemplate.updated_at"`)}
	}
	if _, ok := ftc.mutation.DeletedAt(); !ok {
		return &ValidationError{Name: "deleted_at", err: errors.New(`generated: missing required field "FrontendTemplate.deleted_at"`)}
	}
	if _, ok := ftc.mutation.EntID(); !ok {
		return &ValidationError{Name: "ent_id", err: errors.New(`generated: missing required field "FrontendTemplate.ent_id"`)}
	}
	if _, ok := ftc.mutation.AppID(); !ok {
		return &ValidationError{Name: "app_id", err: errors.New(`generated: missing required field "FrontendTemplate.app_id"`)}
	}
	if _, ok := ftc.mutation.LangID(); !ok {
		return &ValidationError{Name: "lang_id", err: errors.New(`generated: missing required field "FrontendTemplate.lang_id"`)}
	}
	return nil
}
...
func (ftc *FrontendTemplateCreate) createSpec() (*FrontendTemplate, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(frontendtemplate.Table, sqlgraph.NewFieldSpec(frontendtemplate.FieldID, field.TypeUint32))
	)
...
func (u *FrontendTemplateUpsertOne) Exec(ctx context.Context) error {
	if len(u.create.conflict) == 0 {
		return errors.New("generated: missing options for FrontendTemplateCreate.OnConflict")
	}
...
func (u *FrontendTemplateUpsertBulk) Exec(ctx context.Context) error {
	...
	for i, b := range u.create.builders {
		if len(b.conflict) != 0 {
			return fmt.Errorf("generated: OnConflict was set for builder %d. Set it on the FrontendTemplateCreateBulk instead", i)
		}
	}
	if len(u.create.conflict) == 0 {
		return errors.New("generated: missing options for FrontendTemplateCreateBulk.OnConflict")
	}
	return u.create.Exec(ctx)
}
