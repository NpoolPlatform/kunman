...
func (aq *AnnouncementQuery) IDs(ctx context.Context) (ids []uint32, err error) {
...
func (aq *AnnouncementQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(announcement.Table, announcement.Columns, sqlgraph.NewFieldSpec(announcement.FieldID, field.TypeUint32))
	_spec.From = aq.sql
