...
func (*FrontendTemplate) scanValues(columns []string) ([]any, error) {
...
func (ft *FrontendTemplate) assignValues(columns []string, values []any) error {
...
// Value returns the ent.Value that was dynamically selected and assigned to the FrontendTemplate.
// This includes values selected through modifiers, order, etc.
func (ft *FrontendTemplate) Value(name string) (ent.Value, error) {
...
func (ft *FrontendTemplate) Update() *FrontendTemplateUpdateOne {
	return NewFrontendTemplateClient(ft.config).UpdateOne(ft)
}
...
func (ft *FrontendTemplate) Unwrap() *FrontendTemplate {
	...
	if !ok {
		panic("generated: FrontendTemplate is not a transactional entity")
	}
