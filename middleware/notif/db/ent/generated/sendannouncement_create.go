...
func (sac *SendAnnouncementCreate) defaults() {
...
func (sac *SendAnnouncementCreate) check() error {
	if _, ok := sac.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`generated: missing required field "SendAnnouncement.created_at"`)}
	}
	if _, ok := sac.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`generated: missing required field "SendAnnouncement.updated_at"`)}
	}
	if _, ok := sac.mutation.DeletedAt(); !ok {
		return &ValidationError{Name: "deleted_at", err: errors.New(`generated: missing required field "SendAnnouncement.deleted_at"`)}
	}
	if _, ok := sac.mutation.EntID(); !ok {
		return &ValidationError{Name: "ent_id", err: errors.New(`generated: missing required field "SendAnnouncement.ent_id"`)}
	}
	return nil
}
...
func (sac *SendAnnouncementCreate) createSpec() (*SendAnnouncement, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(sendannouncement.Table, sqlgraph.NewFieldSpec(sendannouncement.FieldID, field.TypeUint32))
	)
...
func (u *SendAnnouncementUpsertOne) Exec(ctx context.Context) error {
	if len(u.create.conflict) == 0 {
		return errors.New("generated: missing options for SendAnnouncementCreate.OnConflict")
	}
...
func (u *SendAnnouncementUpsertBulk) Exec(ctx context.Context) error {
	...
	for i, b := range u.create.builders {
		if len(b.conflict) != 0 {
			return fmt.Errorf("generated: OnConflict was set for builder %d. Set it on the SendAnnouncementCreateBulk instead", i)
		}
	}
	if len(u.create.conflict) == 0 {
		return errors.New("generated: missing options for SendAnnouncementCreateBulk.OnConflict")
	}
	return u.create.Exec(ctx)
}
