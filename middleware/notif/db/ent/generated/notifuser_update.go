...
func (nuu *NotifUserUpdate) defaults() {
...
func (nuu *NotifUserUpdate) sqlSave(ctx context.Context) (n int, err error) {
	_spec := sqlgraph.NewUpdateSpec(notifuser.Table, notifuser.Columns, sqlgraph.NewFieldSpec(notifuser.FieldID, field.TypeUint32))
	...
	if value, ok := nuu.mutation.AddedCreatedAt(); ok {
		_spec.AddField(notifuser.FieldCreatedAt, field.TypeUint32, value)
	}
	...
	if value, ok := nuu.mutation.AddedUpdatedAt(); ok {
		_spec.AddField(notifuser.FieldUpdatedAt, field.TypeUint32, value)
	}
	...
	if value, ok := nuu.mutation.AddedDeletedAt(); ok {
		_spec.AddField(notifuser.FieldDeletedAt, field.TypeUint32, value)
	}
	...
	if nuu.mutation.EventTypeCleared() {
		_spec.ClearField(notifuser.FieldEventType, field.TypeString)
	}
...
// Where appends a list predicates to the NotifUserUpdate builder.
func (nuuo *NotifUserUpdateOne) Where(ps ...predicate.NotifUser) *NotifUserUpdateOne {
...
// defaults sets the default values of the builder before save.
func (nuuo *NotifUserUpdateOne) defaults() {
...
func (nuuo *NotifUserUpdateOne) sqlSave(ctx context.Context) (_node *NotifUser, err error) {
	...
	if !ok {
		return nil, &ValidationError{Name: "id", err: errors.New(`generated: missing "NotifUser.id" for update`)}
	}
