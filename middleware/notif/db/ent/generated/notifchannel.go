...
func (*NotifChannel) scanValues(columns []string) ([]any, error) {
...
func (nc *NotifChannel) assignValues(columns []string, values []any) error {
...
// Value returns the ent.Value that was dynamically selected and assigned to the NotifChannel.
// This includes values selected through modifiers, order, etc.
func (nc *NotifChannel) Value(name string) (ent.Value, error) {
...
func (nc *NotifChannel) Update() *NotifChannelUpdateOne {
	return NewNotifChannelClient(nc.config).UpdateOne(nc)
}
...
func (nc *NotifChannel) Unwrap() *NotifChannel {
	...
	if !ok {
		panic("generated: NotifChannel is not a transactional entity")
	}
