...
func (stu *SMSTemplateUpdate) SetNillableAppID(u *uuid.UUID) *SMSTemplateUpdate {
	if u != nil {
		stu.SetAppID(*u)
	}
	return stu
...
func (stu *SMSTemplateUpdate) SetNillableLangID(u *uuid.UUID) *SMSTemplateUpdate {
	if u != nil {
		stu.SetLangID(*u)
	}
	return stu
...
func (stu *SMSTemplateUpdate) sqlSave(ctx context.Context) (n int, err error) {
	_spec := sqlgraph.NewUpdateSpec(smstemplate.Table, smstemplate.Columns, sqlgraph.NewFieldSpec(smstemplate.FieldID, field.TypeUint32))
	...
	if value, ok := stu.mutation.AddedCreatedAt(); ok {
		_spec.AddField(smstemplate.FieldCreatedAt, field.TypeUint32, value)
	}
	...
	if value, ok := stu.mutation.AddedUpdatedAt(); ok {
		_spec.AddField(smstemplate.FieldUpdatedAt, field.TypeUint32, value)
	}
	...
	if value, ok := stu.mutation.AddedDeletedAt(); ok {
		_spec.AddField(smstemplate.FieldDeletedAt, field.TypeUint32, value)
	}
	...
	if stu.mutation.UsedForCleared() {
		_spec.ClearField(smstemplate.FieldUsedFor, field.TypeString)
	}
	...
	if stu.mutation.SubjectCleared() {
		_spec.ClearField(smstemplate.FieldSubject, field.TypeString)
	}
	...
	if stu.mutation.MessageCleared() {
		_spec.ClearField(smstemplate.FieldMessage, field.TypeString)
	}
...
// SetNillableAppID sets the "app_id" field if the given value is not nil.
func (stuo *SMSTemplateUpdateOne) SetNillableAppID(u *uuid.UUID) *SMSTemplateUpdateOne {
	if u != nil {
		stuo.SetAppID(*u)
	}
	return stuo
...
// SetNillableLangID sets the "lang_id" field if the given value is not nil.
func (stuo *SMSTemplateUpdateOne) SetNillableLangID(u *uuid.UUID) *SMSTemplateUpdateOne {
	if u != nil {
		stuo.SetLangID(*u)
	}
	return stuo
...
func (stuo *SMSTemplateUpdateOne) sqlSave(ctx context.Context) (_node *SMSTemplate, err error) {
	...
	if !ok {
		return nil, &ValidationError{Name: "id", err: errors.New(`generated: missing "SMSTemplate.id" for update`)}
	}
