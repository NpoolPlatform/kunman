...
func (nuc *NotifUserCreate) defaults() {
...
func (nuc *NotifUserCreate) check() error {
	if _, ok := nuc.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`generated: missing required field "NotifUser.created_at"`)}
	}
	if _, ok := nuc.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`generated: missing required field "NotifUser.updated_at"`)}
	}
	if _, ok := nuc.mutation.DeletedAt(); !ok {
		return &ValidationError{Name: "deleted_at", err: errors.New(`generated: missing required field "NotifUser.deleted_at"`)}
	}
	if _, ok := nuc.mutation.EntID(); !ok {
		return &ValidationError{Name: "ent_id", err: errors.New(`generated: missing required field "NotifUser.ent_id"`)}
	}
	return nil
}
...
func (nuc *NotifUserCreate) createSpec() (*NotifUser, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(notifuser.Table, sqlgraph.NewFieldSpec(notifuser.FieldID, field.TypeUint32))
	)
	...
	if value, ok := nuc.mutation.CreatedAt(); ok {
		_spec.SetField(notifuser.FieldCreatedAt, field.TypeUint32, value)
		_node.CreatedAt = value
	}
	if value, ok := nuc.mutation.UpdatedAt(); ok {
		_spec.SetField(notifuser.FieldUpdatedAt, field.TypeUint32, value)
		_node.UpdatedAt = value
	}
	if value, ok := nuc.mutation.DeletedAt(); ok {
		_spec.SetField(notifuser.FieldDeletedAt, field.TypeUint32, value)
		_node.DeletedAt = value
	}
	if value, ok := nuc.mutation.EntID(); ok {
		_spec.SetField(notifuser.FieldEntID, field.TypeUUID, value)
		_node.EntID = value
	}
	if value, ok := nuc.mutation.AppID(); ok {
		_spec.SetField(notifuser.FieldAppID, field.TypeUUID, value)
		_node.AppID = value
	}
	if value, ok := nuc.mutation.UserID(); ok {
		_spec.SetField(notifuser.FieldUserID, field.TypeUUID, value)
		_node.UserID = value
	}
	if value, ok := nuc.mutation.EventType(); ok {
		_spec.SetField(notifuser.FieldEventType, field.TypeString, value)
...
func (u *NotifUserUpsertOne) Exec(ctx context.Context) error {
	if len(u.create.conflict) == 0 {
		return errors.New("generated: missing options for NotifUserCreate.OnConflict")
	}
...
func (u *NotifUserUpsertBulk) Exec(ctx context.Context) error {
	...
	for i, b := range u.create.builders {
		if len(b.conflict) != 0 {
			return fmt.Errorf("generated: OnConflict was set for builder %d. Set it on the NotifUserCreateBulk instead", i)
		}
	}
	if len(u.create.conflict) == 0 {
		return errors.New("generated: missing options for NotifUserCreateBulk.OnConflict")
	}
	return u.create.Exec(ctx)
}
