...
// AppendReplyTos adds s to the "reply_tos" field.
func (m *EmailTemplateMutation) AppendReplyTos(s []string) {
	m.appendreply_tos = append(m.appendreply_tos, s...)
}

// AppendedReplyTos returns the list of values that were appended to the "reply_tos" field in this mutation.
func (m *EmailTemplateMutation) AppendedReplyTos() ([]string, bool) {
	if len(m.appendreply_tos) == 0 {
		return nil, false
	}
	return m.appendreply_tos, true
}
...
// AppendCcTos adds s to the "cc_tos" field.
func (m *EmailTemplateMutation) AppendCcTos(s []string) {
	m.appendcc_tos = append(m.appendcc_tos, s...)
}

// AppendedCcTos returns the list of values that were appended to the "cc_tos" field in this mutation.
func (m *EmailTemplateMutation) AppendedCcTos() ([]string, bool) {
	if len(m.appendcc_tos) == 0 {
		return nil, false
	}
	return m.appendcc_tos, true
}
...
// WhereP appends storage-level predicates to the FrontendTemplateMutation builder. Using this method,
// users can use type-assertion to append predicates that do not depend on any generated package.
func (m *FrontendTemplateMutation) WhereP(ps ...func(*sql.Selector)) {
	p := make([]predicate.FrontendTemplate, len(ps))
	for i := range ps {
		p[i] = ps[i]
	}
	m.Where(p...)
...
// SetOp allows setting the mutation operation.
func (m *FrontendTemplateMutation) SetOp(op Op) {
	m.op = op
}
...
// WhereP appends storage-level predicates to the NotifMutation builder. Using this method,
// users can use type-assertion to append predicates that do not depend on any generated package.
func (m *NotifMutation) WhereP(ps ...func(*sql.Selector)) {
	p := make([]predicate.Notif, len(ps))
	for i := range ps {
		p[i] = ps[i]
	}
	m.Where(p...)
...
// SetOp allows setting the mutation operation.
func (m *NotifMutation) SetOp(op Op) {
	m.op = op
}
...
// WhereP appends storage-level predicates to the NotifChannelMutation builder. Using this method,
// users can use type-assertion to append predicates that do not depend on any generated package.
func (m *NotifChannelMutation) WhereP(ps ...func(*sql.Selector)) {
	p := make([]predicate.NotifChannel, len(ps))
	for i := range ps {
		p[i] = ps[i]
	}
	m.Where(p...)
...
// SetOp allows setting the mutation operation.
func (m *NotifChannelMutation) SetOp(op Op) {
	m.op = op
}
...
// WhereP appends storage-level predicates to the NotifUserMutation builder. Using this method,
// users can use type-assertion to append predicates that do not depend on any generated package.
func (m *NotifUserMutation) WhereP(ps ...func(*sql.Selector)) {
	p := make([]predicate.NotifUser, len(ps))
	for i := range ps {
		p[i] = ps[i]
	}
	m.Where(p...)
...
// SetOp allows setting the mutation operation.
func (m *NotifUserMutation) SetOp(op Op) {
	m.op = op
}
...
// WhereP appends storage-level predicates to the ReadAnnouncementMutation builder. Using this method,
// users can use type-assertion to append predicates that do not depend on any generated package.
func (m *ReadAnnouncementMutation) WhereP(ps ...func(*sql.Selector)) {
	p := make([]predicate.ReadAnnouncement, len(ps))
	for i := range ps {
		p[i] = ps[i]
	}
	m.Where(p...)
...
// SetOp allows setting the mutation operation.
func (m *ReadAnnouncementMutation) SetOp(op Op) {
	m.op = op
}
...
// WhereP appends storage-level predicates to the SendAnnouncementMutation builder. Using this method,
// users can use type-assertion to append predicates that do not depend on any generated package.
func (m *SendAnnouncementMutation) WhereP(ps ...func(*sql.Selector)) {
	p := make([]predicate.SendAnnouncement, len(ps))
	for i := range ps {
		p[i] = ps[i]
	}
	m.Where(p...)
...
// SetOp allows setting the mutation operation.
func (m *SendAnnouncementMutation) SetOp(op Op) {
	m.op = op
}
...
// WhereP appends storage-level predicates to the UserAnnouncementMutation builder. Using this method,
// users can use type-assertion to append predicates that do not depend on any generated package.
func (m *UserAnnouncementMutation) WhereP(ps ...func(*sql.Selector)) {
	p := make([]predicate.UserAnnouncement, len(ps))
	for i := range ps {
		p[i] = ps[i]
	}
	m.Where(p...)
...
// SetOp allows setting the mutation operation.
func (m *UserAnnouncementMutation) SetOp(op Op) {
	m.op = op
}
