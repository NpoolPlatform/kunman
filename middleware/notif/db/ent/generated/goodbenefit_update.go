...
func (gbu *GoodBenefitUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if gbu.mutation.GoodTypeCleared() {
		_spec.ClearField(goodbenefit.FieldGoodType, field.TypeString)
	}
	...
	if gbu.mutation.GoodNameCleared() {
		_spec.ClearField(goodbenefit.FieldGoodName, field.TypeString)
	}
	...
	if gbu.mutation.CoinTypeIDCleared() {
		_spec.ClearField(goodbenefit.FieldCoinTypeID, field.TypeUUID)
	}
	...
	if gbu.mutation.AmountCleared() {
		_spec.ClearField(goodbenefit.FieldAmount, field.TypeString)
	}
	...
	if gbu.mutation.StateCleared() {
		_spec.ClearField(goodbenefit.FieldState, field.TypeString)
	}
	...
	if gbu.mutation.MessageCleared() {
		_spec.ClearField(goodbenefit.FieldMessage, field.TypeString)
	}
	...
	if value, ok := gbu.mutation.AddedBenefitDate(); ok {
		_spec.AddField(goodbenefit.FieldBenefitDate, field.TypeUint32, value)
	}
	if gbu.mutation.BenefitDateCleared() {
		_spec.ClearField(goodbenefit.FieldBenefitDate, field.TypeUint32)
	}
	if value, ok := gbu.mutation.TxID(); ok {
		_spec.SetField(goodbenefit.FieldTxID, field.TypeUUID, value)
	}
	if gbu.mutation.TxIDCleared() {
		_spec.ClearField(goodbenefit.FieldTxID, field.TypeUUID)
	}
	...
	if gbu.mutation.GeneratedCleared() {
		_spec.ClearField(goodbenefit.FieldGenerated, field.TypeBool)
	}
