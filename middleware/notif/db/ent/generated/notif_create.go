...
func (nc *NotifCreate) check() error {
	if _, ok := nc.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`generated: missing required field "Notif.created_at"`)}
	}
	if _, ok := nc.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`generated: missing required field "Notif.updated_at"`)}
	}
	if _, ok := nc.mutation.DeletedAt(); !ok {
		return &ValidationError{Name: "deleted_at", err: errors.New(`generated: missing required field "Notif.deleted_at"`)}
	}
	if _, ok := nc.mutation.EntID(); !ok {
		return &ValidationError{Name: "ent_id", err: errors.New(`generated: missing required field "Notif.ent_id"`)}
	}
	return nil
}
...
func (nc *NotifCreate) createSpec() (*Notif, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(notif.Table, sqlgraph.NewFieldSpec(notif.FieldID, field.TypeUint32))
	)
...
func (u *NotifUpsertOne) Exec(ctx context.Context) error {
	if len(u.create.conflict) == 0 {
		return errors.New("generated: missing options for NotifCreate.OnConflict")
	}
...
func (u *NotifUpsertBulk) Exec(ctx context.Context) error {
	...
	for i, b := range u.create.builders {
		if len(b.conflict) != 0 {
			return fmt.Errorf("generated: OnConflict was set for builder %d. Set it on the NotifCreateBulk instead", i)
		}
	}
	if len(u.create.conflict) == 0 {
		return errors.New("generated: missing options for NotifCreateBulk.OnConflict")
	}
	return u.create.Exec(ctx)
}
