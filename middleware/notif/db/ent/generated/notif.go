...
// Value returns the ent.Value that was dynamically selected and assigned to the Notif.
// This includes values selected through modifiers, order, etc.
func (n *Notif) Value(name string) (ent.Value, error) {
...
func (n *Notif) Update() *NotifUpdateOne {
	return NewNotifClient(n.config).UpdateOne(n)
}
...
func (n *Notif) Unwrap() *Notif {
	...
	if !ok {
		panic("generated: Notif is not a transactional entity")
	}
