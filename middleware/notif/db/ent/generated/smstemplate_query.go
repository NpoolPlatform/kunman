...
func (stq *SMSTemplateQuery) IDs(ctx context.Context) (ids []uint32, err error) {
...
func (stq *SMSTemplateQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(smstemplate.Table, smstemplate.Columns, sqlgraph.NewFieldSpec(smstemplate.FieldID, field.TypeUint32))
	_spec.From = stq.sql
