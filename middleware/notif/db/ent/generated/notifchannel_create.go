...
func (ncc *NotifChannelCreate) defaults() {
...
func (ncc *NotifChannelCreate) check() error {
	if _, ok := ncc.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`generated: missing required field "NotifChannel.created_at"`)}
	}
	if _, ok := ncc.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`generated: missing required field "NotifChannel.updated_at"`)}
	}
	if _, ok := ncc.mutation.DeletedAt(); !ok {
		return &ValidationError{Name: "deleted_at", err: errors.New(`generated: missing required field "NotifChannel.deleted_at"`)}
	}
	if _, ok := ncc.mutation.EntID(); !ok {
		return &ValidationError{Name: "ent_id", err: errors.New(`generated: missing required field "NotifChannel.ent_id"`)}
	}
	return nil
}
...
func (ncc *NotifChannelCreate) createSpec() (*NotifChannel, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(notifchannel.Table, sqlgraph.NewFieldSpec(notifchannel.FieldID, field.TypeUint32))
	)
...
func (u *NotifChannelUpsertOne) Exec(ctx context.Context) error {
	if len(u.create.conflict) == 0 {
		return errors.New("generated: missing options for NotifChannelCreate.OnConflict")
	}
...
func (u *NotifChannelUpsertBulk) Exec(ctx context.Context) error {
	...
	for i, b := range u.create.builders {
		if len(b.conflict) != 0 {
			return fmt.Errorf("generated: OnConflict was set for builder %d. Set it on the NotifChannelCreateBulk instead", i)
		}
	}
	if len(u.create.conflict) == 0 {
		return errors.New("generated: missing options for NotifChannelCreateBulk.OnConflict")
	}
	return u.create.Exec(ctx)
}
