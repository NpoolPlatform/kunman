...
func (stc *SMSTemplateCreate) check() error {
	if _, ok := stc.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`generated: missing required field "SMSTemplate.created_at"`)}
	}
	if _, ok := stc.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`generated: missing required field "SMSTemplate.updated_at"`)}
	}
	if _, ok := stc.mutation.DeletedAt(); !ok {
		return &ValidationError{Name: "deleted_at", err: errors.New(`generated: missing required field "SMSTemplate.deleted_at"`)}
	}
	if _, ok := stc.mutation.EntID(); !ok {
		return &ValidationError{Name: "ent_id", err: errors.New(`generated: missing required field "SMSTemplate.ent_id"`)}
	}
	if _, ok := stc.mutation.AppID(); !ok {
		return &ValidationError{Name: "app_id", err: errors.New(`generated: missing required field "SMSTemplate.app_id"`)}
	}
	if _, ok := stc.mutation.LangID(); !ok {
		return &ValidationError{Name: "lang_id", err: errors.New(`generated: missing required field "SMSTemplate.lang_id"`)}
	}
	return nil
}
...
func (stc *SMSTemplateCreate) createSpec() (*SMSTemplate, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(smstemplate.Table, sqlgraph.NewFieldSpec(smstemplate.FieldID, field.TypeUint32))
	)
	...
	if value, ok := stc.mutation.CreatedAt(); ok {
		_spec.SetField(smstemplate.FieldCreatedAt, field.TypeUint32, value)
		_node.CreatedAt = value
	}
	if value, ok := stc.mutation.UpdatedAt(); ok {
		_spec.SetField(smstemplate.FieldUpdatedAt, field.TypeUint32, value)
		_node.UpdatedAt = value
	}
	if value, ok := stc.mutation.DeletedAt(); ok {
		_spec.SetField(smstemplate.FieldDeletedAt, field.TypeUint32, value)
		_node.DeletedAt = value
	}
	if value, ok := stc.mutation.EntID(); ok {
		_spec.SetField(smstemplate.FieldEntID, field.TypeUUID, value)
		_node.EntID = value
	}
	if value, ok := stc.mutation.AppID(); ok {
		_spec.SetField(smstemplate.FieldAppID, field.TypeUUID, value)
		_node.AppID = value
	}
	if value, ok := stc.mutation.LangID(); ok {
		_spec.SetField(smstemplate.FieldLangID, field.TypeUUID, value)
		_node.LangID = value
	}
	if value, ok := stc.mutation.UsedFor(); ok {
		_spec.SetField(smstemplate.FieldUsedFor, field.TypeString, value)
		_node.UsedFor = value
	}
	if value, ok := stc.mutation.Subject(); ok {
		_spec.SetField(smstemplate.FieldSubject, field.TypeString, value)
		_node.Subject = value
	}
	if value, ok := stc.mutation.Message(); ok {
		_spec.SetField(smstemplate.FieldMessage, field.TypeString, value)
		_node.Message = value
	}
	return _node, _spec
}
...
func (u *SMSTemplateUpsertOne) Exec(ctx context.Context) error {
	if len(u.create.conflict) == 0 {
		return errors.New("generated: missing options for SMSTemplateCreate.OnConflict")
	}
...
func (u *SMSTemplateUpsertBulk) Exec(ctx context.Context) error {
	...
	for i, b := range u.create.builders {
		if len(b.conflict) != 0 {
			return fmt.Errorf("generated: OnConflict was set for builder %d. Set it on the SMSTemplateCreateBulk instead", i)
		}
	}
	if len(u.create.conflict) == 0 {
		return errors.New("generated: missing options for SMSTemplateCreateBulk.OnConflict")
	}
	return u.create.Exec(ctx)
}
