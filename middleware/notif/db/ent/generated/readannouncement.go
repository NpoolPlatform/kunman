...
func (*ReadAnnouncement) scanValues(columns []string) ([]any, error) {
...
func (ra *ReadAnnouncement) assignValues(columns []string, values []any) error {
...
// Value returns the ent.Value that was dynamically selected and assigned to the ReadAnnouncement.
// This includes values selected through modifiers, order, etc.
func (ra *ReadAnnouncement) Value(name string) (ent.Value, error) {
...
func (ra *ReadAnnouncement) Update() *ReadAnnouncementUpdateOne {
	return NewReadAnnouncementClient(ra.config).UpdateOne(ra)
}
...
func (ra *ReadAnnouncement) Unwrap() *ReadAnnouncement {
	...
	if !ok {
		panic("generated: ReadAnnouncement is not a transactional entity")
	}
