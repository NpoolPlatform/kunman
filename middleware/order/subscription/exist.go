...
func (h *Handler) ExistSubscriptionOrder(ctx context.Context) (exist bool, err error) {
...
func (h *Handler) ExistSubscriptionOrderConds(ctx context.Context) (exist bool, err error) {
	handler := &existHandler{
		baseQueryHandler: &baseQueryHandler{
			Handler: h,
		},
