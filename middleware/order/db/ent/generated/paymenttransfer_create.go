...
func (ptc *PaymentTransferCreate) defaults() {
...
func (ptc *PaymentTransferCreate) check() error {
	if _, ok := ptc.mutation.EntID(); !ok {
		return &ValidationError{Name: "ent_id", err: errors.New(`generated: missing required field "PaymentTransfer.ent_id"`)}
	}
	if _, ok := ptc.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`generated: missing required field "PaymentTransfer.created_at"`)}
	}
	if _, ok := ptc.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`generated: missing required field "PaymentTransfer.updated_at"`)}
	}
	if _, ok := ptc.mutation.DeletedAt(); !ok {
		return &ValidationError{Name: "deleted_at", err: errors.New(`generated: missing required field "PaymentTransfer.deleted_at"`)}
	}
	return nil
}
...
func (ptc *PaymentTransferCreate) createSpec() (*PaymentTransfer, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(paymenttransfer.Table, sqlgraph.NewFieldSpec(paymenttransfer.FieldID, field.TypeUint32))
	)
...
func (u *PaymentTransferUpsertOne) Exec(ctx context.Context) error {
	if len(u.create.conflict) == 0 {
		return errors.New("generated: missing options for PaymentTransferCreate.OnConflict")
	}
...
func (u *PaymentTransferUpsertBulk) Exec(ctx context.Context) error {
	...
	for i, b := range u.create.builders {
		if len(b.conflict) != 0 {
			return fmt.Errorf("generated: OnConflict was set for builder %d. Set it on the PaymentTransferCreateBulk instead", i)
		}
	}
	if len(u.create.conflict) == 0 {
		return errors.New("generated: missing options for PaymentTransferCreateBulk.OnConflict")
	}
	return u.create.Exec(ctx)
}
