...
func (*PaymentBalance) scanValues(columns []string) ([]any, error) {
...
func (pb *PaymentBalance) assignValues(columns []string, values []any) error {
...
// Value returns the ent.Value that was dynamically selected and assigned to the PaymentBalance.
// This includes values selected through modifiers, order, etc.
func (pb *PaymentBalance) Value(name string) (ent.Value, error) {
...
func (pb *PaymentBalance) Update() *PaymentBalanceUpdateOne {
	return NewPaymentBalanceClient(pb.config).UpdateOne(pb)
}
...
func (pb *PaymentBalance) Unwrap() *PaymentBalance {
	...
	if !ok {
		panic("generated: PaymentBalance is not a transactional entity")
	}
