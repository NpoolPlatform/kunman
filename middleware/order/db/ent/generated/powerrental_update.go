...
func (pru *PowerRentalUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := pru.mutation.OrderID(); ok {
		_spec.SetField(powerrental.FieldOrderID, field.TypeUUID, value)
	}
	if pru.mutation.OrderIDCleared() {
		_spec.ClearField(powerrental.FieldOrderID, field.TypeUUID)
	}
	if value, ok := pru.mutation.AppGoodStockID(); ok {
		_spec.SetField(powerrental.FieldAppGoodStockID, field.TypeUUID, value)
	}
	if pru.mutation.AppGoodStockIDCleared() {
		_spec.ClearField(powerrental.FieldAppGoodStockID, field.TypeUUID)
	}
	if value, ok := pru.mutation.Units(); ok {
		_spec.SetField(powerrental.FieldUnits, field.TypeOther, value)
	}
	if pru.mutation.UnitsCleared() {
		_spec.ClearField(powerrental.FieldUnits, field.TypeOther)
	}
	if value, ok := pru.mutation.GoodValueUsd(); ok {
		_spec.SetField(powerrental.FieldGoodValueUsd, field.TypeOther, value)
	}
	if pru.mutation.GoodValueUsdCleared() {
		_spec.ClearField(powerrental.FieldGoodValueUsd, field.TypeOther)
	}
	if value, ok := pru.mutation.PaymentAmountUsd(); ok {
		_spec.SetField(powerrental.FieldPaymentAmountUsd, field.TypeOther, value)
	}
	if pru.mutation.PaymentAmountUsdCleared() {
		_spec.ClearField(powerrental.FieldPaymentAmountUsd, field.TypeOther)
	}
	if value, ok := pru.mutation.DiscountAmountUsd(); ok {
		_spec.SetField(powerrental.FieldDiscountAmountUsd, field.TypeOther, value)
	}
	if pru.mutation.DiscountAmountUsdCleared() {
		_spec.ClearField(powerrental.FieldDiscountAmountUsd, field.TypeOther)
	}
	if value, ok := pru.mutation.PromotionID(); ok {
		_spec.SetField(powerrental.FieldPromotionID, field.TypeUUID, value)
	}
	if pru.mutation.PromotionIDCleared() {
		_spec.ClearField(powerrental.FieldPromotionID, field.TypeUUID)
	}
	if value, ok := pru.mutation.InvestmentType(); ok {
		_spec.SetField(powerrental.FieldInvestmentType, field.TypeString, value)
	}
	if pru.mutation.InvestmentTypeCleared() {
		_spec.ClearField(powerrental.FieldInvestmentType, field.TypeString)
	}
	if value, ok := pru.mutation.GoodStockMode(); ok {
		_spec.SetField(powerrental.FieldGoodStockMode, field.TypeString, value)
	}
	if pru.mutation.GoodStockModeCleared() {
		_spec.ClearField(powerrental.FieldGoodStockMode, field.TypeString)
	}
	if value, ok := pru.mutation.DurationSeconds(); ok {
		_spec.SetField(powerrental.FieldDurationSeconds, field.TypeUint32, value)
	}
	if value, ok := pru.mutation.AddedDurationSeconds(); ok {
		_spec.AddField(powerrental.FieldDurationSeconds, field.TypeUint32, value)
	}
	if pru.mutation.DurationSecondsCleared() {
		_spec.ClearField(powerrental.FieldDurationSeconds, field.TypeUint32)
	}
