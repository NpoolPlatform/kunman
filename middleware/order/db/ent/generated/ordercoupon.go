...
// Value returns the ent.Value that was dynamically selected and assigned to the OrderCoupon.
// This includes values selected through modifiers, order, etc.
func (oc *OrderCoupon) Value(name string) (ent.Value, error) {
...
func (oc *OrderCoupon) Update() *OrderCouponUpdateOne {
	return NewOrderCouponClient(oc.config).UpdateOne(oc)
}
...
func (oc *OrderCoupon) Unwrap() *OrderCoupon {
	...
	if !ok {
		panic("generated: OrderCoupon is not a transactional entity")
	}
