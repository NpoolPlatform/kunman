...
func (pq *PaymentQuery) IDs(ctx context.Context) (ids []uint32, err error) {
...
func (pq *PaymentQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(payment.Table, payment.Columns, sqlgraph.NewFieldSpec(payment.FieldID, field.TypeUint32))
	_spec.From = pq.sql
