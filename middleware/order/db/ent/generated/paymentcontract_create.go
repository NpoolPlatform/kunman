...
func (pcc *PaymentContractCreate) defaults() {
...
func (pcc *PaymentContractCreate) check() error {
	if _, ok := pcc.mutation.EntID(); !ok {
		return &ValidationError{Name: "ent_id", err: errors.New(`generated: missing required field "PaymentContract.ent_id"`)}
	}
	if _, ok := pcc.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`generated: missing required field "PaymentContract.created_at"`)}
	}
	if _, ok := pcc.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`generated: missing required field "PaymentContract.updated_at"`)}
	}
	if _, ok := pcc.mutation.DeletedAt(); !ok {
		return &ValidationError{Name: "deleted_at", err: errors.New(`generated: missing required field "PaymentContract.deleted_at"`)}
	}
	return nil
}
...
func (pcc *PaymentContractCreate) createSpec() (*PaymentContract, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(paymentcontract.Table, sqlgraph.NewFieldSpec(paymentcontract.FieldID, field.TypeUint32))
	)
...
func (u *PaymentContractUpsertOne) Exec(ctx context.Context) error {
	if len(u.create.conflict) == 0 {
		return errors.New("generated: missing options for PaymentContractCreate.OnConflict")
	}
...
func (u *PaymentContractUpsertBulk) Exec(ctx context.Context) error {
	...
	for i, b := range u.create.builders {
		if len(b.conflict) != 0 {
			return fmt.Errorf("generated: OnConflict was set for builder %d. Set it on the PaymentContractCreateBulk instead", i)
		}
	}
	if len(u.create.conflict) == 0 {
		return errors.New("generated: missing options for PaymentContractCreateBulk.OnConflict")
	}
	return u.create.Exec(ctx)
}
