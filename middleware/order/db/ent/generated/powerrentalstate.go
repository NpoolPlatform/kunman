...
func (*PowerRentalState) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case powerrentalstate.FieldID, powerrentalstate.FieldCanceledAt, powerrentalstate.FieldPaidAt, powerrentalstate.FieldOutofgasSeconds, powerrentalstate.FieldCompensateSeconds, powerrentalstate.FieldRenewNotifyAt:
...
func (prs *PowerRentalState) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		default:
			prs.selectValues.Set(columns[i], values[i])
		}
	}
	return nil
}

// Value returns the ent.Value that was dynamically selected and assigned to the PowerRentalState.
// This includes values selected through modifiers, order, etc.
func (prs *PowerRentalState) Value(name string) (ent.Value, error) {
	return prs.selectValues.Get(name)
}
...
func (prs *PowerRentalState) Update() *PowerRentalStateUpdateOne {
	return NewPowerRentalStateClient(prs.config).UpdateOne(prs)
}
...
func (prs *PowerRentalState) Unwrap() *PowerRentalState {
	...
	if !ok {
		panic("generated: PowerRentalState is not a transactional entity")
	}
