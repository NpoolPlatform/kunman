...
func (*PaymentTransfer) scanValues(columns []string) ([]any, error) {
...
func (pt *PaymentTransfer) assignValues(columns []string, values []any) error {
...
// Value returns the ent.Value that was dynamically selected and assigned to the PaymentTransfer.
// This includes values selected through modifiers, order, etc.
func (pt *PaymentTransfer) Value(name string) (ent.Value, error) {
...
func (pt *PaymentTransfer) Update() *PaymentTransferUpdateOne {
	return NewPaymentTransferClient(pt.config).UpdateOne(pt)
}
...
func (pt *PaymentTransfer) Unwrap() *PaymentTransfer {
	...
	if !ok {
		panic("generated: PaymentTransfer is not a transactional entity")
	}
