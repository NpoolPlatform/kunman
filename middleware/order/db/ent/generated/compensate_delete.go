...
func (cd *CompensateDelete) sqlExec(ctx context.Context) (int, error) {
	_spec := sqlgraph.NewDeleteSpec(compensate.Table, sqlgraph.NewFieldSpec(compensate.FieldID, field.TypeUint32))
...
// Where appends a list predicates to the CompensateDelete builder.
func (cdo *CompensateDeleteOne) Where(ps ...predicate.Compensate) *CompensateDeleteOne {
