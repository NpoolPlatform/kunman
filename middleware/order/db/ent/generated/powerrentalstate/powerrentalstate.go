...
// OrderOption defines the ordering options for the PowerRentalState queries.
...
// ByOutofgasSeconds orders the results by the outofgas_seconds field.
func ByOutofgasSeconds(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldOutofgasSeconds, opts...).ToFunc()
}
