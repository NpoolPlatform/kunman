...
func (oc *OrderCreate) check() error {
	if _, ok := oc.mutation.EntID(); !ok {
		return &ValidationError{Name: "ent_id", err: errors.New(`generated: missing required field "Order.ent_id"`)}
	}
	if _, ok := oc.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`generated: missing required field "Order.created_at"`)}
	}
	if _, ok := oc.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`generated: missing required field "Order.updated_at"`)}
	}
	if _, ok := oc.mutation.DeletedAt(); !ok {
		return &ValidationError{Name: "deleted_at", err: errors.New(`generated: missing required field "Order.deleted_at"`)}
	}
	if _, ok := oc.mutation.AppID(); !ok {
		return &ValidationError{Name: "app_id", err: errors.New(`generated: missing required field "Order.app_id"`)}
	}
	if _, ok := oc.mutation.UserID(); !ok {
		return &ValidationError{Name: "user_id", err: errors.New(`generated: missing required field "Order.user_id"`)}
	}
	if _, ok := oc.mutation.GoodID(); !ok {
		return &ValidationError{Name: "good_id", err: errors.New(`generated: missing required field "Order.good_id"`)}
	}
	if _, ok := oc.mutation.AppGoodID(); !ok {
		return &ValidationError{Name: "app_good_id", err: errors.New(`generated: missing required field "Order.app_good_id"`)}
	}
	if _, ok := oc.mutation.CoinTypeID(); !ok {
		return &ValidationError{Name: "coin_type_id", err: errors.New(`generated: missing required field "Order.coin_type_id"`)}
	}
	return nil
}
...
func (u *OrderUpsertOne) Exec(ctx context.Context) error {
	if len(u.create.conflict) == 0 {
		return errors.New("generated: missing options for OrderCreate.OnConflict")
	}
...
func (u *OrderUpsertBulk) Exec(ctx context.Context) error {
	...
	for i, b := range u.create.builders {
		if len(b.conflict) != 0 {
			return fmt.Errorf("generated: OnConflict was set for builder %d. Set it on the OrderCreateBulk instead", i)
		}
	}
	if len(u.create.conflict) == 0 {
		return errors.New("generated: missing options for OrderCreateBulk.OnConflict")
	}
	return u.create.Exec(ctx)
}
