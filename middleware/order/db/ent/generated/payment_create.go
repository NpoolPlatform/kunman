...
func (pc *PaymentCreate) check() error {
	...
	if _, ok := pc.mutation.AppID(); !ok {
		return &ValidationError{Name: "app_id", err: errors.New(`generated: missing required field "Payment.app_id"`)}
	}
	if _, ok := pc.mutation.UserID(); !ok {
		return &ValidationError{Name: "user_id", err: errors.New(`generated: missing required field "Payment.user_id"`)}
	}
	if _, ok := pc.mutation.GoodID(); !ok {
		return &ValidationError{Name: "good_id", err: errors.New(`generated: missing required field "Payment.good_id"`)}
	}
	if _, ok := pc.mutation.OrderID(); !ok {
		return &ValidationError{Name: "order_id", err: errors.New(`generated: missing required field "Payment.order_id"`)}
	}
	if _, ok := pc.mutation.AccountID(); !ok {
		return &ValidationError{Name: "account_id", err: errors.New(`generated: missing required field "Payment.account_id"`)}
	}
	return nil
}
