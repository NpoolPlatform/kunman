...
func (prsc *PowerRentalStateCreate) Save(ctx context.Context) (*PowerRentalState, error) {
	prsc.defaults()
	return withHooks(ctx, prsc.sqlSave, prsc.mutation, prsc.hooks)
}
...
func (prsc *PowerRentalStateCreate) defaults() {
...
func (prsc *PowerRentalStateCreate) check() error {
	if _, ok := prsc.mutation.EntID(); !ok {
		return &ValidationError{Name: "ent_id", err: errors.New(`generated: missing required field "PowerRentalState.ent_id"`)}
	}
	if _, ok := prsc.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`generated: missing required field "PowerRentalState.created_at"`)}
	}
	if _, ok := prsc.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`generated: missing required field "PowerRentalState.updated_at"`)}
	}
	if _, ok := prsc.mutation.DeletedAt(); !ok {
		return &ValidationError{Name: "deleted_at", err: errors.New(`generated: missing required field "PowerRentalState.deleted_at"`)}
	}
	return nil
}
...
func (prsc *PowerRentalStateCreate) sqlSave(ctx context.Context) (*PowerRentalState, error) {
	...
	prsc.mutation.id = &_node.ID
	prsc.mutation.done = true
	return _node, nil
}
...
func (prsc *PowerRentalStateCreate) createSpec() (*PowerRentalState, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(powerrentalstate.Table, sqlgraph.NewFieldSpec(powerrentalstate.FieldID, field.TypeUint32))
	)
	...
	if value, ok := prsc.mutation.CreatedAt(); ok {
		_spec.SetField(powerrentalstate.FieldCreatedAt, field.TypeUint32, value)
		_node.CreatedAt = value
	}
	if value, ok := prsc.mutation.UpdatedAt(); ok {
		_spec.SetField(powerrentalstate.FieldUpdatedAt, field.TypeUint32, value)
		_node.UpdatedAt = value
	}
	if value, ok := prsc.mutation.DeletedAt(); ok {
		_spec.SetField(powerrentalstate.FieldDeletedAt, field.TypeUint32, value)
...
func (u *PowerRentalStateUpsertOne) Exec(ctx context.Context) error {
	if len(u.create.conflict) == 0 {
		return errors.New("generated: missing options for PowerRentalStateCreate.OnConflict")
	}
...
func (u *PowerRentalStateUpsertBulk) Exec(ctx context.Context) error {
	...
	for i, b := range u.create.builders {
		if len(b.conflict) != 0 {
			return fmt.Errorf("generated: OnConflict was set for builder %d. Set it on the PowerRentalStateCreateBulk instead", i)
		}
	}
	if len(u.create.conflict) == 0 {
		return errors.New("generated: missing options for PowerRentalStateCreateBulk.OnConflict")
	}
	return u.create.Exec(ctx)
}
