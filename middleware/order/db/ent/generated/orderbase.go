...
func (*OrderBase) scanValues(columns []string) ([]any, error) {
...
func (ob *OrderBase) assignValues(columns []string, values []any) error {
...
// Value returns the ent.Value that was dynamically selected and assigned to the OrderBase.
// This includes values selected through modifiers, order, etc.
func (ob *OrderBase) Value(name string) (ent.Value, error) {
...
func (ob *OrderBase) Update() *OrderBaseUpdateOne {
	return NewOrderBaseClient(ob.config).UpdateOne(ob)
}
...
func (ob *OrderBase) Unwrap() *OrderBase {
	...
	if !ok {
		panic("generated: OrderBase is not a transactional entity")
	}
