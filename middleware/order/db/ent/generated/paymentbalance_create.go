...
func (pbc *PaymentBalanceCreate) defaults() {
...
func (pbc *PaymentBalanceCreate) createSpec() (*PaymentBalance, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(paymentbalance.Table, sqlgraph.NewFieldSpec(paymentbalance.FieldID, field.TypeUint32))
	)
...
func (u *PaymentBalanceUpsertOne) Exec(ctx context.Context) error {
	if len(u.create.conflict) == 0 {
		return errors.New("generated: missing options for PaymentBalanceCreate.OnConflict")
	}
...
func (u *PaymentBalanceUpsertBulk) Exec(ctx context.Context) error {
	...
	for i, b := range u.create.builders {
		if len(b.conflict) != 0 {
			return fmt.Errorf("generated: OnConflict was set for builder %d. Set it on the PaymentBalanceCreateBulk instead", i)
		}
	}
	if len(u.create.conflict) == 0 {
		return errors.New("generated: missing options for PaymentBalanceCreateBulk.OnConflict")
	}
	return u.create.Exec(ctx)
}
