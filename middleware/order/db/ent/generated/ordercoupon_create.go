...
func (occ *OrderCouponCreate) defaults() {
...
func (occ *OrderCouponCreate) createSpec() (*OrderCoupon, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(ordercoupon.Table, sqlgraph.NewFieldSpec(ordercoupon.FieldID, field.TypeUint32))
	)
...
func (u *OrderCouponUpsertOne) Exec(ctx context.Context) error {
	if len(u.create.conflict) == 0 {
		return errors.New("generated: missing options for OrderCouponCreate.OnConflict")
	}
...
func (u *OrderCouponUpsertBulk) Exec(ctx context.Context) error {
	...
	for i, b := range u.create.builders {
		if len(b.conflict) != 0 {
			return fmt.Errorf("generated: OnConflict was set for builder %d. Set it on the OrderCouponCreateBulk instead", i)
		}
	}
	if len(u.create.conflict) == 0 {
		return errors.New("generated: missing options for OrderCouponCreateBulk.OnConflict")
	}
	return u.create.Exec(ctx)
}
