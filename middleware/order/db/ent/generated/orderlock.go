...
func (*OrderLock) scanValues(columns []string) ([]any, error) {
...
func (ol *OrderLock) assignValues(columns []string, values []any) error {
...
// Value returns the ent.Value that was dynamically selected and assigned to the OrderLock.
// This includes values selected through modifiers, order, etc.
func (ol *OrderLock) Value(name string) (ent.Value, error) {
...
func (ol *OrderLock) Update() *OrderLockUpdateOne {
	return NewOrderLockClient(ol.config).UpdateOne(ol)
}
...
func (ol *OrderLock) Unwrap() *OrderLock {
	...
	if !ok {
		panic("generated: OrderLock is not a transactional entity")
	}
