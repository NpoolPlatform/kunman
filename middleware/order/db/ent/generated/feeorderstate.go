...
func (*FeeOrderState) scanValues(columns []string) ([]any, error) {
...
func (fos *FeeOrderState) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		default:
			fos.selectValues.Set(columns[i], values[i])
		}
	}
	return nil
}

// Value returns the ent.Value that was dynamically selected and assigned to the FeeOrderState.
// This includes values selected through modifiers, order, etc.
func (fos *FeeOrderState) Value(name string) (ent.Value, error) {
	return fos.selectValues.Get(name)
}
...
func (fos *FeeOrderState) Update() *FeeOrderStateUpdateOne {
	return NewFeeOrderStateClient(fos.config).UpdateOne(fos)
}
...
func (fos *FeeOrderState) Unwrap() *FeeOrderState {
	...
	if !ok {
		panic("generated: FeeOrderState is not a transactional entity")
	}
