...
func (*OrderState) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case orderstate.FieldID, orderstate.FieldStartAt, orderstate.FieldEndAt, orderstate.FieldPaidAt, orderstate.FieldLastBenefitAt, orderstate.FieldOutofgasHours, orderstate.FieldCompensateHours, orderstate.FieldRenewNotifyAt:
...
func (os *OrderState) assignValues(columns []string, values []any) error {
...
// Value returns the ent.Value that was dynamically selected and assigned to the OrderState.
// This includes values selected through modifiers, order, etc.
func (os *OrderState) Value(name string) (ent.Value, error) {
...
func (os *OrderState) Update() *OrderStateUpdateOne {
	return NewOrderStateClient(os.config).UpdateOne(os)
}
...
func (os *OrderState) Unwrap() *OrderState {
	...
	if !ok {
		panic("generated: OrderState is not a transactional entity")
	}
