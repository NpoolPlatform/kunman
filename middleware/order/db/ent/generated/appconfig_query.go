...
func (acq *AppConfigQuery) IDs(ctx context.Context) (ids []uint32, err error) {
...
func (acq *AppConfigQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(appconfig.Table, appconfig.Columns, sqlgraph.NewFieldSpec(appconfig.FieldID, field.TypeUint32))
	_spec.From = acq.sql
