...
func (pouu *PoolOrderUserUpdate) SetNillableOrderID(u *uuid.UUID) *PoolOrderUserUpdate {
	if u != nil {
		pouu.SetOrderID(*u)
	}
	return pouu
...
// SetNillablePoolOrderUserID sets the "pool_order_user_id" field if the given value is not nil.
func (pouu *PoolOrderUserUpdate) SetNillablePoolOrderUserID(u *uuid.UUID) *PoolOrderUserUpdate {
	if u != nil {
		pouu.SetPoolOrderUserID(*u)
	}
	return pouu
}
...
func (pouu *PoolOrderUserUpdate) sqlSave(ctx context.Context) (n int, err error) {
	_spec := sqlgraph.NewUpdateSpec(poolorderuser.Table, poolorderuser.Columns, sqlgraph.NewFieldSpec(poolorderuser.FieldID, field.TypeUint32))
	...
	_spec.AddModifiers(pouu.modifiers...)
...
// SetNillableOrderID sets the "order_id" field if the given value is not nil.
func (pouuo *PoolOrderUserUpdateOne) SetNillableOrderID(u *uuid.UUID) *PoolOrderUserUpdateOne {
	if u != nil {
		pouuo.SetOrderID(*u)
	}
	return pouuo
...
// SetNillablePoolOrderUserID sets the "pool_order_user_id" field if the given value is not nil.
func (pouuo *PoolOrderUserUpdateOne) SetNillablePoolOrderUserID(u *uuid.UUID) *PoolOrderUserUpdateOne {
	if u != nil {
		pouuo.SetPoolOrderUserID(*u)
	}
	return pouuo
}
...
// Where appends a list predicates to the PoolOrderUserUpdate builder.
func (pouuo *PoolOrderUserUpdateOne) Where(ps ...predicate.PoolOrderUser) *PoolOrderUserUpdateOne {
	pouuo.mutation.Where(ps...)
	return pouuo
}
...
func (pouuo *PoolOrderUserUpdateOne) sqlSave(ctx context.Context) (_node *PoolOrderUser, err error) {
	...
	if !ok {
		return nil, &ValidationError{Name: "id", err: errors.New(`generated: missing "PoolOrderUser.id" for update`)}
	}
	...
	_spec.AddModifiers(pouuo.modifiers...)
