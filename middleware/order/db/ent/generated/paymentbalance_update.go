...
func (pbu *PaymentBalanceUpdate) sqlSave(ctx context.Context) (n int, err error) {
	_spec := sqlgraph.NewUpdateSpec(paymentbalance.Table, paymentbalance.Columns, sqlgraph.NewFieldSpec(paymentbalance.FieldID, field.TypeUint32))
	...
	if pbu.mutation.PaymentIDCleared() {
		_spec.ClearField(paymentbalance.FieldPaymentID, field.TypeUUID)
	}
	if value, ok := pbu.mutation.CoinTypeID(); ok {
		_spec.SetField(paymentbalance.FieldCoinTypeID, field.TypeUUID, value)
	}
	if pbu.mutation.CoinTypeIDCleared() {
		_spec.ClearField(paymentbalance.FieldCoinTypeID, field.TypeUUID)
	}
	if value, ok := pbu.mutation.Amount(); ok {
		_spec.SetField(paymentbalance.FieldAmount, field.TypeOther, value)
	}
	if pbu.mutation.AmountCleared() {
		_spec.ClearField(paymentbalance.FieldAmount, field.TypeOther)
	}
	if value, ok := pbu.mutation.CoinUsdCurrency(); ok {
		_spec.SetField(paymentbalance.FieldCoinUsdCurrency, field.TypeOther, value)
	}
	if pbu.mutation.CoinUsdCurrencyCleared() {
		_spec.ClearField(paymentbalance.FieldCoinUsdCurrency, field.TypeOther)
	}
	if value, ok := pbu.mutation.LocalCoinUsdCurrency(); ok {
		_spec.SetField(paymentbalance.FieldLocalCoinUsdCurrency, field.TypeOther, value)
	}
	if pbu.mutation.LocalCoinUsdCurrencyCleared() {
		_spec.ClearField(paymentbalance.FieldLocalCoinUsdCurrency, field.TypeOther)
	}
	if value, ok := pbu.mutation.LiveCoinUsdCurrency(); ok {
		_spec.SetField(paymentbalance.FieldLiveCoinUsdCurrency, field.TypeOther, value)
	}
	if pbu.mutation.LiveCoinUsdCurrencyCleared() {
		_spec.ClearField(paymentbalance.FieldLiveCoinUsdCurrency, field.TypeOther)
	}
...
// Where appends a list predicates to the PaymentBalanceUpdate builder.
func (pbuo *PaymentBalanceUpdateOne) Where(ps ...predicate.PaymentBalance) *PaymentBalanceUpdateOne {
...
func (pbuo *PaymentBalanceUpdateOne) sqlSave(ctx context.Context) (_node *PaymentBalance, err error) {
	...
	if !ok {
		return nil, &ValidationError{Name: "id", err: errors.New(`generated: missing "PaymentBalance.id" for update`)}
	}
