...
func (aucc *AppUserControlCreate) Save(ctx context.Context) (*AppUserControl, error) {
	aucc.defaults()
	return withHooks(ctx, aucc.sqlSave, aucc.mutation, aucc.hooks)
}
...
func (aucc *AppUserControlCreate) check() error {
	if _, ok := aucc.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`generated: missing required field "AppUserControl.created_at"`)}
	}
	if _, ok := aucc.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`generated: missing required field "AppUserControl.updated_at"`)}
	}
	if _, ok := aucc.mutation.DeletedAt(); !ok {
		return &ValidationError{Name: "deleted_at", err: errors.New(`generated: missing required field "AppUserControl.deleted_at"`)}
	}
	if _, ok := aucc.mutation.EntID(); !ok {
		return &ValidationError{Name: "ent_id", err: errors.New(`generated: missing required field "AppUserControl.ent_id"`)}
	}
	if _, ok := aucc.mutation.Kol(); !ok {
		return &ValidationError{Name: "kol", err: errors.New(`generated: missing required field "AppUserControl.kol"`)}
	}
	if _, ok := aucc.mutation.KolConfirmed(); !ok {
		return &ValidationError{Name: "kol_confirmed", err: errors.New(`generated: missing required field "AppUserControl.kol_confirmed"`)}
	}
	return nil
}
...
func (aucc *AppUserControlCreate) sqlSave(ctx context.Context) (*AppUserControl, error) {
	...
	aucc.mutation.id = &_node.ID
	aucc.mutation.done = true
	return _node, nil
}
...
func (aucc *AppUserControlCreate) createSpec() (*AppUserControl, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(appusercontrol.Table, sqlgraph.NewFieldSpec(appusercontrol.FieldID, field.TypeUint32))
	)
...
func (u *AppUserControlUpsertOne) Exec(ctx context.Context) error {
	if len(u.create.conflict) == 0 {
		return errors.New("generated: missing options for AppUserControlCreate.OnConflict")
	}
...
func (u *AppUserControlUpsertBulk) Exec(ctx context.Context) error {
	...
	for i, b := range u.create.builders {
		if len(b.conflict) != 0 {
			return fmt.Errorf("generated: OnConflict was set for builder %d. Set it on the AppUserControlCreateBulk instead", i)
		}
	}
	if len(u.create.conflict) == 0 {
		return errors.New("generated: missing options for AppUserControlCreateBulk.OnConflict")
	}
	return u.create.Exec(ctx)
}
