...
func (kq *KycQuery) Order(o ...kyc.OrderOption) *KycQuery {
...
func (kq *KycQuery) All(ctx context.Context) ([]*Kyc, error) {
	...
	return withInterceptors[[]*Kyc](ctx, kq, qr, kq.inters)
}
...
func (kq *KycQuery) IDs(ctx context.Context) (ids []uint32, err error) {
...
func (kq *KycQuery) Count(ctx context.Context) (int, error) {
	...
	return withInterceptors[int](ctx, kq, querierCount[*KycQuery](), kq.inters)
}
...
func (kq *KycQuery) Clone() *KycQuery {
	...
	return &KycQuery{
		config:     kq.config,
		ctx:        kq.ctx.Clone(),
		order:      append([]kyc.OrderOption{}, kq.order...),
...
func (kq *KycQuery) Aggregate(fns ...AggregateFunc) *KycSelect {
...
func (kq *KycQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(kyc.Table, kyc.Columns, sqlgraph.NewFieldSpec(kyc.FieldID, field.TypeUint32))
	_spec.From = kq.sql
...
func (kgb *KycGroupBy) Scan(ctx context.Context, v any) error {
	ctx = setContextOp(ctx, kgb.build.ctx, ent.OpQueryGroupBy)
	if err := kgb.build.prepareQuery(ctx); err != nil {
		return err
	}
	return scanWithInterceptors[*KycQuery, *KycGroupBy](ctx, kgb.build, kgb, kgb.build.inters, v)
}

func (kgb *KycGroupBy) sqlScan(ctx context.Context, root *KycQuery, v any) error {
...
func (ks *KycSelect) Aggregate(fns ...AggregateFunc) *KycSelect {
	ks.fns = append(ks.fns, fns...)
	return ks
}

// Scan applies the selector query and scans the result into the given value.
func (ks *KycSelect) Scan(ctx context.Context, v any) error {
	ctx = setContextOp(ctx, ks.ctx, ent.OpQuerySelect)
	if err := ks.prepareQuery(ctx); err != nil {
		return err
	}
	return scanWithInterceptors[*KycQuery, *KycSelect](ctx, ks.KycQuery, ks, ks.inters, v)
}

func (ks *KycSelect) sqlScan(ctx context.Context, root *KycQuery, v any) error {
