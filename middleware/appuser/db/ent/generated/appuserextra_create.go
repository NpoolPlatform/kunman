...
func (auec *AppUserExtraCreate) Save(ctx context.Context) (*AppUserExtra, error) {
	auec.defaults()
	return withHooks(ctx, auec.sqlSave, auec.mutation, auec.hooks)
}
...
func (auec *AppUserExtraCreate) check() error {
	if _, ok := auec.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`generated: missing required field "AppUserExtra.created_at"`)}
	}
	if _, ok := auec.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`generated: missing required field "AppUserExtra.updated_at"`)}
	}
	if _, ok := auec.mutation.DeletedAt(); !ok {
		return &ValidationError{Name: "deleted_at", err: errors.New(`generated: missing required field "AppUserExtra.deleted_at"`)}
	}
	if _, ok := auec.mutation.EntID(); !ok {
		return &ValidationError{Name: "ent_id", err: errors.New(`generated: missing required field "AppUserExtra.ent_id"`)}
	}
	if _, ok := auec.mutation.AppID(); !ok {
		return &ValidationError{Name: "app_id", err: errors.New(`generated: missing required field "AppUserExtra.app_id"`)}
	}
	if _, ok := auec.mutation.UserID(); !ok {
		return &ValidationError{Name: "user_id", err: errors.New(`generated: missing required field "AppUserExtra.user_id"`)}
	}
	if _, ok := auec.mutation.Username(); !ok {
		return &ValidationError{Name: "username", err: errors.New(`generated: missing required field "AppUserExtra.username"`)}
	}
	if _, ok := auec.mutation.FirstName(); !ok {
		return &ValidationError{Name: "first_name", err: errors.New(`generated: missing required field "AppUserExtra.first_name"`)}
	}
	if _, ok := auec.mutation.LastName(); !ok {
		return &ValidationError{Name: "last_name", err: errors.New(`generated: missing required field "AppUserExtra.last_name"`)}
	}
	if _, ok := auec.mutation.AddressFields(); !ok {
		return &ValidationError{Name: "address_fields", err: errors.New(`generated: missing required field "AppUserExtra.address_fields"`)}
	}
	if _, ok := auec.mutation.Gender(); !ok {
		return &ValidationError{Name: "gender", err: errors.New(`generated: missing required field "AppUserExtra.gender"`)}
	}
	if _, ok := auec.mutation.PostalCode(); !ok {
		return &ValidationError{Name: "postal_code", err: errors.New(`generated: missing required field "AppUserExtra.postal_code"`)}
	}
	if _, ok := auec.mutation.Age(); !ok {
		return &ValidationError{Name: "age", err: errors.New(`generated: missing required field "AppUserExtra.age"`)}
	}
	if _, ok := auec.mutation.Birthday(); !ok {
		return &ValidationError{Name: "birthday", err: errors.New(`generated: missing required field "AppUserExtra.birthday"`)}
	}
	if _, ok := auec.mutation.Avatar(); !ok {
		return &ValidationError{Name: "avatar", err: errors.New(`generated: missing required field "AppUserExtra.avatar"`)}
	}
	if _, ok := auec.mutation.Organization(); !ok {
		return &ValidationError{Name: "organization", err: errors.New(`generated: missing required field "AppUserExtra.organization"`)}
	}
	if _, ok := auec.mutation.IDNumber(); !ok {
		return &ValidationError{Name: "id_number", err: errors.New(`generated: missing required field "AppUserExtra.id_number"`)}
	}
	return nil
}
...
func (auec *AppUserExtraCreate) sqlSave(ctx context.Context) (*AppUserExtra, error) {
	...
	auec.mutation.id = &_node.ID
	auec.mutation.done = true
	return _node, nil
}
...
func (auec *AppUserExtraCreate) createSpec() (*AppUserExtra, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(appuserextra.Table, sqlgraph.NewFieldSpec(appuserextra.FieldID, field.TypeUint32))
	)
	...
	if value, ok := auec.mutation.CreatedAt(); ok {
		_spec.SetField(appuserextra.FieldCreatedAt, field.TypeUint32, value)
		_node.CreatedAt = value
	}
	if value, ok := auec.mutation.UpdatedAt(); ok {
		_spec.SetField(appuserextra.FieldUpdatedAt, field.TypeUint32, value)
		_node.UpdatedAt = value
	}
	if value, ok := auec.mutation.DeletedAt(); ok {
		_spec.SetField(appuserextra.FieldDeletedAt, field.TypeUint32, value)
		_node.DeletedAt = value
	}
	if value, ok := auec.mutation.EntID(); ok {
		_spec.SetField(appuserextra.FieldEntID, field.TypeUUID, value)
		_node.EntID = value
	}
	if value, ok := auec.mutation.AppID(); ok {
		_spec.SetField(appuserextra.FieldAppID, field.TypeUUID, value)
		_node.AppID = value
	}
	if value, ok := auec.mutation.UserID(); ok {
		_spec.SetField(appuserextra.FieldUserID, field.TypeUUID, value)
		_node.UserID = value
	}
	if value, ok := auec.mutation.Username(); ok {
		_spec.SetField(appuserextra.FieldUsername, field.TypeString, value)
		_node.Username = value
	}
	if value, ok := auec.mutation.FirstName(); ok {
		_spec.SetField(appuserextra.FieldFirstName, field.TypeString, value)
		_node.FirstName = value
	}
	if value, ok := auec.mutation.LastName(); ok {
		_spec.SetField(appuserextra.FieldLastName, field.TypeString, value)
		_node.LastName = value
	}
	if value, ok := auec.mutation.AddressFields(); ok {
		_spec.SetField(appuserextra.FieldAddressFields, field.TypeJSON, value)
		_node.AddressFields = value
	}
	if value, ok := auec.mutation.Gender(); ok {
		_spec.SetField(appuserextra.FieldGender, field.TypeString, value)
		_node.Gender = value
	}
	if value, ok := auec.mutation.PostalCode(); ok {
		_spec.SetField(appuserextra.FieldPostalCode, field.TypeString, value)
		_node.PostalCode = value
	}
	if value, ok := auec.mutation.Age(); ok {
		_spec.SetField(appuserextra.FieldAge, field.TypeUint32, value)
		_node.Age = value
	}
	if value, ok := auec.mutation.Birthday(); ok {
		_spec.SetField(appuserextra.FieldBirthday, field.TypeUint32, value)
		_node.Birthday = value
	}
	if value, ok := auec.mutation.Avatar(); ok {
		_spec.SetField(appuserextra.FieldAvatar, field.TypeString, value)
		_node.Avatar = value
	}
	if value, ok := auec.mutation.Organization(); ok {
		_spec.SetField(appuserextra.FieldOrganization, field.TypeString, value)
		_node.Organization = value
	}
	if value, ok := auec.mutation.IDNumber(); ok {
		_spec.SetField(appuserextra.FieldIDNumber, field.TypeString, value)
...
func (u *AppUserExtraUpsertOne) Exec(ctx context.Context) error {
	if len(u.create.conflict) == 0 {
		return errors.New("generated: missing options for AppUserExtraCreate.OnConflict")
	}
...
func (u *AppUserExtraUpsertBulk) Exec(ctx context.Context) error {
	...
	for i, b := range u.create.builders {
		if len(b.conflict) != 0 {
			return fmt.Errorf("generated: OnConflict was set for builder %d. Set it on the AppUserExtraCreateBulk instead", i)
		}
	}
	if len(u.create.conflict) == 0 {
		return errors.New("generated: missing options for AppUserExtraCreateBulk.OnConflict")
	}
	return u.create.Exec(ctx)
}
