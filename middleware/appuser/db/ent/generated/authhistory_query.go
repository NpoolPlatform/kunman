...
func (ahq *AuthHistoryQuery) IDs(ctx context.Context) (ids []uint32, err error) {
...
func (ahq *AuthHistoryQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(authhistory.Table, authhistory.Columns, sqlgraph.NewFieldSpec(authhistory.FieldID, field.TypeUint32))
	_spec.From = ahq.sql
