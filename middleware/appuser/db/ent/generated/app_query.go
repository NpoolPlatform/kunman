...
func (aq *AppQuery) IDs(ctx context.Context) (ids []uint32, err error) {
...
func (aq *AppQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(app.Table, app.Columns, sqlgraph.NewFieldSpec(app.FieldID, field.TypeUint32))
	_spec.From = aq.sql
