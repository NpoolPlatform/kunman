...
func (ku *KycUpdate) sqlSave(ctx context.Context) (n int, err error) {
	_spec := sqlgraph.NewUpdateSpec(kyc.Table, kyc.Columns, sqlgraph.NewFieldSpec(kyc.FieldID, field.TypeUint32))
	...
	if value, ok := ku.mutation.CreatedAt(); ok {
		_spec.SetField(kyc.FieldCreatedAt, field.TypeUint32, value)
	}
	if value, ok := ku.mutation.AddedCreatedAt(); ok {
		_spec.AddField(kyc.FieldCreatedAt, field.TypeUint32, value)
	}
	if value, ok := ku.mutation.UpdatedAt(); ok {
		_spec.SetField(kyc.FieldUpdatedAt, field.TypeUint32, value)
	}
	if value, ok := ku.mutation.AddedUpdatedAt(); ok {
		_spec.AddField(kyc.FieldUpdatedAt, field.TypeUint32, value)
	}
	if value, ok := ku.mutation.DeletedAt(); ok {
		_spec.SetField(kyc.FieldDeletedAt, field.TypeUint32, value)
	}
	if value, ok := ku.mutation.AddedDeletedAt(); ok {
		_spec.AddField(kyc.FieldDeletedAt, field.TypeUint32, value)
	}
	if value, ok := ku.mutation.EntID(); ok {
		_spec.SetField(kyc.FieldEntID, field.TypeUUID, value)
	}
	if value, ok := ku.mutation.AppID(); ok {
		_spec.SetField(kyc.FieldAppID, field.TypeUUID, value)
	}
	if ku.mutation.AppIDCleared() {
		_spec.ClearField(kyc.FieldAppID, field.TypeUUID)
	}
	if value, ok := ku.mutation.UserID(); ok {
		_spec.SetField(kyc.FieldUserID, field.TypeUUID, value)
	}
	if ku.mutation.UserIDCleared() {
		_spec.ClearField(kyc.FieldUserID, field.TypeUUID)
	}
	if value, ok := ku.mutation.DocumentType(); ok {
		_spec.SetField(kyc.FieldDocumentType, field.TypeString, value)
	}
	if ku.mutation.DocumentTypeCleared() {
		_spec.ClearField(kyc.FieldDocumentType, field.TypeString)
	}
	if value, ok := ku.mutation.IDNumber(); ok {
		_spec.SetField(kyc.FieldIDNumber, field.TypeString, value)
	}
	if ku.mutation.IDNumberCleared() {
		_spec.ClearField(kyc.FieldIDNumber, field.TypeString)
	}
	if value, ok := ku.mutation.FrontImg(); ok {
		_spec.SetField(kyc.FieldFrontImg, field.TypeString, value)
	}
	if ku.mutation.FrontImgCleared() {
		_spec.ClearField(kyc.FieldFrontImg, field.TypeString)
	}
	if value, ok := ku.mutation.BackImg(); ok {
		_spec.SetField(kyc.FieldBackImg, field.TypeString, value)
	}
	if ku.mutation.BackImgCleared() {
		_spec.ClearField(kyc.FieldBackImg, field.TypeString)
	}
	if value, ok := ku.mutation.SelfieImg(); ok {
		_spec.SetField(kyc.FieldSelfieImg, field.TypeString, value)
	}
	if ku.mutation.SelfieImgCleared() {
		_spec.ClearField(kyc.FieldSelfieImg, field.TypeString)
	}
	if value, ok := ku.mutation.EntityType(); ok {
		_spec.SetField(kyc.FieldEntityType, field.TypeString, value)
	}
	if ku.mutation.EntityTypeCleared() {
		_spec.ClearField(kyc.FieldEntityType, field.TypeString)
	}
	if value, ok := ku.mutation.ReviewID(); ok {
		_spec.SetField(kyc.FieldReviewID, field.TypeUUID, value)
	}
	if ku.mutation.ReviewIDCleared() {
		_spec.ClearField(kyc.FieldReviewID, field.TypeUUID)
	}
	if value, ok := ku.mutation.State(); ok {
		_spec.SetField(kyc.FieldState, field.TypeString, value)
	}
	if ku.mutation.StateCleared() {
		_spec.ClearField(kyc.FieldState, field.TypeString)
	}
...
// Where appends a list predicates to the KycUpdate builder.
func (kuo *KycUpdateOne) Where(ps ...predicate.Kyc) *KycUpdateOne {
...
func (kuo *KycUpdateOne) sqlSave(ctx context.Context) (_node *Kyc, err error) {
	...
	if !ok {
		return nil, &ValidationError{Name: "id", err: errors.New(`generated: missing "Kyc.id" for update`)}
	}
