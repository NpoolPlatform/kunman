...
func (baq *BanAppQuery) Order(o ...banapp.OrderOption) *BanAppQuery {
...
func (baq *BanAppQuery) All(ctx context.Context) ([]*BanApp, error) {
	...
	qr := querierAll[[]*BanApp, *BanAppQuery]()
	return withInterceptors[[]*BanApp](ctx, baq, qr, baq.inters)
}
...
func (baq *BanAppQuery) IDs(ctx context.Context) (ids []uint32, err error) {
...
func (baq *BanAppQuery) Count(ctx context.Context) (int, error) {
	...
	return withInterceptors[int](ctx, baq, querierCount[*BanAppQuery](), baq.inters)
}
...
func (baq *BanAppQuery) Clone() *BanAppQuery {
	...
	return &BanAppQuery{
		config:     baq.config,
		ctx:        baq.ctx.Clone(),
		order:      append([]banapp.OrderOption{}, baq.order...),
...
func (baq *BanAppQuery) GroupBy(field string, fields ...string) *BanAppGroupBy {
	...
	grbuild := &BanAppGroupBy{build: baq}
...
func (baq *BanAppQuery) Select(fields ...string) *BanAppSelect {
	...
	sbuild := &BanAppSelect{BanAppQuery: baq}
	sbuild.label = banapp.Label
	sbuild.flds, sbuild.scan = &baq.ctx.Fields, sbuild.Scan
	return sbuild
}

// Aggregate returns a BanAppSelect configured with the given aggregations.
func (baq *BanAppQuery) Aggregate(fns ...AggregateFunc) *BanAppSelect {
...
func (baq *BanAppQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(banapp.Table, banapp.Columns, sqlgraph.NewFieldSpec(banapp.FieldID, field.TypeUint32))
	_spec.From = baq.sql
...
func (bagb *BanAppGroupBy) Scan(ctx context.Context, v any) error {
	ctx = setContextOp(ctx, bagb.build.ctx, ent.OpQueryGroupBy)
	if err := bagb.build.prepareQuery(ctx); err != nil {
		return err
	}
	return scanWithInterceptors[*BanAppQuery, *BanAppGroupBy](ctx, bagb.build, bagb, bagb.build.inters, v)
}

func (bagb *BanAppGroupBy) sqlScan(ctx context.Context, root *BanAppQuery, v any) error {
...
func (bas *BanAppSelect) Aggregate(fns ...AggregateFunc) *BanAppSelect {
	bas.fns = append(bas.fns, fns...)
	return bas
}

// Scan applies the selector query and scans the result into the given value.
func (bas *BanAppSelect) Scan(ctx context.Context, v any) error {
	ctx = setContextOp(ctx, bas.ctx, ent.OpQuerySelect)
	if err := bas.prepareQuery(ctx); err != nil {
		return err
	}
	return scanWithInterceptors[*BanAppQuery, *BanAppSelect](ctx, bas.BanAppQuery, bas, bas.inters, v)
}

func (bas *BanAppSelect) sqlScan(ctx context.Context, root *BanAppQuery, v any) error {
