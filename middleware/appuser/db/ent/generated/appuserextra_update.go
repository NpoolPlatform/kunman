...
func (aueu *AppUserExtraUpdate) SetNillableAppID(u *uuid.UUID) *AppUserExtraUpdate {
	if u != nil {
		aueu.SetAppID(*u)
	}
	return aueu
...
func (aueu *AppUserExtraUpdate) SetNillableUserID(u *uuid.UUID) *AppUserExtraUpdate {
	if u != nil {
		aueu.SetUserID(*u)
	}
	return aueu
...
// AppendAddressFields appends s to the "address_fields" field.
func (aueu *AppUserExtraUpdate) AppendAddressFields(s []string) *AppUserExtraUpdate {
	aueu.mutation.AppendAddressFields(s)
	return aueu
}
...
func (aueu *AppUserExtraUpdate) Save(ctx context.Context) (int, error) {
	aueu.defaults()
	return withHooks(ctx, aueu.sqlSave, aueu.mutation, aueu.hooks)
}
...
func (aueu *AppUserExtraUpdate) sqlSave(ctx context.Context) (n int, err error) {
	_spec := sqlgraph.NewUpdateSpec(appuserextra.Table, appuserextra.Columns, sqlgraph.NewFieldSpec(appuserextra.FieldID, field.TypeUint32))
	...
	if value, ok := aueu.mutation.AddedCreatedAt(); ok {
		_spec.AddField(appuserextra.FieldCreatedAt, field.TypeUint32, value)
	}
	...
	if value, ok := aueu.mutation.AddedUpdatedAt(); ok {
		_spec.AddField(appuserextra.FieldUpdatedAt, field.TypeUint32, value)
	}
	...
	if value, ok := aueu.mutation.AddedDeletedAt(); ok {
		_spec.AddField(appuserextra.FieldDeletedAt, field.TypeUint32, value)
	}
	...
	if value, ok := aueu.mutation.AppendedAddressFields(); ok {
		_spec.AddModifier(func(u *sql.UpdateBuilder) {
			sqljson.Append(u, appuserextra.FieldAddressFields, value)
		})
	}
	...
	if value, ok := aueu.mutation.AddedAge(); ok {
		_spec.AddField(appuserextra.FieldAge, field.TypeUint32, value)
	}
	...
	if value, ok := aueu.mutation.AddedBirthday(); ok {
		_spec.AddField(appuserextra.FieldBirthday, field.TypeUint32, value)
	}
	...
	_spec.AddModifiers(aueu.modifiers...)
...
// SetNillableAppID sets the "app_id" field if the given value is not nil.
func (aueuo *AppUserExtraUpdateOne) SetNillableAppID(u *uuid.UUID) *AppUserExtraUpdateOne {
	if u != nil {
		aueuo.SetAppID(*u)
	}
	return aueuo
...
// SetNillableUserID sets the "user_id" field if the given value is not nil.
func (aueuo *AppUserExtraUpdateOne) SetNillableUserID(u *uuid.UUID) *AppUserExtraUpdateOne {
	if u != nil {
		aueuo.SetUserID(*u)
	}
	return aueuo
...
// AppendAddressFields appends s to the "address_fields" field.
func (aueuo *AppUserExtraUpdateOne) AppendAddressFields(s []string) *AppUserExtraUpdateOne {
	aueuo.mutation.AppendAddressFields(s)
	return aueuo
}
...
// Where appends a list predicates to the AppUserExtraUpdate builder.
func (aueuo *AppUserExtraUpdateOne) Where(ps ...predicate.AppUserExtra) *AppUserExtraUpdateOne {
	aueuo.mutation.Where(ps...)
	return aueuo
}
...
func (aueuo *AppUserExtraUpdateOne) Save(ctx context.Context) (*AppUserExtra, error) {
	aueuo.defaults()
	return withHooks(ctx, aueuo.sqlSave, aueuo.mutation, aueuo.hooks)
}
...
func (aueuo *AppUserExtraUpdateOne) sqlSave(ctx context.Context) (_node *AppUserExtra, err error) {
	...
	if !ok {
		return nil, &ValidationError{Name: "id", err: errors.New(`generated: missing "AppUserExtra.id" for update`)}
	}
	...
	if value, ok := aueuo.mutation.AppendedAddressFields(); ok {
		_spec.AddModifier(func(u *sql.UpdateBuilder) {
			sqljson.Append(u, appuserextra.FieldAddressFields, value)
		})
	}
	...
	_spec.AddModifiers(aueuo.modifiers...)
