...
func (*AppUserExtra) scanValues(columns []string) ([]any, error) {
...
func (aue *AppUserExtra) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		default:
			aue.selectValues.Set(columns[i], values[i])
		}
	}
	return nil
}

// Value returns the ent.Value that was dynamically selected and assigned to the AppUserExtra.
// This includes values selected through modifiers, order, etc.
func (aue *AppUserExtra) Value(name string) (ent.Value, error) {
	return aue.selectValues.Get(name)
}
...
func (aue *AppUserExtra) Update() *AppUserExtraUpdateOne {
	return NewAppUserExtraClient(aue.config).UpdateOne(aue)
}
...
func (aue *AppUserExtra) Unwrap() *AppUserExtra {
	...
	if !ok {
		panic("generated: AppUserExtra is not a transactional entity")
	}
