...
func (*AppUserSecret) scanValues(columns []string) ([]any, error) {
...
func (aus *AppUserSecret) assignValues(columns []string, values []any) error {
...
// Value returns the ent.Value that was dynamically selected and assigned to the AppUserSecret.
// This includes values selected through modifiers, order, etc.
func (aus *AppUserSecret) Value(name string) (ent.Value, error) {
...
func (aus *AppUserSecret) Update() *AppUserSecretUpdateOne {
	return NewAppUserSecretClient(aus.config).UpdateOne(aus)
}
...
func (aus *AppUserSecret) Unwrap() *AppUserSecret {
	...
	if !ok {
		panic("generated: AppUserSecret is not a transactional entity")
	}
