...
func (sq *SubscriberQuery) IDs(ctx context.Context) (ids []uint32, err error) {
...
func (sq *SubscriberQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(subscriber.Table, subscriber.Columns, sqlgraph.NewFieldSpec(subscriber.FieldID, field.TypeUint32))
	_spec.From = sq.sql
