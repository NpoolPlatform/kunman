...
// to the Kyc fields.
func (k *Kyc) assignValues(columns []string, values []any) error {
...
func (k *Kyc) Value(name string) (ent.Value, error) {
...
func (k *Kyc) Update() *KycUpdateOne {
	return NewKycClient(k.config).UpdateOne(k)
}
...
func (k *Kyc) Unwrap() *Kyc {
	...
	if !ok {
		panic("generated: Kyc is not a transactional entity")
	}
