...
func (bauc *BanAppUserCreate) Save(ctx context.Context) (*BanAppUser, error) {
	bauc.defaults()
	return withHooks(ctx, bauc.sqlSave, bauc.mutation, bauc.hooks)
}
...
func (bauc *BanAppUserCreate) check() error {
	if _, ok := bauc.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`generated: missing required field "BanAppUser.created_at"`)}
	}
	if _, ok := bauc.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`generated: missing required field "BanAppUser.updated_at"`)}
	}
	if _, ok := bauc.mutation.DeletedAt(); !ok {
		return &ValidationError{Name: "deleted_at", err: errors.New(`generated: missing required field "BanAppUser.deleted_at"`)}
	}
	if _, ok := bauc.mutation.EntID(); !ok {
		return &ValidationError{Name: "ent_id", err: errors.New(`generated: missing required field "BanAppUser.ent_id"`)}
	}
	if _, ok := bauc.mutation.AppID(); !ok {
		return &ValidationError{Name: "app_id", err: errors.New(`generated: missing required field "BanAppUser.app_id"`)}
	}
	if _, ok := bauc.mutation.UserID(); !ok {
		return &ValidationError{Name: "user_id", err: errors.New(`generated: missing required field "BanAppUser.user_id"`)}
	}
	if _, ok := bauc.mutation.Message(); !ok {
		return &ValidationError{Name: "message", err: errors.New(`generated: missing required field "BanAppUser.message"`)}
	}
	return nil
}
...
func (bauc *BanAppUserCreate) sqlSave(ctx context.Context) (*BanAppUser, error) {
	...
	bauc.mutation.id = &_node.ID
	bauc.mutation.done = true
	return _node, nil
}
...
func (bauc *BanAppUserCreate) createSpec() (*BanAppUser, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(banappuser.Table, sqlgraph.NewFieldSpec(banappuser.FieldID, field.TypeUint32))
	)
...
func (u *BanAppUserUpsertOne) Exec(ctx context.Context) error {
	if len(u.create.conflict) == 0 {
		return errors.New("generated: missing options for BanAppUserCreate.OnConflict")
	}
...
func (u *BanAppUserUpsertBulk) Exec(ctx context.Context) error {
	...
	for i, b := range u.create.builders {
		if len(b.conflict) != 0 {
			return fmt.Errorf("generated: OnConflict was set for builder %d. Set it on the BanAppUserCreateBulk instead", i)
		}
	}
	if len(u.create.conflict) == 0 {
		return errors.New("generated: missing options for BanAppUserCreateBulk.OnConflict")
	}
	return u.create.Exec(ctx)
}
