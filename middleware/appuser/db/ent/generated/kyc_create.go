...
func (kc *KycCreate) check() error {
	if _, ok := kc.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`generated: missing required field "Kyc.created_at"`)}
	}
	if _, ok := kc.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`generated: missing required field "Kyc.updated_at"`)}
	}
	if _, ok := kc.mutation.DeletedAt(); !ok {
		return &ValidationError{Name: "deleted_at", err: errors.New(`generated: missing required field "Kyc.deleted_at"`)}
	}
	if _, ok := kc.mutation.EntID(); !ok {
		return &ValidationError{Name: "ent_id", err: errors.New(`generated: missing required field "Kyc.ent_id"`)}
	}
	return nil
}
...
func (kc *KycCreate) createSpec() (*Kyc, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(kyc.Table, sqlgraph.NewFieldSpec(kyc.FieldID, field.TypeUint32))
	)
...
func (u *KycUpsertOne) Exec(ctx context.Context) error {
	if len(u.create.conflict) == 0 {
		return errors.New("generated: missing options for KycCreate.OnConflict")
	}
...
func (u *KycUpsertBulk) Exec(ctx context.Context) error {
	...
	for i, b := range u.create.builders {
		if len(b.conflict) != 0 {
			return fmt.Errorf("generated: OnConflict was set for builder %d. Set it on the KycCreateBulk instead", i)
		}
	}
	if len(u.create.conflict) == 0 {
		return errors.New("generated: missing options for KycCreateBulk.OnConflict")
	}
	return u.create.Exec(ctx)
}
