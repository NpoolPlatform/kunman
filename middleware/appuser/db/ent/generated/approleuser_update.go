...
func (aruu *AppRoleUserUpdate) Save(ctx context.Context) (int, error) {
	aruu.defaults()
	return withHooks(ctx, aruu.sqlSave, aruu.mutation, aruu.hooks)
}
...
func (aruu *AppRoleUserUpdate) sqlSave(ctx context.Context) (n int, err error) {
	_spec := sqlgraph.NewUpdateSpec(approleuser.Table, approleuser.Columns, sqlgraph.NewFieldSpec(approleuser.FieldID, field.TypeUint32))
	...
	if value, ok := aruu.mutation.AddedCreatedAt(); ok {
		_spec.AddField(approleuser.FieldCreatedAt, field.TypeUint32, value)
	}
	...
	if value, ok := aruu.mutation.AddedUpdatedAt(); ok {
		_spec.AddField(approleuser.FieldUpdatedAt, field.TypeUint32, value)
	}
	...
	if value, ok := aruu.mutation.AddedDeletedAt(); ok {
		_spec.AddField(approleuser.FieldDeletedAt, field.TypeUint32, value)
	}
	...
	if aruu.mutation.AppIDCleared() {
		_spec.ClearField(approleuser.FieldAppID, field.TypeUUID)
	}
	...
	if aruu.mutation.RoleIDCleared() {
		_spec.ClearField(approleuser.FieldRoleID, field.TypeUUID)
	}
	...
	if aruu.mutation.UserIDCleared() {
		_spec.ClearField(approleuser.FieldUserID, field.TypeUUID)
	}
	_spec.AddModifiers(aruu.modifiers...)
...
// Where appends a list predicates to the AppRoleUserUpdate builder.
func (aruuo *AppRoleUserUpdateOne) Where(ps ...predicate.AppRoleUser) *AppRoleUserUpdateOne {
	aruuo.mutation.Where(ps...)
	return aruuo
}
...
func (aruuo *AppRoleUserUpdateOne) Save(ctx context.Context) (*AppRoleUser, error) {
	aruuo.defaults()
	return withHooks(ctx, aruuo.sqlSave, aruuo.mutation, aruuo.hooks)
}
...
func (aruuo *AppRoleUserUpdateOne) sqlSave(ctx context.Context) (_node *AppRoleUser, err error) {
	...
	if !ok {
		return nil, &ValidationError{Name: "id", err: errors.New(`generated: missing "AppRoleUser.id" for update`)}
	}
	...
	_spec.AddModifiers(aruuo.modifiers...)
