...
func (*AppControl) scanValues(columns []string) ([]any, error) {
...
func (ac *AppControl) assignValues(columns []string, values []any) error {
...
// Value returns the ent.Value that was dynamically selected and assigned to the AppControl.
// This includes values selected through modifiers, order, etc.
func (ac *AppControl) Value(name string) (ent.Value, error) {
...
func (ac *AppControl) Update() *AppControlUpdateOne {
	return NewAppControlClient(ac.config).UpdateOne(ac)
}
...
func (ac *AppControl) Unwrap() *AppControl {
	...
	if !ok {
		panic("generated: AppControl is not a transactional entity")
	}
