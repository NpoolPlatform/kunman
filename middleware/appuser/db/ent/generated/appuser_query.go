...
func (auq *AppUserQuery) IDs(ctx context.Context) (ids []uint32, err error) {
...
func (auq *AppUserQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(appuser.Table, appuser.Columns, sqlgraph.NewFieldSpec(appuser.FieldID, field.TypeUint32))
	_spec.From = auq.sql
