...
func (aq *AuthQuery) IDs(ctx context.Context) (ids []uint32, err error) {
...
func (aq *AuthQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(auth.Table, auth.Columns, sqlgraph.NewFieldSpec(auth.FieldID, field.TypeUint32))
	_spec.From = aq.sql
