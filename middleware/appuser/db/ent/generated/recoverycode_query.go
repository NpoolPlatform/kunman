...
func (rcq *RecoveryCodeQuery) IDs(ctx context.Context) (ids []uint32, err error) {
...
func (rcq *RecoveryCodeQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(recoverycode.Table, recoverycode.Columns, sqlgraph.NewFieldSpec(recoverycode.FieldID, field.TypeUint32))
	_spec.From = rcq.sql
