...
var pattern_Gateway_SendCode_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "send", "usercode"}, ""))

var forward_Gateway_SendCode_0 = runtime.ForwardResponseMessage
