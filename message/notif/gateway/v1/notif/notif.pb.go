...
// 	protoc        v3.18.1
// source: notif/gateway/v1/notif/notif.proto
...
func (x *Notif) Reset() {
	*x = Notif{}
	if protoimpl.UnsafeEnabled {
		mi := &file_notif_gateway_v1_notif_notif_proto_msgTypes[0]
...
func (*Notif) Descriptor() ([]byte, []int) {
	return file_notif_gateway_v1_notif_notif_proto_rawDescGZIP(), []int{0}
}
...
func (x *UpdateNotifsRequest) Reset() {
	*x = UpdateNotifsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_notif_gateway_v1_notif_notif_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*UpdateNotifsRequest) Descriptor() ([]byte, []int) {
	return file_notif_gateway_v1_notif_notif_proto_rawDescGZIP(), []int{1}
}
...
func (x *UpdateNotifsResponse) Reset() {
	*x = UpdateNotifsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_notif_gateway_v1_notif_notif_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*UpdateNotifsResponse) Descriptor() ([]byte, []int) {
	return file_notif_gateway_v1_notif_notif_proto_rawDescGZIP(), []int{2}
}
...
func (x *GetNotifsRequest) Reset() {
	*x = GetNotifsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_notif_gateway_v1_notif_notif_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GetNotifsRequest) Descriptor() ([]byte, []int) {
	return file_notif_gateway_v1_notif_notif_proto_rawDescGZIP(), []int{3}
}
...
func (x *GetNotifsResponse) Reset() {
	*x = GetNotifsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_notif_gateway_v1_notif_notif_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GetNotifsResponse) Descriptor() ([]byte, []int) {
	return file_notif_gateway_v1_notif_notif_proto_rawDescGZIP(), []int{4}
}
...
func (x *GetAppNotifsRequest) Reset() {
	*x = GetAppNotifsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_notif_gateway_v1_notif_notif_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GetAppNotifsRequest) Descriptor() ([]byte, []int) {
	return file_notif_gateway_v1_notif_notif_proto_rawDescGZIP(), []int{5}
}
...
func (x *GetAppNotifsResponse) Reset() {
	*x = GetAppNotifsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_notif_gateway_v1_notif_notif_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GetAppNotifsResponse) Descriptor() ([]byte, []int) {
	return file_notif_gateway_v1_notif_notif_proto_rawDescGZIP(), []int{6}
}
...
var File_notif_gateway_v1_notif_notif_proto protoreflect.FileDescriptor

var file_notif_gateway_v1_notif_notif_proto_rawDesc = []byte{
	0x0a, 0x22, 0x6e, 0x6f, 0x74, 0x69, 0x66, 0x2f, 0x67, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x2f,
	0x76, 0x31, 0x2f, 0x6e, 0x6f, 0x74, 0x69, 0x66, 0x2f, 0x6e, 0x6f, 0x74, 0x69, 0x66, 0x2e, 0x70,
	0x72, 0x6f, 0x74, 0x6f, 0x12, 0x17, 0x6e, 0x6f, 0x74, 0x69, 0x66, 0x2e, 0x67, 0x61, 0x74, 0x65,
	0x77, 0x61, 0x79, 0x2e, 0x6e, 0x6f, 0x74, 0x69, 0x66, 0x33, 0x2e, 0x76, 0x31, 0x1a, 0x1c, 0x67,
	...
	0x6f, 0x74, 0x6f, 0x1a, 0x1c, 0x62, 0x61, 0x73, 0x65, 0x74, 0x79, 0x70, 0x65, 0x73, 0x2f, 0x76,
	0x31, 0x2f, 0x6e, 0x6f, 0x74, 0x69, 0x66, 0x74, 0x79, 0x70, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x1a, 0x25, 0x6e, 0x6f, 0x74, 0x69, 0x66, 0x2f, 0x6d, 0x69, 0x64, 0x64, 0x6c, 0x65, 0x77,
	0x61, 0x72, 0x65, 0x2f, 0x76, 0x31, 0x2f, 0x6e, 0x6f, 0x74, 0x69, 0x66, 0x2f, 0x6e, 0x6f, 0x74,
	0x69, 0x66, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xe8, 0x04, 0x0a, 0x05, 0x4e, 0x6f, 0x74,
	0x69, 0x66, 0x12, 0x0e, 0x0a, 0x02, 0x49, 0x44, 0x18, 0x09, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x02,
	...
	0x52, 0x08, 0x55, 0x73, 0x65, 0x72, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x33, 0x0a, 0x09, 0x45, 0x76,
	0x65, 0x6e, 0x74, 0x54, 0x79, 0x70, 0x65, 0x18, 0x50, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x15, 0x2e,
	...
	0x74, 0x12, 0x34, 0x0a, 0x07, 0x43, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x18, 0x78, 0x20, 0x01,
	...
	0x41, 0x74, 0x12, 0x17, 0x0a, 0x06, 0x4c, 0x61, 0x6e, 0x67, 0x49, 0x44, 0x18, 0xa0, 0x01, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x06, 0x4c, 0x61, 0x6e, 0x67, 0x49, 0x44, 0x12, 0x13, 0x0a, 0x04, 0x4c,
	0x61, 0x6e, 0x67, 0x18, 0xaa, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x4c, 0x61, 0x6e, 0x67,
	0x12, 0x19, 0x0a, 0x07, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x49, 0x44, 0x18, 0xb4, 0x01, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x07, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x49, 0x44, 0x12, 0x36, 0x0a, 0x09, 0x4e,
	0x6f, 0x74, 0x69, 0x66, 0x54, 0x79, 0x70, 0x65, 0x18, 0xbe, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32,
	...
	0x79, 0x70, 0x65, 0x22, 0x7e, 0x0a, 0x13, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x4e, 0x6f, 0x74,
	...
	0x52, 0x06, 0x55, 0x73, 0x65, 0x72, 0x49, 0x44, 0x12, 0x39, 0x0a, 0x05, 0x49, 0x6e, 0x66, 0x6f,
	0x73, 0x18, 0x1e, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x23, 0x2e, 0x6e, 0x6f, 0x74, 0x69, 0x66, 0x2e,
	...
	0x66, 0x6f, 0x73, 0x22, 0x4c, 0x0a, 0x14, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x4e, 0x6f, 0x74,
	...
	0x73, 0x22, 0x86, 0x01, 0x0a, 0x10, 0x47, 0x65, 0x74, 0x4e, 0x6f, 0x74, 0x69, 0x66, 0x73, 0x52,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x4c, 0x61, 0x6e, 0x67, 0x49, 0x44, 0x12, 0x16, 0x0a, 0x06,
	...
	0x65, 0x74, 0x41, 0x70, 0x70, 0x4e, 0x6f, 0x74, 0x69, 0x66, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65,
	...
	0x01, 0x28, 0x0d, 0x52, 0x05, 0x54, 0x6f, 0x74, 0x61, 0x6c, 0x32, 0xa1, 0x03, 0x0a, 0x07, 0x47,
	0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x12, 0x89, 0x01, 0x0a, 0x0c, 0x55, 0x70, 0x64, 0x61, 0x74,
	...
	0x11, 0x2f, 0x76, 0x31, 0x2f, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x2f, 0x6e, 0x6f, 0x74, 0x69,
	0x66, 0x73, 0x12, 0x7d, 0x0a, 0x09, 0x47, 0x65, 0x74, 0x4e, 0x6f, 0x74, 0x69, 0x66, 0x73, 0x12,
	...
	0x2a, 0x22, 0x0e, 0x2f, 0x76, 0x31, 0x2f, 0x67, 0x65, 0x74, 0x2f, 0x6e, 0x6f, 0x74, 0x69, 0x66,
	0x73, 0x12, 0x8a, 0x01, 0x0a, 0x0c, 0x47, 0x65, 0x74, 0x41, 0x70, 0x70, 0x4e, 0x6f, 0x74, 0x69,
	...
	0x41, 0x70, 0x70, 0x4e, 0x6f, 0x74, 0x69, 0x66, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	...
	0x70, 0x4e, 0x6f, 0x74, 0x69, 0x66, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22,
	0x1d, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x17, 0x3a, 0x01, 0x2a, 0x22, 0x12, 0x2f, 0x76, 0x31, 0x2f,
	0x67, 0x65, 0x74, 0x2f, 0x61, 0x70, 0x70, 0x2f, 0x6e, 0x6f, 0x74, 0x69, 0x66, 0x73, 0x42, 0x40,
	...
	0x67, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x2f, 0x76, 0x31, 0x2f, 0x6e, 0x6f, 0x74, 0x69, 0x66,
	0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_notif_gateway_v1_notif_notif_proto_rawDescOnce sync.Once
	file_notif_gateway_v1_notif_notif_proto_rawDescData = file_notif_gateway_v1_notif_notif_proto_rawDesc
)

func file_notif_gateway_v1_notif_notif_proto_rawDescGZIP() []byte {
	file_notif_gateway_v1_notif_notif_proto_rawDescOnce.Do(func() {
		file_notif_gateway_v1_notif_notif_proto_rawDescData = protoimpl.X.CompressGZIP(file_notif_gateway_v1_notif_notif_proto_rawDescData)
	})
...
func init() { file_notif_gateway_v1_notif_notif_proto_init() }
func file_notif_gateway_v1_notif_notif_proto_init() {
	if File_notif_gateway_v1_notif_notif_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_notif_gateway_v1_notif_notif_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Notif); i {
			case 0:
				return &v.state
			case 1:
		...
		file_notif_gateway_v1_notif_notif_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_notif_gateway_v1_notif_notif_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_notif_gateway_v1_notif_notif_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_notif_gateway_v1_notif_notif_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_notif_gateway_v1_notif_notif_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_notif_gateway_v1_notif_notif_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_notif_gateway_v1_notif_notif_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_notif_gateway_v1_notif_notif_proto_goTypes,
		DependencyIndexes: file_notif_gateway_v1_notif_notif_proto_depIdxs,
		MessageInfos:      file_notif_gateway_v1_notif_notif_proto_msgTypes,
	}.Build()
	File_notif_gateway_v1_notif_notif_proto = out.File
	file_notif_gateway_v1_notif_notif_proto_rawDesc = nil
	file_notif_gateway_v1_notif_notif_proto_goTypes = nil
	file_notif_gateway_v1_notif_notif_proto_depIdxs = nil
}
