...
var (
	file_notif_middleware_v1_announcement_readstate_readstate_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
	file_notif_middleware_v1_announcement_readstate_readstate_proto_goTypes  = []interface{}{
