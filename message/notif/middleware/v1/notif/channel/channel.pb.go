...
var (
	file_notif_middleware_v1_notif_channel_channel_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
	file_notif_middleware_v1_notif_channel_channel_proto_goTypes  = []interface{}{
