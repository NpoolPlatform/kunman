...
// 	protoc        v3.18.1
// source: ledger/middleware/v2/simulate/ledger/profit/profit.proto
...
func (x *ProfitReq) Reset() {
	*x = ProfitReq{}
	if protoimpl.UnsafeEnabled {
		mi := &file_ledger_middleware_v2_simulate_ledger_profit_profit_proto_msgTypes[0]
...
func (*ProfitReq) Descriptor() ([]byte, []int) {
	return file_ledger_middleware_v2_simulate_ledger_profit_profit_proto_rawDescGZIP(), []int{0}
}
...
func (x *Profit) Reset() {
	*x = Profit{}
	if protoimpl.UnsafeEnabled {
		mi := &file_ledger_middleware_v2_simulate_ledger_profit_profit_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Profit) Descriptor() ([]byte, []int) {
	return file_ledger_middleware_v2_simulate_ledger_profit_profit_proto_rawDescGZIP(), []int{1}
}
...
func (x *Conds) Reset() {
	*x = Conds{}
	if protoimpl.UnsafeEnabled {
		mi := &file_ledger_middleware_v2_simulate_ledger_profit_profit_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Conds) Descriptor() ([]byte, []int) {
	return file_ledger_middleware_v2_simulate_ledger_profit_profit_proto_rawDescGZIP(), []int{2}
}
...
var File_ledger_middleware_v2_simulate_ledger_profit_profit_proto protoreflect.FileDescriptor

var file_ledger_middleware_v2_simulate_ledger_profit_profit_proto_rawDesc = []byte{
	0x0a, 0x38, 0x6c, 0x65, 0x64, 0x67, 0x65, 0x72, 0x2f, 0x6d, 0x69, 0x64, 0x64, 0x6c, 0x65, 0x77,
	0x61, 0x72, 0x65, 0x2f, 0x76, 0x32, 0x2f, 0x73, 0x69, 0x6d, 0x75, 0x6c, 0x61, 0x74, 0x65, 0x2f,
	0x6c, 0x65, 0x64, 0x67, 0x65, 0x72, 0x2f, 0x70, 0x72, 0x6f, 0x66, 0x69, 0x74, 0x2f, 0x70, 0x72,
	0x6f, 0x66, 0x69, 0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x2b, 0x6c, 0x65, 0x64, 0x67,
	...
	0x6f, 0x66, 0x69, 0x74, 0x2e, 0x76, 0x32, 0x1a, 0x18, 0x62, 0x61, 0x73, 0x65, 0x74, 0x79, 0x70,
	...
	0x69, 0x6e, 0x67, 0x42, 0x55, 0x5a, 0x53, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f,
...
var (
	file_ledger_middleware_v2_simulate_ledger_profit_profit_proto_rawDescOnce sync.Once
	file_ledger_middleware_v2_simulate_ledger_profit_profit_proto_rawDescData = file_ledger_middleware_v2_simulate_ledger_profit_profit_proto_rawDesc
)

func file_ledger_middleware_v2_simulate_ledger_profit_profit_proto_rawDescGZIP() []byte {
	file_ledger_middleware_v2_simulate_ledger_profit_profit_proto_rawDescOnce.Do(func() {
		file_ledger_middleware_v2_simulate_ledger_profit_profit_proto_rawDescData = protoimpl.X.CompressGZIP(file_ledger_middleware_v2_simulate_ledger_profit_profit_proto_rawDescData)
	})
...
var file_ledger_middleware_v2_simulate_ledger_profit_profit_proto_depIdxs = []int32{
	...
	3, // 2: ledger.middleware.simulate.ledger.profit.v2.Conds.UserID:type_name -> basetypes.v1.StringVal
	3, // 3: ledger.middleware.simulate.ledger.profit.v2.Conds.CoinTypeID:type_name -> basetypes.v1.StringVal
	3, // 4: ledger.middleware.simulate.ledger.profit.v2.Conds.Incoming:type_name -> basetypes.v1.StringVal
...
func init() { file_ledger_middleware_v2_simulate_ledger_profit_profit_proto_init() }
func file_ledger_middleware_v2_simulate_ledger_profit_profit_proto_init() {
	if File_ledger_middleware_v2_simulate_ledger_profit_profit_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_ledger_middleware_v2_simulate_ledger_profit_profit_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_ledger_middleware_v2_simulate_ledger_profit_profit_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Profit); i {
			case 0:
				return &v.state
			case 1:
		...
		file_ledger_middleware_v2_simulate_ledger_profit_profit_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Conds); i {
			case 0:
				return &v.state
			case 1:
	...
	file_ledger_middleware_v2_simulate_ledger_profit_profit_proto_msgTypes[0].OneofWrappers = []interface{}{}
	file_ledger_middleware_v2_simulate_ledger_profit_profit_proto_msgTypes[2].OneofWrappers = []interface{}{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: file_ledger_middleware_v2_simulate_ledger_profit_profit_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_ledger_middleware_v2_simulate_ledger_profit_profit_proto_goTypes,
		DependencyIndexes: file_ledger_middleware_v2_simulate_ledger_profit_profit_proto_depIdxs,
		MessageInfos:      file_ledger_middleware_v2_simulate_ledger_profit_profit_proto_msgTypes,
	}.Build()
	File_ledger_middleware_v2_simulate_ledger_profit_profit_proto = out.File
	file_ledger_middleware_v2_simulate_ledger_profit_profit_proto_rawDesc = nil
	file_ledger_middleware_v2_simulate_ledger_profit_profit_proto_goTypes = nil
	file_ledger_middleware_v2_simulate_ledger_profit_profit_proto_depIdxs = nil
}
