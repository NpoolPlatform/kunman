...
import (
	_ "github.com/NpoolPlatform/kunman/message/basetypes/ledger/v1"
...
func (x *LockBalance) GetCoinTypeID() string {
	if x != nil {
		return x.CoinTypeID
	}
	return ""
...
var file_ledger_middleware_v2_ledger_ledger_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x22, 0xa8, 0x02, 0x0a, 0x06, 0x4c, 0x65, 0x64, 0x67, 0x65, 0x72, 0x12, 0x0e, 0x0a,
	...
	0x69, 0x63, 0x65, 0x56, 0x61, 0x6c, 0x48, 0x04, 0x52, 0x0b, 0x43, 0x6f, 0x69, 0x6e, 0x54, 0x79,
	0x70, 0x65, 0x49, 0x44, 0x73, 0x88, 0x01, 0x01, 0x42, 0x08, 0x0a, 0x06, 0x5f, 0x45, 0x6e, 0x74,
	...
	0x79, 0x70, 0x65, 0x49, 0x44, 0x73, 0x22, 0x45, 0x0a, 0x0b, 0x4c, 0x6f, 0x63, 0x6b, 0x42, 0x61,
	...
	0x14, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x41, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x42, 0x45, 0x5a,
	...
	0x6d, 0x69, 0x64, 0x64, 0x6c, 0x65, 0x77, 0x61, 0x72, 0x65, 0x2f, 0x76, 0x32, 0x2f, 0x6c, 0x65,
...
var file_ledger_middleware_v2_ledger_ledger_proto_depIdxs = []int32{
	3, // 0: ledger.middleware.ledger.v2.Conds.EntID:type_name -> basetypes.v1.StringVal
	3, // 1: ledger.middleware.ledger.v2.Conds.AppID:type_name -> basetypes.v1.StringVal
	3, // 2: ledger.middleware.ledger.v2.Conds.UserID:type_name -> basetypes.v1.StringVal
	3, // 3: ledger.middleware.ledger.v2.Conds.CoinTypeID:type_name -> basetypes.v1.StringVal
	4, // 4: ledger.middleware.ledger.v2.Conds.CoinTypeIDs:type_name -> basetypes.v1.StringSliceVal
