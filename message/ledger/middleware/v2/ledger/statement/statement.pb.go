...
var (
	file_ledger_middleware_v2_ledger_statement_statement_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
	file_ledger_middleware_v2_ledger_statement_statement_proto_goTypes  = []interface{}{
