...
var pattern_Gateway_CreateTransfer_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "create", "transfer"}, ""))

var forward_Gateway_CreateTransfer_0 = runtime.ForwardResponseMessage
