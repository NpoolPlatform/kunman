...
var pattern_Gateway_GetCurrencies_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "get", "coinfiatcurrencyhistories"}, ""))

var forward_Gateway_GetCurrencies_0 = runtime.ForwardResponseMessage
