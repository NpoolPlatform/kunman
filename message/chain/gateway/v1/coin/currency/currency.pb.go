...
// 	protoc        v3.18.1
// source: chain/gateway/v1/coin/currency/currency.proto
...
func (x *GetCurrencyRequest) Reset() {
	*x = GetCurrencyRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_chain_gateway_v1_coin_currency_currency_proto_msgTypes[0]
...
func (*GetCurrencyRequest) Descriptor() ([]byte, []int) {
	return file_chain_gateway_v1_coin_currency_currency_proto_rawDescGZIP(), []int{0}
}
...
func (x *GetCurrencyResponse) Reset() {
	*x = GetCurrencyResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_chain_gateway_v1_coin_currency_currency_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GetCurrencyResponse) Descriptor() ([]byte, []int) {
	return file_chain_gateway_v1_coin_currency_currency_proto_rawDescGZIP(), []int{1}
}
...
func (x *GetCurrenciesRequest) Reset() {
	*x = GetCurrenciesRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_chain_gateway_v1_coin_currency_currency_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GetCurrenciesRequest) Descriptor() ([]byte, []int) {
	return file_chain_gateway_v1_coin_currency_currency_proto_rawDescGZIP(), []int{2}
}
...
func (x *GetCurrenciesResponse) Reset() {
	*x = GetCurrenciesResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_chain_gateway_v1_coin_currency_currency_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GetCurrenciesResponse) Descriptor() ([]byte, []int) {
	return file_chain_gateway_v1_coin_currency_currency_proto_rawDescGZIP(), []int{3}
}
...
var File_chain_gateway_v1_coin_currency_currency_proto protoreflect.FileDescriptor

var file_chain_gateway_v1_coin_currency_currency_proto_rawDesc = []byte{
	...
	0x1e, 0x63, 0x68, 0x61, 0x69, 0x6e, 0x2e, 0x67, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x2e, 0x63,
	0x6f, 0x69, 0x6e, 0x2e, 0x63, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x63, 0x79, 0x2e, 0x76, 0x31, 0x1a,
	...
	0x34, 0x0a, 0x12, 0x47, 0x65, 0x74, 0x43, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x63, 0x79, 0x52, 0x65,
	...
	0x79, 0x70, 0x65, 0x49, 0x44, 0x22, 0x56, 0x0a, 0x13, 0x47, 0x65, 0x74, 0x43, 0x75, 0x72, 0x72,
	0x65, 0x6e, 0x63, 0x79, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x3f, 0x0a, 0x04,
	0x49, 0x6e, 0x66, 0x6f, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2b, 0x2e, 0x63, 0x68, 0x61,
	...
	0x75, 0x72, 0x72, 0x65, 0x6e, 0x63, 0x79, 0x52, 0x04, 0x49, 0x6e, 0x66, 0x6f, 0x22, 0x66, 0x0a,
	...
	0x52, 0x05, 0x54, 0x6f, 0x74, 0x61, 0x6c, 0x32, 0xc5, 0x02, 0x0a, 0x07, 0x47, 0x61, 0x74, 0x65,
	0x77, 0x61, 0x79, 0x12, 0x97, 0x01, 0x0a, 0x0b, 0x47, 0x65, 0x74, 0x43, 0x75, 0x72, 0x72, 0x65,
	0x6e, 0x63, 0x79, 0x12, 0x32, 0x2e, 0x63, 0x68, 0x61, 0x69, 0x6e, 0x2e, 0x67, 0x61, 0x74, 0x65,
	...
	0x67, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x2e, 0x63, 0x6f, 0x69, 0x6e, 0x2e, 0x63, 0x75, 0x72,
	...
	0x2f, 0x63, 0x6f, 0x69, 0x6e, 0x63, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x63, 0x79, 0x12, 0x9f, 0x01,
	...
	0x2f, 0x63, 0x6f, 0x69, 0x6e, 0x63, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x63, 0x69, 0x65, 0x73, 0x42,
	...
	0x2f, 0x67, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x2f, 0x76, 0x31, 0x2f, 0x63, 0x6f, 0x69, 0x6e,
	0x2f, 0x63, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x63, 0x79, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x33,
}

var (
	file_chain_gateway_v1_coin_currency_currency_proto_rawDescOnce sync.Once
	file_chain_gateway_v1_coin_currency_currency_proto_rawDescData = file_chain_gateway_v1_coin_currency_currency_proto_rawDesc
)

func file_chain_gateway_v1_coin_currency_currency_proto_rawDescGZIP() []byte {
	file_chain_gateway_v1_coin_currency_currency_proto_rawDescOnce.Do(func() {
		file_chain_gateway_v1_coin_currency_currency_proto_rawDescData = protoimpl.X.CompressGZIP(file_chain_gateway_v1_coin_currency_currency_proto_rawDescData)
	})
...
func init() { file_chain_gateway_v1_coin_currency_currency_proto_init() }
func file_chain_gateway_v1_coin_currency_currency_proto_init() {
	if File_chain_gateway_v1_coin_currency_currency_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_chain_gateway_v1_coin_currency_currency_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_chain_gateway_v1_coin_currency_currency_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_chain_gateway_v1_coin_currency_currency_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_chain_gateway_v1_coin_currency_currency_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_chain_gateway_v1_coin_currency_currency_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_chain_gateway_v1_coin_currency_currency_proto_goTypes,
		DependencyIndexes: file_chain_gateway_v1_coin_currency_currency_proto_depIdxs,
		MessageInfos:      file_chain_gateway_v1_coin_currency_currency_proto_msgTypes,
	}.Build()
	File_chain_gateway_v1_coin_currency_currency_proto = out.File
	file_chain_gateway_v1_coin_currency_currency_proto_rawDesc = nil
	file_chain_gateway_v1_coin_currency_currency_proto_goTypes = nil
	file_chain_gateway_v1_coin_currency_currency_proto_depIdxs = nil
}
