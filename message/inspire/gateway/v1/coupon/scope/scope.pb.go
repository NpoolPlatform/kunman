...
var (
	file_inspire_gateway_v1_coupon_scope_scope_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
	file_inspire_gateway_v1_coupon_scope_scope_proto_goTypes  = []interface{}{
