...
var pattern_Gateway_Reconcile_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v1", "reconcile"}, ""))

var forward_Gateway_Reconcile_0 = runtime.ForwardResponseMessage
