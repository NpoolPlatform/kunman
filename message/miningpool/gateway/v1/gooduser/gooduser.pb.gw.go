...
var pattern_Gateway_AdminGetGoodUsers_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"v1", "admin", "get", "goodminingpoolusers"}, ""))

var forward_Gateway_AdminGetGoodUsers_0 = runtime.ForwardResponseMessage
