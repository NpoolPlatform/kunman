...
var (
	file_good_gateway_v1_app_good_poster_poster_proto_msgTypes = make([]protoimpl.MessageInfo, 17)
	file_good_gateway_v1_app_good_poster_poster_proto_goTypes  = []interface{}{
