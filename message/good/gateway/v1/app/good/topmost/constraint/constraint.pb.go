...
var (
	file_good_gateway_v1_app_good_topmost_constraint_constraint_proto_msgTypes = make([]protoimpl.MessageInfo, 17)
	file_good_gateway_v1_app_good_topmost_constraint_constraint_proto_goTypes  = []interface{}{
