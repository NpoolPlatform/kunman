...
var (
	file_good_middleware_v1_app_good_like_like_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
	file_good_middleware_v1_app_good_like_like_proto_goTypes  = []interface{}{
