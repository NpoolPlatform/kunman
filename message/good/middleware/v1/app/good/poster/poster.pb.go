...
// 	protoc        v3.18.1
// source: good/middleware/v1/app/good/poster/poster.proto
...
func (x *PosterReq) Reset() {
	*x = PosterReq{}
	if protoimpl.UnsafeEnabled {
		mi := &file_good_middleware_v1_app_good_poster_poster_proto_msgTypes[0]
...
func (*PosterReq) Descriptor() ([]byte, []int) {
	return file_good_middleware_v1_app_good_poster_poster_proto_rawDescGZIP(), []int{0}
}
...
func (x *Poster) Reset() {
	*x = Poster{}
	if protoimpl.UnsafeEnabled {
		mi := &file_good_middleware_v1_app_good_poster_poster_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Poster) Descriptor() ([]byte, []int) {
	return file_good_middleware_v1_app_good_poster_poster_proto_rawDescGZIP(), []int{1}
}
...
func (x *PosterInfo) Reset() {
	*x = PosterInfo{}
	if protoimpl.UnsafeEnabled {
		mi := &file_good_middleware_v1_app_good_poster_poster_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*PosterInfo) Descriptor() ([]byte, []int) {
	return file_good_middleware_v1_app_good_poster_poster_proto_rawDescGZIP(), []int{2}
}
...
func (x *Conds) Reset() {
	*x = Conds{}
	if protoimpl.UnsafeEnabled {
		mi := &file_good_middleware_v1_app_good_poster_poster_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Conds) Descriptor() ([]byte, []int) {
	return file_good_middleware_v1_app_good_poster_poster_proto_rawDescGZIP(), []int{3}
}
...
var File_good_middleware_v1_app_good_poster_poster_proto protoreflect.FileDescriptor

var file_good_middleware_v1_app_good_poster_poster_proto_rawDesc = []byte{
	...
	0x08, 0x0a, 0x06, 0x5f, 0x45, 0x6e, 0x74, 0x49, 0x44, 0x42, 0x0c, 0x0a, 0x0a, 0x5f, 0x41, 0x70,
	0x70, 0x47, 0x6f, 0x6f, 0x64, 0x49, 0x44, 0x42, 0x09, 0x0a, 0x07, 0x5f, 0x50, 0x6f, 0x73, 0x74,
	0x65, 0x72, 0x42, 0x08, 0x0a, 0x06, 0x5f, 0x49, 0x6e, 0x64, 0x65, 0x78, 0x22, 0xff, 0x02, 0x0a,
	...
	0x6f, 0x6f, 0x64, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x50, 0x6f, 0x73, 0x74, 0x65,
	0x72, 0x18, 0x50, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x50, 0x6f, 0x73, 0x74, 0x65, 0x72, 0x12,
	0x20, 0x0a, 0x0b, 0x47, 0x6f, 0x6f, 0x64, 0x54, 0x79, 0x70, 0x65, 0x53, 0x74, 0x72, 0x18, 0x5a,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x47, 0x6f, 0x6f, 0x64, 0x54, 0x79, 0x70, 0x65, 0x53, 0x74,
	0x72, 0x12, 0x37, 0x0a, 0x08, 0x47, 0x6f, 0x6f, 0x64, 0x54, 0x79, 0x70, 0x65, 0x18, 0x64, 0x20,
	...
	0x52, 0x08, 0x47, 0x6f, 0x6f, 0x64, 0x54, 0x79, 0x70, 0x65, 0x12, 0x14, 0x0a, 0x05, 0x49, 0x6e,
	...
	0x01, 0x28, 0x0d, 0x52, 0x09, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x64, 0x41, 0x74, 0x22, 0x58,
	0x0a, 0x0a, 0x50, 0x6f, 0x73, 0x74, 0x65, 0x72, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x1c, 0x0a, 0x09,
	...
	0x73, 0x74, 0x65, 0x72, 0x18, 0x14, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x50, 0x6f, 0x73, 0x74,
	0x65, 0x72, 0x12, 0x14, 0x0a, 0x05, 0x49, 0x6e, 0x64, 0x65, 0x78, 0x18, 0x1e, 0x20, 0x01, 0x28,
	...
	0x70, 0x70, 0x47, 0x6f, 0x6f, 0x64, 0x49, 0x44, 0x73, 0x42, 0x45, 0x5a, 0x43, 0x67, 0x69, 0x74,
...
var (
	file_good_middleware_v1_app_good_poster_poster_proto_rawDescOnce sync.Once
	file_good_middleware_v1_app_good_poster_poster_proto_rawDescData = file_good_middleware_v1_app_good_poster_poster_proto_rawDesc
)

func file_good_middleware_v1_app_good_poster_poster_proto_rawDescGZIP() []byte {
	file_good_middleware_v1_app_good_poster_poster_proto_rawDescOnce.Do(func() {
		file_good_middleware_v1_app_good_poster_poster_proto_rawDescData = protoimpl.X.CompressGZIP(file_good_middleware_v1_app_good_poster_poster_proto_rawDescData)
	})
	return file_good_middleware_v1_app_good_poster_poster_proto_rawDescData
}

var file_good_middleware_v1_app_good_poster_poster_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_good_middleware_v1_app_good_poster_poster_proto_goTypes = []interface{}{
...
var file_good_middleware_v1_app_good_poster_poster_proto_depIdxs = []int32{
	4, // 0: good.middleware.app.good1.poster.v1.Poster.GoodType:type_name -> basetypes.good.v1.GoodType
	5, // 1: good.middleware.app.good1.poster.v1.Conds.ID:type_name -> basetypes.v1.Uint32Val
	6, // 2: good.middleware.app.good1.poster.v1.Conds.EntID:type_name -> basetypes.v1.StringVal
	6, // 3: good.middleware.app.good1.poster.v1.Conds.AppID:type_name -> basetypes.v1.StringVal
	6, // 4: good.middleware.app.good1.poster.v1.Conds.GoodID:type_name -> basetypes.v1.StringVal
	7, // 5: good.middleware.app.good1.poster.v1.Conds.GoodIDs:type_name -> basetypes.v1.StringSliceVal
	6, // 6: good.middleware.app.good1.poster.v1.Conds.AppGoodID:type_name -> basetypes.v1.StringVal
	7, // 7: good.middleware.app.good1.poster.v1.Conds.AppGoodIDs:type_name -> basetypes.v1.StringSliceVal
...
func init() { file_good_middleware_v1_app_good_poster_poster_proto_init() }
func file_good_middleware_v1_app_good_poster_poster_proto_init() {
	if File_good_middleware_v1_app_good_poster_poster_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_good_middleware_v1_app_good_poster_poster_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_good_middleware_v1_app_good_poster_poster_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Poster); i {
			case 0:
				return &v.state
			case 1:
		...
		file_good_middleware_v1_app_good_poster_poster_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_good_middleware_v1_app_good_poster_poster_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Conds); i {
			case 0:
				return &v.state
			case 1:
	...
	file_good_middleware_v1_app_good_poster_poster_proto_msgTypes[0].OneofWrappers = []interface{}{}
	file_good_middleware_v1_app_good_poster_poster_proto_msgTypes[3].OneofWrappers = []interface{}{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: file_good_middleware_v1_app_good_poster_poster_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_good_middleware_v1_app_good_poster_poster_proto_goTypes,
		DependencyIndexes: file_good_middleware_v1_app_good_poster_poster_proto_depIdxs,
		MessageInfos:      file_good_middleware_v1_app_good_poster_poster_proto_msgTypes,
	}.Build()
	File_good_middleware_v1_app_good_poster_poster_proto = out.File
	file_good_middleware_v1_app_good_poster_poster_proto_rawDesc = nil
	file_good_middleware_v1_app_good_poster_poster_proto_goTypes = nil
	file_good_middleware_v1_app_good_poster_poster_proto_depIdxs = nil
}
