...
var (
	file_good_middleware_v1_app_good_poster_poster_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
	file_good_middleware_v1_app_good_poster_poster_proto_goTypes  = []interface{}{
