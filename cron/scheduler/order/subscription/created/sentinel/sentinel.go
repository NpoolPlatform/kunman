...
func (h *handler) scanSubscriptionOrders(ctx context.Context, state ordertypes.OrderState, exec chan interface{}) error {
	offset := int32(0)
...
func (h *handler) Scan(ctx context.Context, exec chan interface{}) error {
	return h.scanSubscriptionOrders(ctx, ordertypes.OrderState_OrderStateCreated, exec)
}
...
func (h *handler) ObjectID(ent interface{}) string {
	...
	if order, ok := ent.(*types.PersistentSubscriptionOrder); ok {
