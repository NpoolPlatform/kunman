...
import (
	...
	types "github.com/NpoolPlatform/kunman/cron/scheduler/order/powerrental/simulate/cancel/unlockaccount/types"
...
func (p *handler) Update(ctx context.Context, order interface{}, reward, notif, done chan interface{}) error {
	...
	handler, err := powerrentalordermw.NewHandler(
		...
		powerrentalordermw.WithOrderState(ordertypes.OrderState_OrderStateCanceled.Enum(), true),
	)
	if err != nil {
		return err
	}
